...
export function buildProductVideoTemplateCards(
  ...
  const cards: IntakeTemplateCard[] = [
    ...
    },
    {
      ...
      title: modes["wet-glass-reveal"].title,
      description: modes["wet-glass-reveal"].description,
      previewSrc: videoModePreviewSrc("wet-glass-reveal"),
    },
    {
      id: "torn_paper_reveal",
      kind: "video",
      videoSubpath: "torn_paper_reveal",
      title: modes["torn-paper-reveal"].title,
      description: modes["torn-paper-reveal"].description,
      previewSrc: videoModePreviewSrc("torn-paper-reveal"),
    },
    {
      id: "swift_chroma_run",
      kind: "video",
      videoSubpath: "swift_chroma_run",
      title: modes["swift-chroma-run"].title,
      description: modes["swift-chroma-run"].description,
      previewSrc: videoModePreviewSrc("swift-chroma-run"),
    },
    {
      id: "magazine_cover_morph",
      kind: "video",
      videoSubpath: "magazine_cover_morph",
      title: modes["magazine-cover-morph"].title,
      description: modes["magazine-cover-morph"].description,
