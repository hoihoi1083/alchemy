...
export const en = {
  ...
  wizard: {
    ...
    quickFixInpaintBrush: "Brush over the area to change (tap for a small spot)",
    quickFixInpaintClear: "Clear mask",
    quickFixInpaintPrompt: "Replace example: 改成「認識金砂石」 / marble surface",
  ...
  imageCanvas: {
    ...
    cleanRegionCount: (n: number) => `${n} area${n === 1 ? "" : "s"} selected to remove`,
    ...
    cleanCostNote: "Each remove/replace uses 1 image credit. AI only regenerates the painted pixels.",
