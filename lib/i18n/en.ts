...
export const en = {
  ...
  start: {
    ...
    secureNote: "Your assets are only used to generate content and are never shared externally.",
  ...
  landing: {
    ...
    storyboardImageAlt: "Storyboard mode: three scenes combined into one video",
    ...
    tplTitleAfter: "",
    tplSubtitle: "Formats and platforms you can ship — remake any card for your brand in Studio.",
    ...
    tplAdMakeup: "Reference the look. Keep your product.",
  ...
  wizard: {
    ...
    workflowModes: {
      ...
      "video-only": {
        ...
        description: "AI scenes and shots — ready-to-publish short video",
        cardDescription:
      ...
      combined: {
        ...
        description: "Approve visuals first, then turn them into short video",
        cardDescription:
    ...
    creationPath: {
      ...
      tipCombined: "Best when you want to approve the look, then add motion.",
      ...
      nextSubtitleImage: "Your flow: Set up content → Generate images → Download & use.",
      nextSubtitleVideo: "Your flow: Set up content → Generate video → Download & use.",
      nextSubtitleCombined:
        "Your flow: Set up content → Generate images → Confirm storyboard → Generate video → Download & use.",
      nextStepsUnset: [
        { title: "Set up", body: "Add details, research, style, and assets.", icon: "setup" },
        {
          title: "Generate",
          body: "Images, video, or both — only what your method needs.",
          icon: "generate",
        },
        { title: "Download & use", body: "Edit on canvas and export.", icon: "done" },
      ],
      nextStepsImage: [
        { title: "Set up content", body: "Reference, product, and image settings.", icon: "setup" },
        { title: "Generate images", body: "Create stills for your campaign.", icon: "image" },
        { title: "Download & use", body: "Edit in Canvas, then download.", icon: "done" },
      ],
      nextStepsVideo: [
        { title: "Set up content", body: "Product, motion direction, and settings.", icon: "setup" },
        { title: "Generate video", body: "Create your short video when ready.", icon: "video" },
        { title: "Download & use", body: "Preview, captions, and download.", icon: "done" },
      ],
      nextStepsCombined: [
        { title: "Set up content", body: "Brief, scenes, and still settings.", icon: "setup" },
        { title: "Confirm storyboard", body: "Review scene stills (not the final video yet).", icon: "image" },
        { title: "Generate video", body: "Stitch scenes into a short video.", icon: "video" },
        { title: "Download & use", body: "Preview and export the final video.", icon: "done" },
      ],
    },
    ...
    continueToVideo: "Continue to video setup",
    ...
    imageReviewFailedBody: "Fix the issue below, then try again. You weren’t charged for a failed run when noted.",
