...
export const en = {
  ...
  start: {
    ...
    secureNote: "Your data is secure and never shared.",
    roadmapTitle: "How it works",
    roadmapSubtitle: "Five stages — your path branches at create (image, video, or both).",
    phases: [
    ...
    phaseBodies: [
      "Pick physical product or service / concept.",
      "Images only, videos only, or images then video.",
      "Add details, research, style, and assets.",
      "Run Image and/or Video — only the steps your path needs.",
      "Download ads ready for IG, FB, and TikTok.",
    ],
    physicalShort:
  ...
  landing: {
    ...
    refBody:
      "Learn from a look you like — then generate content that keeps your product, offer, and brand identity.",
    refCardLabel: "Reference Post",
    ...
    canvasFeatures: ["Remove elements", "Add text", "Add logo", "Add diagram", "Export sizes"],
    canvasFeatureItems: [
    ...
    tplTitleBefore: "Ready-to-use templates for every ",
    tplTitleHighlight: "platform",
    tplTitleAfter: "",
    tplSubtitle: "Start from a scenario card, then follow the guided Studio wizard.",
    tplTabAll: "All",
    ...
    scenariosSubtitle: "Pick the industry vibe that matches your next campaign.",
    scenarios: [
      {
  ...
  pricing: {
    ...
    topUpTitle: "Need more tokens?",
    topUpSubtitle: "Subscribers can buy extra tokens anytime — no plan change required.",
    topUpPrice: "$10",
    ...
    comparisonRows: [
      { feature: "Monthly tokens", free: "1,000", standard: "3,000", pro: "8,000", master: "16,000" },
      { feature: "Max image resolution", free: "1K", standard: "1K", pro: "1K", master: "2K" },
      { feature: "Max video resolution", free: "480p", standard: "720p", pro: "1080p", master: "1080p" },
      { feature: "Research / combined / storyboard", free: "✓", standard: "✓", pro: "✓", master: "✓" },
      { feature: "A/B, Campaign, teaching carousel", free: "✓", standard: "✓", pro: "✓", master: "✓" },
      { feature: "Email support", free: "—", standard: "✓", pro: "✓", master: "✓" },
      { feature: "Priority generation", free: "—", standard: "—", pro: "✓", master: "✓" },
      { feature: "Pro canvas", free: "—", standard: "—", pro: "—", master: "✓" },
      { feature: "Priority support", free: "—", standard: "—", pro: "—", master: "✓" },
      { feature: "Token top-up ($10 / 1k)", free: "—", standard: "✓", pro: "✓", master: "✓" },
    ],
  },
  steps: {
    setup: "Setup",
  ...
  wizard: {
    ...
    workflowModes: {
      "image-only": {
        ...
        cardDescription:
          "Generate high-quality images for social posts, ads, banners, or other visuals.",
        tags: ["Social posts", "Product shots"],
      },
      "video-only": {
        title: "Videos only",
        description: "Reel ad — storyboard (preview scenes) or animate one photo",
        cardDescription:
          "Create ready-to-publish videos using AI-generated scenes and clips.",
        tags: ["Short videos", "Video ads"],
      },
      combined: {
        title: "Images first, then video",
        description: "Still image first, then motion — storyboard reel or animate that image",
        cardDescription:
          "Generate images, review and refine, then turn them into engaging videos.",
        tags: ["Ad campaigns", "Product storytelling"],
      },
    },
    creationPath: {
      stepEyebrow: "STEP 2",
      title: "Choose your creation path.",
      hint: "Choose whether to create only images, only videos, or images first then video.",
      chooseLabel: "Choose this path",
      bestForLabel: "Best for:",
      tipTitle: "Which path should I choose?",
      tipImage: "Best when you need stills for feed posts, carousels, or ads.",
      tipVideo: "Best when you already have a still or want a reel-first workflow.",
      tipCombined: "Best when you want to approve the look, then animate it.",
      tipNote: "You can always change this later",
      tipNoteBody:
        "Not sure right now? You can update this anytime inside Advanced studio.",
      backToStep1: "Back to Step 1",
      continueToSetup: "Continue",
      nextTitle: "What happens next",
      nextSubtitleUnset:
        "Pick a path above — Studio only shows Image and/or Video for that path.",
      nextSubtitleImage: "Your path: Setup → Image → Done (no Video step).",
      nextSubtitleVideo: "Your path: Setup → Video → Done (no Image step unless storyboard needs it).",
      nextSubtitleCombined: "Your path: Setup → Image → Video → Done.",
      nextStepsUnset: [
        { title: "Setup", body: "Add details, research, style, and assets.", icon: "setup" },
        {
          title: "Generate",
          body: "Image, Video, or both — only what your path needs.",
          icon: "generate",
        },
        { title: "Done", body: "Download and reuse your ads.", icon: "done" },
      ],
      nextStepsImage: [
        { title: "Setup", body: "Add details, research, style, and assets.", icon: "setup" },
        { title: "Image", body: "Generate and review stills.", icon: "image" },
        { title: "Done", body: "Download and reuse your ads.", icon: "done" },
      ],
      nextStepsVideo: [
        { title: "Setup", body: "Add details, research, style, and assets.", icon: "setup" },
        { title: "Video", body: "Generate your reel.", icon: "video" },
        { title: "Done", body: "Download and reuse your ads.", icon: "done" },
      ],
      nextStepsCombined: [
        { title: "Setup", body: "Add details, research, style, and assets.", icon: "setup" },
        { title: "Image", body: "Generate and review stills first.", icon: "image" },
        { title: "Video", body: "Animate approved stills into a reel.", icon: "video" },
        { title: "Done", body: "Download and reuse your ads.", icon: "done" },
      ],
    },
    ...
    videoOutputTypes: {
      "storyboard-reel": {
        ...
        pipeline: "Step 2: scene stills (preview each) → Step 3: one stitched video generation clip with hard cuts",
        pipelineVideoOnly:
      ...
      "reference-motion": {
        ...
        pipeline: "Your clip sets pacing (@Video1) → video generation generates a new ad with similar motion",
      ...
      "text-reel": {
        ...
        pipeline: "Concept copy → video generation text-to-video — no keyframe upload",
      ...
      "product-assistant": {
        ...
        pipeline: "Upload product + angles → AI plans situational motion → video generation reel",
      ...
      "cinematic-reel": {
        ...
        pipeline: "Mood keyframe(s) → 8s video generation clip per scene (stitch if multi-scene)",
      ...
      "digital-presenter": {
        ...
        pipeline: "Product keyframe → digital presenter lip-sync to your ad-pack script (~$0.10/s)",
        ...
        confidence: "Best for bracelet/UGC-style talking ads — not video generation motion",
      },
    },
    ...
    imageOutputModeHint: "Campaign generates 3 linked posts (~3× image API cost + AI planning)",
    ...
    imagePostflightSafeForVideo: "Ready for video — 9:16 and sharp enough for video generation",
    ...
    storyboardRegenerateAiCostHint: "Charged as a new scene image run (2× tokens if brand logo is on).",
    ...
    storyboardPromptHint: "AI tagged each scene as @Image1, @Image2… Review before generating video.",
    ...
    ugcPresenter: {
      ...
      imagePreflight: "Mode: UGC keyframe for digital presenter (talking-head, product in hand)",
      videoPreflight: "Mode: digital presenter lip-sync (not video generation)",
    ...
    pathUgcPresenterDesc: "Talking-head lip-sync promo (keyframe + digital presenter).",
    ...
    cinematicStitchVideoPreflight: "{count}-scene cinematic stitch: {count} image-to-video clips + local stitch",
    cinematicStitchFfmpegNote: "Stitching is done by local stitch (each clip is animated separately)",
    ...
    imagePreflightTeachingCarousel: "Teaching carousel: {count} educational slides + planning call.",
    ...
    imagePreflightStoryboard: "Storyboard mode: multiple scene images + AI planning.",
    ...
    videoCreativeModes: {
      "product-assistant": {
        ...
        description: "Upload product + packaging + angles → AI analyzes photos → situational video generation reel",
      },
      "product-promo": {
    ...
    setupCallouts: {
      ...
      "video-only": "Video workflow — video generation + BGM. Upload product photo + reference ad MP4 on the next screen.",
    ...
    videoKeyframeHint: "The still image video generation will animate (your photo or a generated image)",
    downloadImage: "Download image",
    ...
    imageReviewHeroHint: "Preview, edit, download, or regenerate your content.",
    ...
    imageReviewCompleteSingle: "Generation completed! Your image is ready to review.",
    ...
    imageReviewEditCanvasBtn: "Add logo & edit",
    ...
    generationWaitHint: "Hang tight — your creative is rendering in this frame.",
    ...
    adPack: {
      ...
      voiceoverSkippedNote: "Voiceover failed — video kept with BGM only. Check service credentials.",
  ...
  templates: {
    ...
    "storyboard-video": {
      ...
      description: "AI storyboard → scene images → one video generation clip",
    },
    "ugc-presenter-reel": {
  ...
  errors: {
    ...
    voiceoverFailed: "Voiceover dub failed. Check service credentials or disable spoken voiceover.",
    ugcPresenterFailed: "Digital presenter video failed. Check service credentials and try again.",
  ...
  ugcStudio: {
    ...
    scriptPlaceholder: "Keep it under ~10 seconds — one hook + one benefit + CTA.",
    scriptHint: "For ~10s UGC, aim for 1–3 short sentences. Edit AI script before generate.",
    planScript: "AI write script (AI)",
    planningScript: "Writing script…",
    planScriptHint: "Uses AI to draft a ~10s spoken intro from your product name. Edit freely after.",
    ...
    avatarVoiceHint: "Each stock presenter has a paired MiniMax voice for the language you selected.",
    ...
    customHint: "Upload a clear product photo, then generate a keyframe with the product in hand/wrist.",
    stockHint: "Stock avatar is the quickest way to see lip-sync. No product photo required.",
    stockNoProductNote:
    ...
    voiceMatchesAvatarNote: "Changing the presenter also changes their paired voice.",
    ...
    costHint: "Uses tokens for voice (if synthesized) + digital presenter video (~30 tokens/sec of audio ≈ $0.10/s). Sign in required.",
  ...
  captions: {
    ...
    planCaptionVoiceTopicPlaceholder: "e.g. free ad creatives for SMBs, one-stop promo…",
    ...
    syncCaptionsNeedScript: "Paste a voice script above first, then sync captions.",
    ...
    expandCaptionVoiceFailed: "Could not lengthen spoken lines. Check AI API key.",
    ...
    beatStatusReady: "Detected {n} beats — drag with Snap on, or Align captions to beats.",
    beatStatusEmpty: "No beats detected — add BGM first, then wait for re-analysis.",
    beatStatusUnavailable: "Beat detection needs a server video URL (add BGM or open from studio).",
  ...
  contentResearch: {
    ...
    searchCooldown: "XHS API needs a short cooldown — wait {seconds}s before searching again.",
    ...
    resultSubtitle: "Based on trending posts from Xiaohongshu, Instagram, TikTok.",
  ...
  microWizard: {
    ...
    outputGoalHint: "Pick image, video, or both — you can change this later in Advanced studio.",
    pickAngleTitle: "Pick a reference post",
    pickAngleHint: "Choose an angle from research — we borrow layout and style, not the topic.",
    generateImageTitle: "Generate image",
    generateWaitEyebrow: "STEP 5",
    generateImageHint: "Review settings above, then generate your poster or keyframe.",
    generateImageFooterHint: "Pick output count (single / A/B / campaign / teaching carousel), then tap Generate image below.",
    referenceAnalyzeReadyTitle: "Reference analysis complete",
    referenceAnalyzeReadyHint: "Done — advancing automatically, or tap Continue.",
    ...
    videoModeHint: "How should video generation use your keyframe or reference?",
    imagePromptTitle: "Image polish prompt",
    imagePromptHint: "Optional extra instructions for AI image before generating.",
    cinematicModeTitle: "Concept cinematic style",
    cinematicModeHint: "Single 8s cinematic clip only. Multi-scene stitch is not available yet.",
    sceneCountTitle: "How many scenes?",
    sceneCountHint: "Each scene is ~8 seconds. 4–5 scenes ≈ 30–40s after stitch.",
    intakeTitle: "How do you want to start?",
    intakeHint: "Research finds trending layouts; Direct lets you upload your own references.",
    intakeResearchTitle: "Platform research",
    intakeResearchDesc: "Browse posts for style inspiration — copy stays yours.",
    ...
    intakeFuse: {
      ...
      conceptHint: "Platform research finds layout references. Concept assistant writes your brief without research.",
      tabsAriaLabel: "How to start",
      tabResearch: "Platform research",
      tabDirect: "Direct create",
      tabAssistant: "Concept assistant",
      pickTabHint: "Pick a tab to continue — research or create directly.",
    ...
    productNameStep: {
      ...
      examples: ["Goldstone bracelet", "Portable power station", "Vitamin C serum"],
      tipTitle: "Why we ask",
      tipBody:
    ...
    preGenerateSetup: {
      ...
      mainPhotoHint: "Clear front-facing product shot — this drives product identity in the output.",
      anglePhotoRowLabel: "Other angles",
      anglePhotoOptional: "Optional",
      anglePhotoHint: "Extra angles help material and form detail. Not required.",
      productPhotosHint:
      ...
      storyboardHint: "Optional story notes plus duration / scene count for the stitched reel.",
    ...
    conceptNameStep: {
      ...
      examplesLabel: "Try an example",
      examples: ["Fast-approval personal loan", "Yoga membership", "SaaS free trial"],
      tipTitle: "Why we ask",
      tipBody:
    ...
    conceptSourceHint: "Pick one starting point — AI brief or platform research, not both.",
    conceptSourceAssistantTitle: "Concept assistant",
    conceptSourceAssistantDesc: "AI writes copy and visual direction — skips platform research.",
    conceptSourceResearchTitle: "Platform research",
    conceptSourceResearchDesc: "Find trending layout references — skips concept assistant; copy review required.",
    conceptTopicTitle: "Concept name",
    conceptTopicHint: "Name your service or concept — next you’ll choose research or Concept assistant.",
    ...
    copyEditHint: "Hook, subline, offer, and optional brand kit before generating.",
    brandKitSummary: "Brand settings (optional)",
    refImageTitle: "Reference image (optional)",
    refImageHint: "Match layout and colors — your product and copy still drive the topic.",
    imageOptionsTitle: "Image options",
    imageOptionsHint: "Art style, aspect ratio, and text mode — defaults are fine for most paths.",
    videoSettingsTitle: "Video settings",
    videoSettingsHint: "Duration and resolution affect billing — set before generating.",
    analyzing: "Analyzing…",
    ...
    fallbackHint: "Use Advanced studio for this path until v2 parity ships.",
    blockReasons: {
      ...
      complete_research: "Apply a research direction, or switch to Direct create.",
      ...
      need_reference_video: "Upload a reference MP4 (or pick a reel from research).",
      need_brand_website: "Brand website is optional — continue without it.",
      need_duration_before_reel: "Pick explicit video duration before reel analyze.",
    ...
    combinedAnimateDesc: "Multi-scene keyframes → one stitched Reel. This is the only image+video path.",
    ...
    legacyImageHint: "Continue to the image studio — generate keyframes, then return here.",
    doneTitle: "Export",
