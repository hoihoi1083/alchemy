...
export const en = {
  ...
  auth: {
	...
	account: {
		...
		consumeKinds: {
			...
			smart_layers_sam: "Smart layers — SAM cutout",
			smart_layers_matte: "Smart layers — matte",
			smart_layers_heal: "Smart layers — heal",
			smart_layers_qwen: "Smart layers — split",
			smart_layers_seedream: "Smart layers — split into editable layers",
			smart_layers_expand: "Smart layers — AI outpaint",
		},
  ...
  landing: {
    ...
    ultraCanvasNavLink: "Ultra canvas",
		...
		toolCaptionsTitle: "Captions & video finish",
		toolCaptionsDesc:
			"AI picture edit, trim/join, captions, BGM & burn — full finish studio.",
...
"brand-fit":
  ...
  errors: {
	...
	captions: {
		...
		trimIn: "Start (sec)",
		trimOut: "End (sec)",
		tryCaptions2: "Open Captions (timeline board)",
	},
	captions2: {
		badge: "Captions · finish studio",
		title: "Captions",
		subtitle:
			"One board: trim and split on the timeline, AI-edit a selected clip, arrange captions & BGM, then burn.",
		diffTitle: "How this board works",
		diffBody:
			"One board: trim/split on the timeline, AI-edit a clip, plan captions + VO from a topic, mix voice & BGM, then burn — all without leaving Captions.",
		openClassic: "Classic caption tools →",
		phaseImport: "1 · Import",
		phaseCaptions: "3 · Captions",
		phaseFinish: "4 · Finish",
		phasePictureName: "Picture",
		phaseStructureName: "Structure",
		...
		phaseHowToFinish:
			"Preview/mix VO, add library or AI BGM. Caption AI plan is on Captions. Then export / burn.",
		dismissTip: "Dismiss",
		showProcessed: "Show captioned",
		tokenCostHint: (n: number) => `~${n} tokens · cloud speech-to-text`,
		emptyLinesHint: "No lines yet — add a line, run From speech, or use AI plan.",
		stickyPictureHint: "Edit look with AI, or skip to trim / join.",
		stickyStructureHint: "Edit the timeline (trim / split / bind), then continue to captions.",
		stickyCaptionsHint: "Drag caption blocks on the timeline, or edit lines on the right.",
		...
		continueStructure: "Continue to structure",
		continueCaptions: "Continue to captions",
		importHint:
			"Import a video — trim on the timeline, AI-edit a clip, add captions and BGM.",
		fromLink: "From link",
		uploadedVideo: "Uploaded video",
		readyAuto: "Video ready — run Auto captions from speech.",
		readyPicture: "Video ready — trim on the timeline, AI-edit a clip, add captions.",
		mediaBin: "Media",
		boardHint:
			"Trim / split on the timeline, AI-edit the selected clip, arrange captions & BGM.",
		tabEdit: "Edit",
		tabCaptions: "Captions",
		tabAudio: "Audio · Finish",
		stickyBoardHint: "Trim → AI-edit selected clip → captions → burn when ready.",
		pictureTitle: "AI picture edit",
		pictureHint:
			"Pick a job chip, add a reference photo or short note, then generate. Applies to the look — not a full remake prompt.",
		pictureHintSelected:
			"Applies to the selected timeline clip (trim that clip first if you only want a section).",
		jobProduct: "Swap product",
		jobScene: "Swap background",
		jobStyle: "Restyle",
		refPhoto: "Reference photo",
		refHint: "Product or background still for the swap.",
		editNoteLabel: "Optional note",
		editNotePlaceholder: "e.g. keep the bottle label readable",
		editGenerate: "Generate edit",
		editGenerating: "Editing video…",
		editStageTrim: "Trimming selected clip…",
		editStageGenerate: "Generating AI edit… (may take up to a couple of minutes)",
		...
		editDoneOnClip: "Selected clip updated — keep arranging on the timeline.",
		downloadEdited: "Download edited clip",
		downloadingEdited: "Downloading…",
		editDownloadFailed: "Could not download the edited clip.",
		structureTitle: "Timeline · trim & bind",
		structureHint:
			"Drag edges to trim, scissors to split, drag clips to reorder (magnetic). Add more clips from media.",
		addClip: "Add clip to timeline",
		addClipFromLibrary: "Add from library",
		addClipFromFile: "Upload & add file",
		joinClips: "Join clips",
		joining: "Joining…",
		clipN: (n: number) => `Clip ${n}`,
		needTwoClips: "Add at least one extra clip to join.",
		joinFree: "Timeline trim & join are free. AI picture edit costs tokens.",
		joinFailed: "Could not join clips.",
		...
		pureEditHint: "Add line → edit text & timing → Continue to finish.",
		autoTitle: "Auto captions from speech",
		autoHint:
			"Extracts audio → transcribes → fills timed lines. Cloud speech-to-text uses a small plan token.",
		...
		noSpeech:
			"No speech detected (silent AI video?). Switch to Pure captions, or open Audio · Finish to plan VO from a topic.",
		silentHint: "Silent reel?",
		openClassicPlan: "Need classic caption tools? →",
		evenSplitNote: "timing estimated (no speech segments)",
		asrCloud: "cloud speech",
		asrLocal: "on-device speech",
	...
	editImage2: {
		...
		subtitleShortcuts: "Scroll zoom · drag background to pan · Space pan · ⌘Z undo",
		upload: "Upload",
		undo: "Undo",
		redo: "Redo",
		zoomOut: "Zoom out",
		...
		save: "Save",
		clearAll: "Clear all",
		clearAllConfirm: "Clear the canvas and start over? Unsaved work will be lost.",
		dropTitle: "Drop an image here",
		dropHint:
			"Upload a poster — keep the look, then Split layers or box-lift one piece. No full-image regen.",
		tokenHint: (
			split: number,
			erasePerMp: number,
			heal: number,
			...
			`Split ${split} · AI edit ${edit} · erase/fill ~${erasePerMp}/MP · fallback ${heal} · matte ${matte}`,
		uploading: "Uploading…",
		...
		cuttingCleanly: "Cutting cleanly…",
		cutReadyHealed: "Cut ready — hole filled. Drag freely.",
		...
		grabClick: "Click grab",
		grabClickOn: "Click grab on",
		grabClickHint: "Click a piece on the photo — we’ll lift it and clear the hole.",
		grabClickReady: "Grabbed — drag freely. Matte if edges need cleaning.",
		brushErase: "Brush erase",
		brushEraseOn: "Brush erase on",
		brushEraseHint: "Paint over leftovers, then Erase painted (no new layer).",
		brushErasePlate: "Brush clean plate",
		brushErasePlateOn: "Brush clean plate on",
		brushErasePlateHint: "Paint leftovers on the background, then apply — cleans the plate only.",
		brushEraseLayer: "Brush erase layer",
		brushEraseLayerOn: "Brush erase layer on",
		brushEraseLayerHint: "Paint on the selected layer — punches holes in that piece only.",
		erasePainted: "Erase painted",
		eraseLayerPainted: "Erase on layer",
		erasePaintedDone: "Painted area erased from background.",
		expandTitle: "AI outpaint to ratio",
		expandHow:
		...
		expandWider: (n: number) => `4:5 · ${n} tok`,
		expanding: "AI outpainting…",
		expandDone: "Plate outpainted — drag layers to fit the new frame.",
		expandFailed: "Outpaint failed",
		expandNeedHttpBg: "Background needs a server URL — Split layers once, then outpaint.",
		...
		magicFullEditDoneClearedLayers:
			"Whole image updated — previous layers were cleared so they don’t fight the new plate.",
		magicFullEditFailed: "Full-image edit failed",
		magicFullEditNeedPrompt: "Describe what to change on the whole image.",
		magicFullEditNeedImage: "Upload an image first.",
		qwenSplitting: "Splitting layers…",
		qwenRegionSplitting: "Splitting selection…",
		qwenRegionReady: "Region split — new layers added; background patched under the box.",
		layersReadyHint:
			"Layers ready — leftovers stay on the background. Use Erase, or box + split selection.",
		readyToEdit: "Image ready — split layers, then erase leftovers or split a selection.",
		readyLiftHint: "Box select is on — drag around one whole component. Release to lift.",
		readyManualHint:
			"Image ready — Split layers (text + objects), or box-lift one piece. Your layout stays.",
		emptyLiftHint: "No layers yet — Split layers, or box/brush a region.",
		boxLift: "Box lift",
		...
		qwenBoxHint: "Box a leftover on the background — we’ll split only that region.",
		qwenNeedHttpBg: "Background isn’t ready yet — try Split layers again after upload.",
		erase: "Clean plate",
		eraseOn: "Clean plate on",
		eraseHint: "Box an unwanted leftover on the background to remove it (no new layer).",
		erasePlate: "Clean plate",
		erasePlateOn: "Clean plate on",
		erasePlateHint: "Box leftovers on the background — inpaint the plate only. Layers stay.",
		erasePlateDone: "Erased from background plate.",
		eraseLayer: "Erase layer",
		eraseLayerOn: "Erase layer on",
		eraseLayerHint: "Select a layer first, then box the part to punch out (transparent hole in that piece).",
		eraseLayerNeedSelect: "Select a layer first, then erase on it.",
		eraseLayerDone: "Erased from this layer.",
		erasingHole: "Erasing…",
		eraseDone: "Erased from background.",
		missTools: "Leftovers",
		missToolsHint:
			"Missed a piece? AI-edit a region, clean the plate, erase on a layer, box-lift, or split a selection.",
		lifting: "Cutting & cleaning…",
		makeEditableText: "Edit as text",
		makeEditableTextHint:
			"Free: swap the image crop for real type — 25+ fonts, outline / soft & hard shadow / glow / neon, and separate fill · stroke · shadow colors.",
		liveText: "Edit as text",
		liveTextOn: "Editable text on",
		bold: "Bold",
		color: "Color",
		strokeColor: "Stroke",
		effectColor: "Shadow",
		effectColorHint: "Shadow or glow color (independent of fill)",
		fontStyle: "Font",
		fontGroupSystem: "System",
		fontGroupCjk: "Chinese",
		fontGroupSans: "Sans",
		fontGroupSerif: "Serif",
		fontGroupDisplay: "Display / poster",
		fontGroupScript: "Script",
		fontSystem: "System",
		fontPingFang: "PingFang / Heiti",
		fontSongtiSystem: "Songti (system)",
		fontYuantiSystem: "Rounded (system)",
		fontNotoSansSc: "Noto Sans SC",
		fontNotoSansTc: "Noto Sans TC",
		fontNotoSerifSc: "Noto Serif SC",
		fontZcoolXiaowei: "ZCOOL XiaoWei",
		fontZcoolQingke: "ZCOOL QingKe",
		...
		textEffectHeavyOutline: "Heavy outline",
		textEffectSoftShadow: "Soft shadow",
		textEffectHardShadow: "Hard shadow",
		textEffectGlow: "Glow",
		textEffectNeon: "Neon",
		textEffectOutlineShadow: "Outline + shadow",
		textEffectShadow: "Shadow",
		add: "Add",
		addHow: "Add plain text, shapes, logo — or generate a new AI sticker onto the board.",
		aiAddComponent: "AI component",
		aiAddHow:
			"Describe a badge, icon, product, or sticker. Lands as its own transparent layer you can drag.",
		aiAddPlaceholder: "e.g. gold limited-time corner badge · red sale burst · cute mascot wave",
		aiAddRun: (n: number) => `Generate component ${n}`,
		aiAddGenerating: "Generating component…",
		aiAddReady: "AI component added — drag to place.",
		aiAddFailed: "AI component failed",
		aiAddNeedPrompt: "Describe the component first.",
		cropEditTitle: "Edit selection",
		cropEditHow: "Two ways to change this piece — pick a tab below.",
		cropEditModeText: "Change words",
		cropEditModeAi: "AI edit look",
		cropEditModeTextHint:
			"Keep letter style, rewrite wording only (~image tokens).",
		cropEditModeAiHint:
		...
		aiEditingCrop: "AI editing selection…",
		aiEditCropDone: "Selection updated.",
		aiEditCropFailed: "AI region edit failed",
		aiEditNeedInstruction: "Describe what you want changed in this region.",
		chargedAiEditCrop: (n: number) => `AI region edit · ${n} tokens`,
		aiRewriting: "AI rewriting text…",
		aiRewriteDone: "Text rewritten — style matched from the crop.",
		aiRewriteFailed: "AI text rewrite failed",
		aiRewriteNeedText: "Enter the new wording first.",
		aiRewriteNeedHttpCrop: "This crop isn’t ready for AI rewrite — using plain text edit instead.",
		...
		updatingLayers: "Splitting layers…",
		layers: "Layers",
		...
		capsule: "Capsule",
		circle: "Circle",
		brandKitHint: "Brand Kit",
		brandKitForLogo: "for logo",
		brushCutout: "Brush",
		brushOn: "Brush on",
		size: "Size",
		...
		copyLayer: "Copy",
		pasteLayer: "Paste",
		layerCopied: "Layer copied — Paste or ⌘V to place.",
		layerPasted: "Layer pasted.",
		layerClipboardEmpty: "Nothing to paste — Copy a layer first.",
		forward: "↑",
		backward: "↓",
		toFront: "Top",
		toBack: "Bottom",
		matte: (n: number) => `Matte ${n}`,
		matting: "…",
		delete: "Delete",
		editTextPlaceholder: "Type new wording…",
		editTextHintEnable: "Type new wording, then AI rewrite (keeps style) or Edit as text",
		enablingText: "Clearing original text from the plate…",
		textEditableNow: "Text is editable — change wording, size, font, or direction.",
		aiRewrite: (n: number) => `AI rewrite ${n}`,
		aiRewriteHint:
			"Ignore OCR gibberish — type the real new wording. AI keeps style from the crop.",
		qwenTextEditHint:
			"Layers are visual crops. To change words: type new copy → AI rewrite. Live text is a plain-font fallback.",
		cropEditIdle:
			"Select a layer on the canvas, or use AI edit region to box what you want to change.",
		aiEditRegion: "AI edit region",
		aiEditRegionOn: "AI edit region on",
		aiEditRegionHint:
			"Drag a box around what you want to change. Release → type what to do → AI edits only that crop.",
		aiEditRegionReady: "Region ready — describe the change below, then run AI edit.",
		brushCutoutLabel: "Brush cutout",
		brandLogoLabel: "Brand logo",
		layerText: (s: string) => `Text: ${s}`,
		layerLogo: (s: string) => `Logo: ${s}`,
		layerShape: (s: string) => `Shape: ${s}`,
		layerObject: (s: string) => `Object: ${s}`,
		chargedDetect: (n: number, bal?: number) =>
			bal != null
				? `Charged ${n} tokens for detect · balance ${bal}`
				: `Charged ${n} tokens for detect`,
		chargedHeal: (n: number) => `Charged ${n} tokens for local heal fallback`,
		chargedMatte: (n: number) => `Charged ${n} tokens for matte cutout`,
		blurPunchFallback: "Used free local blur punch (server heal unavailable).",
		downloaded: "Downloaded flattened PNG (background + layers).",
		downloadLayer: "Download piece",
		downloadLayerHint: "Save only this selected layer as PNG — not the full board.",
		downloadedLayer: "Downloaded this layer PNG.",
		downloadLayerNeedImage: "This layer has no image file yet (live text / shape). Use Download for the full board, or convert to an image crop first.",
		downloadLayerFailed: "Could not download this layer.",
		savedLibrary: "Saved to library",
		noLayersDetected: "No layers detected. Try Brush cutout to lift regions manually.",
		detectMissHint: "Missed areas? Use Brush or Box under Lift missed areas.",
		...
		logoLoadFailed: "Logo failed to load",
		couldNotAddLogo: "Could not add brand logo",
		brushFailed: "Brush cutout failed",
		matteFailed: "Matte failed",
		noCropForMatte: "No crop URL for matte.",
		nothingToExport: "Nothing to export yet.",
		exportFailedLoading: "Export failed — images may still be loading. Try again.",
		exportFailedGeneric:
			"Could not export — wait for layers to finish loading, then retry.",
		saveFailed: "Could not save to library",
		titleShow: "Show",
		titleHide: "Hide",
		titleLock: "Lock",
		titleUnlock: "Unlock",
		titleForward: "Forward",
		titleBackward: "Backward",
		titleBrandLogo: "Brand Kit logo",
		titleNeedBrandLogo: "Upload logo in Brand Kit first",
	},
	imageCanvas: {
  ...
  ultraCanvas: {
    ...
    directorChips: {
      ...
      beats: "Micro beats (product)",
      action: "Action impact",
    },
    directorChipsHint:
      "Optional: tap a chip to paste helper text into the box above. For action films, skip these — write your own motion, or use Action impact only.",
    scriptNode: {
    ...
    spliceHint: "Connect video nodes (and optional audio for BGM). Reorder cuts in the list below.",
    spliceOrder: {
      title: "Cut order",
      empty: "Wire video nodes into this splice — then reorder here.",
      hint: "↑↓ sets play order. Canvas position no longer controls cut order.",
      moveUp: "Move earlier",
      moveDown: "Move later",
      ready: "Ready",
      waiting: "Generate video first",
      needClips: "Connect finished video clips before splicing.",
    },
    videoProControls: {
      ...
      engineHint:
        "Single-clip first for face/product lock and punchy clips. Switch to reference reel for multi-still style.",
      aspectRatio: "Aspect ratio",
      camera: "Camera move",
  ...
  ultraCanvas2: {
    ...
    title: "Ultra canvas",
    subtitle:
      "Pick a start, then edit freely on the same Ultra board. Add any nodes from the palette.",
    backClassic: "Ultra →",
    tryBeta: "Ultra canvas",
    costHint:
      "Pay-per-use tokens. Each image or video run deducts from your Alchemy balance.",
    howTitle: "How do you want to create?",
    howSubtitle: "Pick a start. You can add or reconnect any nodes after.",
		noImageHint: "",
		...
		saveNow: "Save",
		versionHistory: "Saved boards",
		dirtyUnsaved: "Unsaved changes",
		cards: {
			textToImage: {
				title: "Text → image",
				desc: "Generate a still from a written prompt. No upload needed.",
				flow: "Image prompt → Generate still",
			},
			refToImage: {
				title: "Reference → image",
				desc: "Upload a product or still, then generate or edit from it.",
				flow: "Upload → Image",
			},
			imagesToVideo: {
				title: "Images → video",
				desc: "Turn an image (upload or generate) into a short motion clip.",
				flow: "Upload → Image → Image-to-video",
			},
			storyboard: {
				title: "Storyboard",
				desc: "Plan scenes, stills, voice and splice into a multi-clip ad.",
				flow: "Script → Storyboard → Voice → Splice",
			},
			scratch: {
				title: "Build from scratch",
				desc: "Empty board — add and connect nodes yourself.",
				flow: "Add nodes → Connect → Run",
			},
		},
		useWorkflow: "Use workflow →",
		recommended: "Recommended",
		loadSavedTitle: "Load a saved board",
		loadSavedHint: "Continue a board you already saved to Ultra.",
		loadSavedEmpty: "No saved boards yet — pick a start above.",
		continueBoard: "Continue current board",
		changeStart: "Start picker",
