...
"brand-fit":
  ...
  errors: {
	...
	editImage2: {
		...
		makeEditableTextHint:
			"Free: swap the image crop for real type — edit words, font, horizontal ↔ vertical, outline/shadow.",
  ...
  ultraCanvas: {
    ...
    videoProControls: {
      ...
      engine: "AI model",
      engineMinimaxH3: "MiniMax H3 (default)",
      engineSeedance: "Seedance 2.0",
      engineHint:
        "H3 first for face/product lock and punchy single clips. Switch to Seedance for reference-reel / multi-still style.",
      aspectRatio: "Aspect ratio",
      camera: "Camera move",
