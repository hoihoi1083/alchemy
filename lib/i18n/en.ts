...
export const en = {
  ...
  ultraCanvas: {
    ...
    creativeBHint: {
      title: "Creative B workflow",
      steps: [
        "Fill characters + product/UI uploads, then run script planning.",
        "Spawn image→video pipeline — cast + continuity auto-wire; check @PersonA/@PersonB/@brand on demo beats.",
        "Run all → splice + audio → Captions studio for VO/subtitles.",
      ],
      dismiss: "Dismiss",
    },
    confirmOk: "Confirm",
    ...
    scriptNode: {
      ...
      beatsTitle: "Director beats (time · emotion · shot · line)",
      beatTimePlaceholder: "0-2s",
    ...
    characterNode: {
      hint: "AI-generate a face sheet, upload one, or pick from library — then wire to scene images / @mention.",
    ...
    videoPromptPlaceholder: "Motion / scene description…",
    ...
    templates: {
      ...
      storyDifferenceAd: {
        ...
        desc: "Creative B — pain → Alchemy research → product → CTA (characters + beats prewired)",
      },
    },
  },
} as const;
