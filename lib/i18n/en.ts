...
export const en = {
  ...
  pricing: {
    ...
    comparisonRows: [
      ...
      { feature: "Max image resolution", free: "1K", standard: "1K", pro: "2K", master: "4K" },
  ...
  microWizard: {
    ...
    cinematicModeHint: "Single 8s clip for quick tests, or multi-scene stitch for ~30s pre-rolls.",
    ...
    blockReasons: {
      ...
      pick_combined_style: "Pick cinematic stitch or animate keyframe.",
