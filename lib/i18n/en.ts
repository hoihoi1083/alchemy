...
export const en = {
  ...
  landing: {
    ...
    captionsLink: "Add captions to any video",
  ...
  captions: {
    ...
    subtitle:
      "Upload any reel MP4, write timed on-screen lines, and burn them in. Edit text anytime and re-apply — always from your original video.",
  ...
  contentResearch: {
    ...
    promoteProductHint:
      "We borrow layout and style from the reference post — all copy and slides will be about your product, not the post topic (e.g. zodiac).",
    ...
    appliedWithVideoReference:
      "Angle applied — reference post video loaded for Inspired by reference video (@Video1). Review fields and continue.",
