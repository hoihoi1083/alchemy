  ...
  auth: {
	...
	account: {
		...
		consumeKinds: {
			...
			smart_layers_expand: "Smart layers — expand",
		},
...
"brand-fit":
  ...
  errors: {
	...
	editImage2: {
		...
		changeWordsHint: "Type new copy, then one tap — keeps the look of this text crop.",
		...
		expandTitle: "Magic Expand",
		expandHow: "Grow the canvas to a social size. Layers stay; only the background expands.",
		expandSquare: (n: number) => `1:1 · ${n}`,
		expandStory: (n: number) => `9:16 · ${n}`,
		expandLandscape: (n: number) => `16:9 · ${n}`,
		expandWider: (n: number) => `4:5 · ${n}`,
		expanding: "Expanding canvas…",
		expandDone: "Canvas expanded — drag layers to fit the new frame.",
		expandFailed: "Expand failed",
		expandNeedHttpBg: "Background needs a server URL — Split layers once, then expand.",
		expandAlready: "Already close to that ratio — nudged the edges slightly.",
		magicChatTitle: "Magic chat",
		magicChatHint:
			"Try: 拆层 · 改成新文案 · 点选提起 · 笔刷擦除 · 扩展 9:16 · or describe an AI edit on the selected layer",
		magicChatPlaceholder: "Tell Magic what to do…",
		magicChatSend: "Run",
		magicChatHelp:
			"Split layers · Change words on a text layer · Click grab · Brush erase · Expand 1:1 / 9:16 / 16:9 · Or describe an edit on the selected piece",
		magicChatNeedLayer: "Select a layer first for that command.",
		...
		erasingHole: "Erasing from background…",
		eraseDone: "Erased from background.",
		missTools: "Leftovers",
		missToolsHint:
			"Pick a leftover: AI edit region (change it), Erase, box-lift, or split the selection.",
		...
		textEditableNow: "Text is editable — change wording, size, or color.",
		...
		cropEditHow:
			"Any selected layer: change wording, swap a flag, replace a face — describe it, AI edits only this crop.",
		cropEditModeText: "Change words",
		cropEditModeAi: "AI edit area",
		editInstructionPlaceholder:
			"e.g. Change text to「夏季大促」· England flag → China · replace face with a woman smiling",
		aiEditCrop: (n: number) => `AI edit ${n}`,
		aiEditCropHint:
			"Works on text OR image layers (flag, face, badge…). One region per run.",
