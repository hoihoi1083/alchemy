...
export const en = {
  ...
  landing: {
    ...
    subtitle:
      "Upload a product photo or paste a reference. Alchemy analyzes style, guides your setup, and generates editable ads and videos for IG, Facebook, and TikTok.",
    ...
    heroTrust: [
      "No blank prompt box",
      "Reference style, not copy",
      "Editable canvas",
      "Ready for 9:16 / 4:5 / 1:1",
    ],
    ...
    howSubtitle: "From reference to final creative in four guided steps.",
    howSteps: [
      {
        title: "Upload or paste reference",
        body: "Add your product photo, or bring a post / reel you like as style reference.",
      },
      {
        title: "AI analyzes the style",
        body: "We extract layout, color, and tone — then map them onto your product or concept.",
      },
      {
        title: "Edit copy & plan",
        body: "Review headlines, formats, and (when needed) storyboard stills before you spend tokens.",
      },
      {
        title: "Generate & edit creative",
        body: "Create images or video, then refine text, logo, and export sizes on the canvas.",
      },
    ],
    ...
    resultCardLabel: "Your brand content",
    refCardAlt: "Reference beverage style photo",
    resultCardAlt: "Branded beverage ad result",
    canvasTitle: "Fully editable canvas",
    canvasBody:
      "Generated creatives are not locked. Remove objects, add text and logos, then export the sizes you need.",
    canvasFeatures: ["Remove elements", "Add text", "Add logo", "Export sizes"],
    ...
    pricingSubtitle:
      "Real Alchemy plans — Free, Standard, Pro, Master, and Custom. All priced in Tokens.",
    ...
    tokensBody: "Examples of flat action costs. Video length scales with seconds and resolution.",
    tokensUnit: "tokens",
    tokenCostPlan: "AI plan / brief",
    tokenCostImage: "Single image",
    tokenCostStoryboard: "Storyboard pack (≈4 scenes)",
    tokenCostMusic: "Music bed",
    tokensVideoNote: "Short Seedance clips are billed per second — see Pricing for full detail.",
    tokensSeePricing: "See full pricing →",
    finalTitle: "Ready to create agency-like content?",
    finalBody: "Start free, upload one product photo, and ship your first ad in minutes.",
