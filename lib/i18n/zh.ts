...
socialDripFitTitle: "呢個格式可以／唔可以做咩",
	...
	contentResearch: {
		...
		directPostHint:
			"已有目標帖就唔使搜關鍵字 — 支援 xhslink、小紅書 explore、Instagram /p/ 或 /reel/。實體產品請先填上方產品名稱。xhslink 失效時，請喺 App 內「分享 → 複製連結」貼完整連結。",
		directPostUrlLabel: "參考帖連結",
		directPostUrlPlaceholder:
			"例如 xhslink / Instagram reel",
		directPostBtn: "用這篇帖",
