...
export const zh = {
  ...
  landing: {
    ...
    tplTitleAfter: "",
    tplSubtitle: "先揀渠道同格式，再入 Studio 換成你嘅品牌。",
  ...
  pricing: {
    ...
    faq: [
      ...
      },
      {
        q: "點樣降級計劃？",
        body:
          "喺收費頁揀較低計劃。降級會排程到下一個帳單日生效 — 之前你仍然用緊目前計劃、功能同剩餘點數。較低價錢同每月點數由下個週期開始。咁樣可以避免中途用低價享用高計劃權益。「管理帳單」用嚟取消續訂／改卡，唔係揀較低計劃。",
      },
      {
        q: "喺邊度改計劃或取消訂閱？",
        body:
  ...
  wizard: {
    ...
    imageReviewStoryboardReadyBody:
      "檢查呢啲場景圖，然後繼續去影片設定。呢度未係最終影片。",
    imageReviewStoryboardHeroBefore: "檢查你嘅",
    imageReviewStoryboardHeroAccent: "分鏡圖。",
    imageReviewStoryboardHeroHint: "確認場景包無問題，再繼續製作影片。",
