...
socialDripFitTitle: "呢個格式可以／唔可以做咩",
	...
	captions: {
		...
		trimIn: "開始（秒）",
		trimOut: "結束（秒）",
		tryCaptions2: "試 Caption studio 2（語音自動字幕）",
	},
	captions2: {
		badge: "Caption studio 2 · 語音優先",
		title: "Caption studio 2",
		subtitle:
			"新流程：由片內人聲自動抽出時間軸字幕，再用 FFmpeg 修剪／BGM／燒錄。可同經典版對比。",
		diffTitle: "同經典 Captions 有咩分別",
		diffBody:
			"經典版＝你自己寫，或用主題 AI 規劃字幕 + 完整配音。Studio 2＝聽片入面聲（Whisper/OpenAI）填時間軸再燒錄。無聲 Seedance 片唔會自動有字 — 請手寫或用經典版用主題規劃。",
		openClassic: "打開經典 Caption studio →",
		phaseImport: "1 · 匯入",
		phaseCaptions: "2 · 自動字幕",
		phaseFinish: "3 · 完成",
		phaseCaptionsName: "字幕",
		phaseFinishName: "完成",
		phaseHowToCaptions: "撳語音自動字幕，再喺右邊改時間軸。啱就繼續完成。",
		phaseHowToFinish: "可選 BGM，然後燒字幕。完成後下載。",
		dismissTip: "收起",
		showProcessed: "顯示已燒字幕",
		tokenCostHint: (n: number) => `約 ${n} tok · 雲端語音轉文字`,
		emptyLinesHint: "未有字幕行 — 撳語音自動字幕，或新增一行。",
		stickyCaptionsHint: "語音 → 時間軸，再繼續燒錄。",
		stickyFinishHint: (n: number) =>
			n > 0 ? `已有 ${n} 行可燒錄` : "燒錄前請先有字幕文字",
		backToCaptions: "返回字幕",
		importHint: "匯入方式同經典版 — 跟住撳「語音自動字幕」。",
		fromLink: "來自連結",
		uploadedVideo: "已上載影片",
		readyAuto: "影片就緒 — 可以撳語音自動字幕。",
		autoTitle: "語音自動字幕",
		autoHint: "抽音軌 → 轉文字 → 填入時間軸。雲端 ASR 會扣少量 plan token。",
		autoCta: "語音自動字幕",
		transcribing: "聽緊同寫緊字幕…",
		transcribeDone: (n: number) => `已由語音填入 ${n} 行字幕`,
		transcribeFailed: "轉寫失敗。",
		noSpeech: "聽唔到人聲（可能係無聲 AI 片）。請手寫字幕，或去經典版用主題規劃。",
		silentHint: "無聲短片？",
		openClassicPlan: "去經典版用主題規劃字幕 →",
		evenSplitNote: "時間軸為估算（ASR 冇分段）",
		asrCloud: "雲端 ASR",
		asrLocal: "本機 Whisper",
		chargedTok: (n: number) => `${n} tok`,
		needVideo: "請先載入影片。",
		continueFinish: "繼續完成（BGM + 燒錄）",
		finishHint: "可選 BGM，然後燒字幕（FFmpeg，同經典版同一引擎）。",
		classicVoiceNote: "要 AI 配音／主題規劃？請用經典 Caption studio。Studio 2 專注語音→燒錄。",
	},
	editImage2: {
		title: "AI 智能圖層",
