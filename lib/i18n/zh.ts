...
socialDripFitTitle: "呢個格式可以／唔可以做咩",
	...
	ultraCanvas: {
		...
		creativeBHint: {
			title: "Creative B 工作流",
			steps: [
				"填寫角色同產品上傳，然後執行劇本。",
				"生成 image→video 管線 — 將角色連到各場景圖片（或者提示詞 @提及）。",
				"全部執行 → 拼接 + 音訊 → 喺字幕工作室加配音/字幕。",
			],
			dismiss: "關閉",
		},
		confirmOk: "確認",
		...
		scriptNode: {
			...
			beatsTitle: "導演節拍（時間 · 情緒 · 鏡頭 · 台詞）",
			beatTimePlaceholder: "0-2秒",
		...
		characterNode: {
			hint: "可以 AI 生成人臉參考圖，或者上傳 / 從作品庫選擇 — 再連到場景圖片或 @提及。",
		...
		videoPromptPlaceholder: "動作 / 場景描述…",
		...
		templates: {
			...
			storyDifferenceAd: {
				name: "故事差異廣告",
				desc: "Creative B — 痛點 → Alchemy 調研 → 產品 → CTA（預置主角同節拍）",
			},
		},
	},
} as const;
