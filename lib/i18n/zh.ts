...
export const zh = {
  ...
  start: {
    ...
    chooseTypeLabel: "揀呢個類型",
    continueLabel: "進入 studio",
    continueToStep2: "繼續去第 2 步",
    ...
    roadmapTitle: "點樣運作",
    roadmapSubtitle: "五個階段 — 創作路徑會分支（只要圖、只要片，或兩者）。",
    phases: ["揀推廣類型", "揀創作路徑", "設定", "生成", "完成"],
    phaseBodies: [
      "揀實體產品定服務／概念。",
      "只要相片、只要影片，或先圖再片。",
      "填資料、研究、風格同素材。",
      "跑相片同／或影片 — 只顯示你條路徑需要嘅步驟。",
      "下載適合 IG／FB／TikTok 嘅廣告。",
    ],
  ...
  landing: {
    ...
    navCaptions: "字幕",
    navPro: "Pro",
    heroTrust: ["唔使空白 prompt", "參考風格唔抄內容", "可編輯畫布", "支援 9:16 / 4:5 / 1:1"],
    ...
    howSteps: [
      { title: "上傳或貼參考", body: "加產品相，或帶入你鍾意嘅帖／Reel 做風格參考。" },
      { title: "AI 分析風格", body: "抽出排版、色調同語氣，再套去你嘅產品或概念。" },
      { title: "改文案同規劃", body: "確認標題、格式；需要時先睇分鏡靜幀，再花 token。" },
      { title: "生成同編輯", body: "出圖或出片後，再喺畫布改字、加 Logo、導出尺寸。" },
    ],
    refTitle: "參考風格，出你品牌。",
    refBody: "學你鍾意嘅視覺風格，同時保持你自己嘅產品、賣點同品牌身份。",
    refCardLabel: "參考風格",
    resultCardLabel: "你嘅品牌內容",
    refCardAlt: "參考飲品風格圖",
    resultCardAlt: "品牌飲品廣告結果",
    canvasTitle: "完全可編輯畫布",
    canvasBody: "生成結果唔會鎖死。可以清元素、加文字同 Logo，再導出你要嘅尺寸。",
    ...
    tplTitleAfter: "",
    tplSubtitle: "由場景卡開始，跟住 Studio 精靈完成。",
    tplTabAll: "全部",
    tplTabProduct: "產品廣告",
    ...
    whyItems: [
      { title: "引導式，唔係空白框", body: "MicroWizard 一次一個決定，唔使面對空白 chat。" },
      { title: "參考風格，唔抄內容", body: "學排版同色調，保留你嘅產品同訊息。" },
      { title: "需要先分鏡先分鏡", body: "先圖後片會確認靜幀；只要影片就直接出片。" },
      { title: "輸出可再編輯", body: "生成後改字、Logo、排版，唔使成套重跑。" },
      { title: "產品同概念都得", body: "實體 SKU 同服務／品牌概念各自有路徑。" },
      { title: "Token 計費", body: "用多少付多少；計劃包月 token，用完可加購。" },
    ],
    scenariosTitle: "覆蓋常見營銷場景",
    scenariosSubtitle: "揀貼近你下一個 campaign 嘅行業方向。",
    scenarios: [
      { title: "電商零售", body: "一張產品相做出海報、套圖同短片。" },
      { title: "美容護膚", body: "適合 IG／TikTok 嘅乾淨生活感畫面同 Reel。" },
      { title: "餐飲食品", body: "跟熱門帖學風格，做出食欲感排版。" },
      { title: "教育教練", body: "概念同教學輪播路徑，唔一定要有實體貨。" },
      { title: "地產", body: "重點賣點圖同由靜幀做成短片。" },
      { title: "金融／SaaS", body: "清晰 offer 海報同品牌片，唔亂發明價格。" },
    ],
    pricingSubtitle: "真實計劃：Free／Standard／Pro／Master／Custom，全部用 Tokens。",
    pricingFreeCta: "免費開始",
    ...
    highlights: [
      ...
      { title: "先圖後片更易改", body: "先生成相，再做影片，修改成本更低。" },
      { title: "為中小企宣傳而設", body: "模板同 prompt 針對 IG/FB reels。" },
    ],
    sampleTitle: "典型輸出路徑",
    sampleTimeline: [
      "上傳產品相 + 填寫主標題",
    ...
    faqTitle: "常見問題",
    faq: [
      { q: "一條片大概幾耐？", a: "快速出圖約 10-30 秒；分鏡場景組約 2-5 分鐘；影片通常約 1-3 分鐘。" },
      { q: "重新生成會唔會多用 token？", a: "會。每次 AI 重新生成都係新模型調用，會再用 token。" },
  ...
  wizard: {
    ...
    creationPath: {
      ...
      continueToSetup: "繼續",
      nextTitle: "之後會點",
      nextSubtitleUnset: "上面揀路徑之後，Studio 只會顯示嗰條路需要嘅步驟。",
      nextSubtitleImage: "你嘅路徑：設定 → 相片 → 完成（冇影片步驟）。",
      nextSubtitleVideo: "你嘅路徑：設定 → 影片 → 完成（一般冇相片步驟）。",
      nextSubtitleCombined: "你嘅路徑：設定 → 相片 → 影片 → 完成。",
      nextStepsUnset: [
        { title: "設定", body: "填資料、研究、風格同素材。", icon: "setup" },
        { title: "生成", body: "相片、影片，或兩者 — 只跑你條路需要嘅。", icon: "generate" },
        { title: "完成", body: "下載同重用你嘅廣告。", icon: "done" },
      ],
      nextStepsImage: [
        { title: "設定", body: "填資料、研究、風格同素材。", icon: "setup" },
        { title: "相片", body: "生成同檢視靜態圖。", icon: "image" },
        { title: "完成", body: "下載同重用你嘅廣告。", icon: "done" },
      ],
      nextStepsVideo: [
        { title: "設定", body: "填資料、研究、風格同素材。", icon: "setup" },
        { title: "影片", body: "生成你嘅短片。", icon: "video" },
        { title: "完成", body: "下載同重用你嘅廣告。", icon: "done" },
      ],
      nextStepsCombined: [
        { title: "設定", body: "填資料、研究、風格同素材。", icon: "setup" },
        { title: "相片", body: "先生成同檢視靜態圖。", icon: "image" },
        { title: "影片", body: "將確認咗嘅畫面做成短片。", icon: "video" },
        { title: "完成", body: "下載同重用你嘅廣告。", icon: "done" },
      ],
    },
    ...
    visualStyles: {
      ...
      "brand-video": {
        title: "品牌影片分析",
        description: "分析官網 / 社交 → AI 寫 影片生成 影片 prompt",
      },
      "creative-video": {
        title: "創意影片 Prompt",
        description: "用中文描述你想拍嘅 Reel → AI 寫 影片生成 運鏡 prompt",
      },
      "concept-cinematic": {
        title: "概念電影感短片",
      ...
      "ugc-presenter": {
        title: "UGC 數字人口播",
        description: "產品關鍵幀 → digital presenter 對嘴講稿（似 viral 帶貨短片）",
      },
      "paper-layout": {
        title: "固定紙片版面（舊式）",
    ...
    brandVideoIntro:
      "貼官網或 IG @handle。AI 會分析品牌，再為 影片生成 寫專用影片 prompt（運鏡、氛圍）。上傳產品相片後生成 Reels。",
    modelWearIntro:
      "上傳產品相，AI 會生成似真模特兒佩戴或使用產品嘅 9:16 廣告圖。手鏈／手串會上手；洗鼻器等會示範用法。進階可揀「主體取景」控制露臉或只手。",
    creativeVideoIntro:
      "用中文描述你想拍嘅短片（例如：功夫對打後飲能量飲品）。AI 會寫 影片生成 運鏡 prompt，並提示點樣用參考片 / 雙畫面做到完整故事。只需影片步驟 — 上傳產品相片或關鍵圖即可。",
    ...
    storyboardVideoIntro:
      "已規劃分鏡同場景圖。生成影片會用 逐格圖生影片再拼接（唔再先等 影片生成）。",
    ...
    storyboardSceneCountHint: "片長會同步去步驟 3 影片設定。場景數量控制 AI 規劃幾張圖。",
    ...
    storyboardRegenerateAiCostHint: "按新場景出圖收費（開啟品牌 Logo 時為 2 倍 Token）。",
    storyboardStampLogoBtn: "印上品牌 Logo",
    storyboardStampingLogo: "印 Logo 中…",
    storyboardStampLogoHint:
      "最後一幕：置中印上 Brand kit Logo（唔經 AI、唔收費）。",
    ...
    videoAssistantStepHint:
      "已選 AI 影片助手 — 按「繼續」到步驟 3 上傳產品、包裝同角度相片，AI 會分析並寫 影片生成 prompt。",
    ...
    pathQuickVideoDesc: "一張產品相 + AI 寫 影片生成 運鏡 prompt → 短宣傳片。",
    ...
    cinematicStitchImageHint: "繼續去影片 — 會生成 {count} 段 影片生成 短片並自動拼接。",
    ...
    cinematicLogoModeBNote:
      "勾選「影片靜幀使用品牌 Logo」時，每張影片關鍵幀會印上 Brand kit Logo（角標；最後一幕置中）。",
    ...
    brandKit: {
      ...
      endWithLogoHint:
        "只用於影片 — 俾每張影片關鍵幀／靜幀加 Logo（2 倍出圖 Token；最後一幕置中）。圖片請去「編輯圖片」隨時加 Logo。",
      useLogoLabel: "影片靜幀使用品牌 Logo",
      useLogoHint:
        "只用於影片 — 俾每張影片關鍵幀／靜幀加你嘅 Logo（2 倍出圖 Token；最後一幕置中）。圖片請去「編輯圖片」隨時、任意位置加 Logo。",
      primaryColor: "主色",
      secondaryColor: "副色",
      accentColor: "強調色",
      tagline: "預設標語",
    ...
    conceptVideoPromptSectionHint:
      "唔使關鍵圖 — 影片生成 會由文字出片。請先喺上面按「規劃 AI 影片 prompt」。",
    ...
    cinematicRecipeSteps: [
      ...
      "2) 影片步驟按「AI 規劃影片 Prompt」寫 影片生成 運鏡文案。",
    ...
    videoCreativeModes: {
      "product-assistant": {
        title: "AI 影片助手",
        description: "上傳產品 + 包裝 + 角度 → AI 分析相片 → 寫 影片生成 情境 prompt",
      },
      "product-promo": {
        title: "產品宣傳片",
    ...
    imageReviewEditCanvasBtn: "加 Logo／編輯",
    ...
    imageReviewSteps: ["揀推廣目標", "填寫資料", "AI 分析", "揀風格", "生成內容"],
    videoReviewHeroBefore: "檢查你嘅",
    videoReviewHeroAccent: "生成影片。",
    videoReviewHeroHint: "預覽、下載、加字幕，或者重新生成。",
    ...
    step3Hint: "影片生成 將相片變成影片。可上傳參考廣告 MP4 跟運鏡（@Image1 + @Video1）。",
    step3Hints: {
      "video-only":
    ...
    videoPreflightAI: "＋1 次 AI 寫影片 prompt（品牌影片分析）",
    planVideoPromptBtn: "AI 寫影片 Prompt",
    planVideoPromptBusy: "AI 寫緊影片 prompt…",
    planVideoPromptReady: "已填入下方影片 Prompt — 請檢查後再生成",
    planVideoPromptDurationRefresh: "片長已改 — AI 按新片長重寫影片 prompt…",
    productVideoKitTitle: "產品相片套裝",
    productVideoKitHint:
      "上傳主產品（必填）、包裝或額外角度 — AI 視覺讀全部相，AI 再寫 影片生成 情境 prompt。",
  ...
  templates: {
    ...
    "brand-video": {
      name: "品牌影片分析",
      description: "AI 寫 影片生成 影片 prompt",
    },
    "creative-video": {
      name: "創意影片 Prompt",
      description: "描述創意 → AI 寫 影片生成 prompt",
    },
    "storyboard-video": {
      name: "故事分鏡片",
  ...
  errors: {
    ...
    ugcPresenterFailed: "數字人影片生成失敗。請檢查 service credentials 後再試。",
    ...
    researchReelAnalyzeFailed: "參考短片分析失敗 — 請稍後再試，或重新揀帖。",
  ...
  ugcStudio: {
    ...
    download: "下載 MP4",
    costHint: "會扣 token（聲線 + digital presenter 影片，約 30 token/秒音訊 ≈ $0.10/秒）。需要登入。",
    needScript: "請先填口播講稿。",
    needProduct: "請先填產品名稱。",
  ...
  imageCanvas: {
    ...
    cleanHint:
      "只圈選要刪嘅像素（似手機修圖局部修復）。只有高亮區域會重生，隔籬嘅卡片／文字會留低。",
    cleanBoxHint: "為每段文字拖貼實嘅方框 — 可畫多個後一次擦除",
    cleanMultiRegionHint: "可圈選最多 5 個區域。擦除只修復圈選內，唔會成個組件一齊刪。",
    ...
    cleanFillBtn: "按描述替換",
    cleanCostNote: "每次擦除消耗 1 次圖片生成額度（局部修復 / FLUX Fill）。",
  ...
  microWizard: {
    ...
    videoResultHint: "預覽、下載，或開啟字幕工作室加音樂同文字。",
    ...
    intakeFuse: {
      ...
      tipTitle: "參考風格，唔抄內容。",
      tipIntro: "AI 會分析排版、語氣、色調同構圖 — 唔會抄貼文內容或品牌。",
      tip1: {
        title: "效果更好",
    ...
    preVideoSetup: {
      titleBefore: "設定你嘅",
      titleAccent: "影片詳情",
      hint: "填文案、上傳產品相、揀片長同解像度，再生成短片。",
      assistantHint: "上傳產品相，等 AI 寫運鏡 prompt，檢查後再生成。",
      assistantTitle: "AI 影片方案",
      assistantBody: "DeepSeek 會睇你嘅產品相，寫好 Seedance 運鏡 prompt。",
      assistantNeedPlan: "請先分析相片 — 未有方案前唔可以生成。",
      assistantTip1: {
        title: "先分析再生成",
        body: "撳「分析相片並規劃影片」，等 AI 寫好運鏡 prompt。",
      },
      assistantTip2: {
        title: "可改 prompt",
        body: "生成前可以改 AI 寫好嘅運鏡文字。",
      },
      conceptHint: "確認主題同文案，相片選填，揀片長，再生成短片。",
      conceptCreativeHint: "寫清創作方向，相片選填，揀片長，再生成。",
      conceptBrandHint: "加品牌網站線索，相片選填，揀片長，再生成品牌短片。",
      contentTitle: "內容詳情",
      hookLabel: "主標題 (hook)",
      supportingLabel: "輔助文案",
      extraLabel: "額外要求",
      ...
      productPhotoHint: "清晰產品相 — 產品短片必須上傳。",
      conceptPhotoTitle: "參考相片",
      conceptPhotoHint: "選填 — 有畫面參考時動態會更穩。",
      brandTitle: "品牌網站",
      brandHint: "選填分析 — 幫品牌短片抓語氣同視覺。",
      dragDrop: "上傳",
      settingsTitle: "影片設定",
      ...
      stylePickerTitle: "影片創作方向",
      stylePickerHint: "揀點樣做短片 — 同圖像「創作方向」一樣放喺設定頁。",
      referenceHint: "上傳參考 MP4、填文案，再跟運鏡感覺生成。",
      ...
      referenceVideoHint: "跟運鏡／剪輯感覺 — 唔係逐格複製。",
