...
export const zh = {
	...
	landing: {
		...
		tokensBody:
			"免費方案係 1 張圖 + 1 條 8 秒 480p 一齊用。付費方案顯示 token 全用嚟出 1K 單圖，或者全用嚟出 8 秒影片嘅粗略產能。",
		tokensUnit: "點數",
		tokensPlanGrant: "{n} 點數",
		tokensCapacityImages: "張單圖",
		tokensCapacityOr: "或",
		tokensCapacityAnd: "加",
		tokensCapacityVideos: "條 8 秒影片",
		tokensCapacityVideosFree: "條 8 秒 480p 片",
		...
		tokenCostMusic: "音樂床",
		tokensVideoNote:
			"免費：1 張圖 + 1 條 8 秒 480p 一齊計。付費估算用計劃最高解像度嘅 8 秒影片（或約 10 秒兩場分鏡）。更長片、更多場、Logo 會多用 token。",
	...
	pricing: {
		...
		capacityVideosFeature: "或約 {n} 條 8 秒影片",
		capacityFreeImages: "1 張宣傳圖",
		capacityFreeVideos: "1 條 8 秒 480p 片",
		...
		comparisonRows: [
			...
			{
				feature: "大約產能",
				free: "1 張圖 + 1 條 8 秒 480p",
				standard: "約 46 張圖或約 5 條 8 秒 720p",
				pro: "約 123 張圖或約 9 條 8 秒 1080p",
				master: "約 246 張圖或約 18 條 8 秒 1080p",
			},
			{
				feature: "圖片最高解像度",
				free: "最高 1K",
