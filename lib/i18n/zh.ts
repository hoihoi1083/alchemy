...
export const zh = {
	...
	auth: {
		...
		signUpSubtitle: "建立帳戶 — 註冊即送 300 免費 token。",
		tokensBalance: "{n} 點數",
		tokensBalanceTitle: "你的點數餘額 — 查看方案與加購",
		accountMenu: "帳戶與帳單",
		libraryMenu: "我的作品庫",
		brandKitMenu: "品牌套件",
		signupPromoBar: "註冊即送 300 免費 token",
		closeModal: "關閉",
	...
	account: {
		...
		cancelTrial: "取消 Pro 試用",
		cancelBusy: "取消中…",
		cancelConfirmTrial: "確定取消 Pro 試用？Pro 功能立即結束，剩餘 Token 保留。",
		cancelConfirmPaid: "確定取消續訂？目前週期結束前仍可使用付費功能。",
		cancelSuccess: "訂閱已更新。",
		cancelError: "無法取消，請使用管理帳單或聯絡支援。",
		trialActiveNote: "Pro 試用中 — {date} 結束或轉為付費。",
		tokenExpiryNote: "Token 自發放日起 6 個月有效，先用較早獲得的 Token。",
		manageBilling: "管理帳單",
		...
		consumeKinds: {
			fallback: "生成扣費",
			research_reel: "研究短片分析",
			research_reel_with_plan: "研究短片分析 + 分鏡規劃",
			refine_research_video_script: "研究影片文案優化",
			storyboard: "分鏡圖生成",
			storyboard_scenes: "分鏡圖生成（{count} 個場景）",
			image: "圖片生成",
			image_ab: "A/B 圖片生成（2 個版本）",
			image_refine: "圖片微調",
			campaign: "Campaign 套圖（3 張）",
			...
			inpaint: "圖片修復 / 消除",
			postprocess: "影片後期處理",
			"finish-blockbuster": "Blockbuster 成片",
			smart_layers_detect: "智能圖層 — 偵測",
			smart_layers_sam: "智能圖層 — SAM 切邊",
			smart_layers_matte: "智能圖層 — 去背",
			smart_layers_heal: "智能圖層 — 修復",
			smart_layers_qwen: "智能圖層 — 拆層",
			smart_layers_seedream: "智能圖層 — 拆成可編輯圖層",
			smart_layers_expand: "智能圖層 — AI 外擴補邊",
		},
		team: {
			title: "企業席位",
	...
	library: {
		...
		openMedia: "開啟",
		delete: "刪除",
		deleteConfirm: "確定刪除呢個項目？唔可以還原。",
		deleteCancel: "取消",
		deleteConfirmBtn: "刪除",
		deleting: "刪除中…",
		noMedia: "未有已儲存嘅媒體",
		linkExpiredHint:
			"舊專案可能仲用緊已過期嘅臨時連結 — 請打開「已儲存檔案」分頁，或重新生成。新輸出會永久儲存。",
		updatedLabel: "更新於",
		imageBadge: "圖片",
		videoBadge: "影片",
		accountLink: "帳戶與帳單",
		...
		projectsTitle: "專案",
		projectsSubtitle:
			"可以喺工作室重新打開嘅精靈進度 — 名稱取自產品、概念或標題。撳卡片就可以繼續。",
		highlightNewVersion: "新版本",
		resumeChipExport: "開啟喺匯出",
		resumeChipScenes: "開啟喺分鏡",
		resumeChipImage: "開啟喺圖片",
		resumeChipSetup: "開啟喺設定",
		audioBadge: "音訊",
		voiceoverBadge: "配音",
		download: "下載",
		editCaptions: "加字幕／配音",
		editImage: "編輯圖片",
		teamFolderTitle: "團隊資料夾",
		teamFolderSubtitle:
			"同企業席位共用嘅檔案。個人作品庫預設私密，分享後先出現喺呢度。",
		teamFolderEmpty: "暫時未有共用檔案。喺已儲存檔案撳「分享到團隊」。",
		shareWithTeam: "分享到團隊",
		unshareFromTeam: "取消團隊分享",
		sharing: "更新中…",
		sharedBadge: "已分享",
		sharedByLabel: "由 {name} 分享",
		shareFailed: "無法更新團隊分享。",
	},
	footer: {
		tagline:
			"任何想法，幾分鐘變成吸睛內容 — 圖片、影片同 Reels 一次完成。",
		productTitle: "產品",
		legalTitle: "法律資訊",
		studio: "開始製作",
		pricing: "方案與 tokens",
	...
	studio: {
		...
		loadingHint: "正在還原專案，並打開最合適嘅步驟。",
		hydrateErrorTitle: "無法還原呢個專案",
		hydrateErrorBody: "載入失敗，未有覆寫你嘅存檔。可以重試或返回作品庫。",
		hydrateErrorTimeout: "還原逾時。請檢查網絡後再試。",
		hydrateErrorLibrary: "返回作品庫",
		resumeBannerTitle: "正在瀏覽已儲存專案",
		resumeBannerLibrary: "作品庫",
		regenForksHint:
			"編輯會保存到而家呢個專案。重新生成會消耗代幣並另存為新卡片 — 舊卡片嘅成片仍在原處。",
		forkCreatedTitle: "已建立新版本",
		forkCreatedBody: "你而家喺新專案卡片上編輯。作品庫入面舊卡片未改動。",
		forkCreatedDismiss: "知道了",
		forkCreatedLibraryLink: "喺作品庫查看",
		phaseStepper: {
			ariaLabel: "專案步驟",
			setup: "設定",
			image: "圖片",
			video: "影片",
			export: "匯出",
			hint: "撳已完成步驟可以睇返輸入同結果。重新生成會另存新專案。",
		},
	...
	start: {
		...
		physicalExamples: "例如：護膚、食品飲料、珠寶、服裝、家具",
		physicalTags: ["護膚", "食品飲料", "珠寶", "服裝", "家具"],
	...
	landing: {
		...
		transformTitleHighlight: "工作室級傑作。",
		transformTitleAfter: "",
		transformBody:
			"上傳你嘅產品相。Alchemy 分析顏色、排版同語氣，再幫你重塑成可編輯、可導出到各平台嘅生活方式廣告。",
		transformPoints: [
			{
				title: "保留你真正嘅產品",
				body: "只改場景同光感 — 樽身、標籤同品牌細節保持真實。",
			},
			{
				title: "對齊你想要嘅風格",
				body: "AI 梳理顏色、排版同語氣，等輸出更有方向，唔係亂撞。",
			},
			{
				title: "幾分鐘就能出廣告",
				body: "做出適合 Instagram、Facebook、TikTok、小紅書嘅吸睛靜幀。",
			},
		],
		transformCta: "幫我變產品圖",
		transformHint: "唔使空白 prompt，由你嘅產品相開始。",
		howTitleBefore: "想法點樣變成",
		howTitleHighlight: "現實",
		...
		howSteps: [
			...
			{
				title: "AI 分析你嘅風格",
				body: "AI 分析色板、排版、構圖、語氣同文案風格。",
			},
			{
				title: "改 Prompt 同分鏡",
				body: "生成完整影片前，先審閱同編輯 AI 生成嘅 prompt 同分鏡。",
			},
			{
				title: "自由生成同編輯",
				body: "一鍵生成圖片同影片，再用畫布工具微調。",
			},
		],
		demoModal: {
			close: "關閉示範",
			...
			demos: {
				image: {
					title: "四步出圖廣告",
					subtitle: "真實 Studio 操作 — AI 研究、產品相，再到靜態廣告成品。",
					hint: "真實錄影 · 撳步驟可跳轉",
					steps: [
						{ title: "揀產品", body: "揀實體產品、填產品名，然後入 Studio。" },
						{ title: "AI 研究", body: "喺 Instagram 搜熱門帖做版式靈感，再揀一個 style。" },
						{ title: "產品相 + 標題", body: "上傳產品相、保留改寫好嘅標題，再設圖片選項。" },
				...
				video: {
					title: "四步產品短片",
					subtitle: "真實 Studio 操作 — AI 研究、產品相，再到無聲成片。",
					hint: "真實錄影 · 片尾有成片 · 撳步驟可跳轉",
					steps: [
						{ title: "揀產品", body: "揀實體產品、填產品名，然後入 Studio。" },
						{ title: "AI 研究", body: "喺 Instagram 搜熱門 Reel 做節奏靈感，再揀一個 style。" },
						{ title: "產品相 + 參考片", body: "上傳產品相，保留參考 Reel 做鏡頭／剪輯感覺。" },
						{ title: "生成短片", body: "確認並生成。睇無聲成片，再下載或去字幕工作室。" },
					],
				},
			},
		},
		...
		refTitle: "參考唔同風格，同時聚焦品牌同內容。",
		refBody:
			"選擇你鍾意嘅帖或一條 Reel。Alchemy 會識別排版、色板、光線同語氣，建議再套去你嘅產品或概念 — 學風格唔抄內容，成品仍然係你嘅品牌+內容。",
		refCardLabel: "參考風格",
		refFeatureItems: [
			{
				title: "識別風格 DNA",
				body: "抽取參考嘅氛圍同風格 — 唔抄參考嘅文案或產品。",
			},
			{
				title: "保留你真正嘅產品",
				body: "品牌細節保持真實，只改場景同氛圍。",
			},
			{
				title: "套用，唔係抄襲",
				body: "對齊你嘅偏好，同時帶上產品賣點同你想推廣嘅訊息。",
			},
			{
				title: "多平台輸出",
				body: "做出適合 Instagram、TikTok、Facebook 等嘅圖或片。",
			},
		],
		...
		storyboardTitle: "故事版模式 — 先規劃場景，再合成影片",
		storyboardBody:
			"三格靜幀合成一條故事片 — 先計劃每個鏡頭，再生成語氣同畫面一致嘅影片。",
		storyboardFeatureItems: [
			{
				title: "先計劃每個場景",
				body: "先揀好鏡頭同時間，再花 token 生成影片。",
			},
			{
				title: "故事同語氣一致",
		...
		tplTabService: "服務業",
		whyTitle: "Alchemy AI Lab 有什麼不同",
		whyItems: [
			{
				title: "免寫 Prompt",
				body: "一步步慳心引導。只需撳幾下就能交付內容。",
			},
			{
				title: "智能市場研究",
				body: "用最新風格嘅熱門參考，唔使再亂估。",
			},
			{
				title: "先分鏡再出片",
				body: "一切由你話事。先揀好場景再全片渲染 — 唔會白費 token。",
			},
			{
				title: "輸出可再編輯",
				body: "生成後連少少細節都可以改。即時修正，唔使成套重跑。",
			},
			{
				title: "產品同概念都得",
				body: "實體產品、服務、概念，甚至抽象想法都一樣好用。",
			},
			{
				title: "訂閱 + Token",
				body: "訂閱方案同額外 token 嘅混合模式。需要時再升級或充值。註冊即享免費方案！",
			},
		],
		...
		pricingSubtitle:
			"免費開始。需要更多 AI token、模板、影片同品牌工作流時再升級。",
		pricingFreeCta: "免費開始",
		pricingProCta: "開始 Pro",
		pricingCustom: "Enterprise",
		pricingCustomHint: "3 席 · 每月 40,000 token",
		...
		toolBrandTitle: "品牌套件",
		toolBrandDesc:
			"一次保存 Logo 同品牌色 — 每條廣告都複用到。",
		toolLibraryTitle: "我嘅作品庫",
		toolLibraryDesc: "已保存檔案、專案同團隊資料夾 — 繼續編輯或下載。",
		toolEditTitle: "AI 智能圖層同修圖",
		toolEditDesc: "智能圖層 + 圖片編輯 — 移動文字／物件、改文案、筆刷抠圖、匯出。",
		toolSmartLayersTitle: "AI 智能圖層同修圖",
		toolSmartLayersDesc: "智能圖層 + 圖片編輯 — 偵測拆層、拖動改文、筆刷抠圖 — 所有方案可用。",
		toolCaptionsTitle: "字幕同成片",
		toolCaptionsDesc: "AI 改畫面、裁切拼接、字幕、BGM 燒錄 — 完整成片工作室。",
		...
		recipes: {
			...
			title: "可完成嘅影片配方",
			subtitle:
				"產品同概念同一套兩條路。動態海報＝2 張靜圖 + 短片。免費額度最多約 1 張圖 + 約 5 秒 480p（或約 4 張靜圖）。12 秒 TVC 要付費方案。",
			cta: "用呢個配方",
			physicalGroup: "產品",
			conceptGroup: "概念／服務",
			tvcPaidHint:
				"4 格靜圖 + 12 秒片要付費方案（約 752 token）。免費額度（300）最多約 1 張圖 + 約 5 秒 480p，或約 4 張靜圖 — 唔夠完整 2 圖 + 短片。",
			needPrefix: "需要",
			...
			items: {
				...
				"product-swift-chroma-12s": {
					title: "疾行幻彩分鏡約 12 秒",
					description:
						"多鏡頭：濕潤城市街追 → 自然手持產品特寫 → 騰躍衝擊 → 霓虹定格。要產品圖。",
					costHint: "約 4 張靜幀 + 12 秒分鏡 · 產品包裝圖",
				},
				...
				"concept-studio-type-15s": {
					...
					description: "灰棚立體字推品牌／店鋪／服務 — 唔使 SKU。",
				...
				"concept-swift-chroma-12s": {
					title: "疾行幻彩分鏡（概念）約 12 秒",
					description:
						"多鏡頭品牌／人物：濕潤城市街追 → 能量特寫 → 騰躍 → 霓虹定格。唔好假 SKU。",
					costHint: "約 4 張靜幀 + 12 秒分鏡 · 想法或人物靜圖",
				},
				...
				"product-torn-paper-reveal-6s": {
					title: "撕紙揭示 ~6s",
					description:
						"半透明雪梨紙蓋住產品 → 細纖維橫撕露出 Logo。細條撕／掀捲／闊撕。",
					costHint: "~2 張靜圖 + 6–8秒 · 帶清晰標籤嘅產品圖",
				},
				"product-swift-chroma-run-8s": {
					title: "疾行幻彩 ~8s",
					description:
						"濕潤城市奔跑 + 霓虹幾何拼貼（粉／橙／黃）。產品：跑者手持 SKU。街追／騰躍衝擊／圖形定格。",
					costHint: "~2 張靜圖 + 8–10秒 · 產品／人+SKU 靜圖",
				},
				...
				"product-bullet-elevate-10s": {
					...
					costHint: "~2 圖 + 10s video · 產品／生活方式圖",
				},
				...
				"concept-torn-paper-reveal-6s": {
					title: "撕紙揭示（概念）~6s",
					description:
						"人物／品牌靜圖喺雪梨紙後 → 纖維撕口揭示標誌。細條撕／掀捲／闊撕。",
					costHint: "~2 張靜圖 + 6–8秒 · 帶清晰標誌嘅人像／品牌靜圖",
				},
				"concept-swift-chroma-run-8s": {
					title: "疾行幻彩（概念）~8s",
					description:
						"人物疾行於濕潤城市 + 霓虹幾何拼貼。街追／騰躍衝擊／圖形定格。",
					costHint: "~2 張靜圖 + 8–10秒 · 人像／品牌形象靜圖",
				},
				...
				"concept-bullet-elevate-10s": {
					...
					costHint: "~2 圖 + 10s video · Logo/吉祥物",
				},
				...
				"concept-imitate-ad-8s": {
					...
					costHint: "~10s · Logo/吉祥物 + 參考影片",
				},
				"concept-neon-on-real-8s": {
					title: "霓虹疊實景（概念）~10s",
					description:
						"真實影片 + 霓虹動物/符號在場景中移動 — 可選 Logo 鎖定。",
					costHint: "~10s · 真實 MP4（可選 Logo 靜圖）",
				},
				...
				"concept-h3-logo-mg-8s": {
					title: "3D Logo 演繹（概念）~10s",
					description:
						"上傳 Logo → 明亮玻璃界面／鉻字／絲帶／粒子釘場三維演繹。品牌片頭。",
					costHint: "~10s · Logo/吉祥物靜圖",
				},
				"concept-h3-triangle-light-mg-10s": {
					title: "三角光品牌片頭（概念）~10s",
					description:
						"Logo + 品牌名 → 暗場三角光片頭。Exhibit／Flow。",
					costHint: "~10–12 秒 16:9 · Logo + 品牌名",
				},
				"concept-h3-glass-type-mg-12s": {
					title: "透明3D立體字（概念）~12s",
					description:
						"Logo + 品牌名 → 明亮透明立體字片頭。Click／Parade。",
					costHint: "~10–12 秒 16:9 · Logo + 品牌名",
				},
				"concept-h3-design-studio-mg-12s": {
					title: "設計台玻璃片頭（概念）~12s",
					description:
						"Logo + 品牌名 → 設計台玻璃作品集片頭。Form study／Brand desk。",
		...
		faq: [
			...
			{
				q: "新註冊送幾多免費 token？",
				a: "新帳戶一次過送 300 token（唔會每月自動再送），夠 1 張宣傳圖 + 1 條 8 秒 480p 片。詳情見定價頁。",
			},
			{
				q: "一定要上傳參考影片？",
		...
		heroSidebar: ["上載", "風格", "版面", "語氣", "品牌套件"],
		navResources: "Token",

		planBlurbCustom: "3 個席位 · 共用 token 池",

		planBlurbFree: "試用引導式 Studio 流程",

		planBlurbLight: "中小企每週出帖",

		planBlurbMaster: "高產量創意同商業用途嘅重度用戶",

		planBlurbPro: "專業用戶同創意天才",

		planBlurbStandard: "成長中品牌同自由工作者",
		...
		tplAdBranding: "學風格唔抄內容 — 保留你嘅品牌 DNA",
		tplAdAmber: "陽光下嘅藥珀 — 每粒都唔同",
		tplAdCafe: "小店廣告，把路過的人變成進店客",
	...
	pricing: {
		...
		checkoutSuccessGranted: "（+{granted} · 餘額 {balance}）",
		checkoutSuccessBalance: "（餘額 {balance}）",
		compareScrollHint: "← 左右滑動 →",
		...
		faq: [
			{
				q: "Token 點樣計？",
				body: "Token 用嚟量度工作室入面要計費嘅 AI 用量。工作越複雜（更長影片、更高解像度、分鏡組）用得越多。每次付費步驟生成前都會顯示預計消耗。Token 發放後 6 個月到期，會先用最舊嘅 token。",
			},
			{
				q: "新註冊送幾多免費 token？",
				body: "新帳戶一次過送 300 token，唔會每月自動再送。夠試用完整流程。餘額唔夠做任務時，可以開始 7 日 Pro 試用（需要信用卡）。",
			},
			{
				q: "7 日 Pro 試用係咩？",
				body: "Free 用戶餘額唔夠時，確認試用並喺 Stripe Checkout 加卡。你會即時獲得 +700 token 同 Pro 方案功能 7 日。7 日後會收 Pro 月費並加入完整 Pro 每月 token 份額。試用期內可隨時喺帳戶取消 — Pro 功能即時結束，剩餘 token 保留。試用只適用 Pro 月付（唔包年付）。每個帳戶只得一次試用。",
			},
			{
				q: "Token 用喺邊啲位？",
			...
			{
				q: "Token 用晒會點？",
				body: "會阻止生成，直到你開始 Pro 試用（Free 用戶）、升級或加購（付費方案）。每次運行前都會有清楚提示。",
			},
			{
				q: "Token 會過期嗎？",
				body: "會。每筆發放（註冊、試用獎賞、訂閱、加購、退款）加入後 6 個月到期。我哋會先用最舊嘅 token。規則推出前已有嘅餘額保留原數量，並由遷移日起計 6 個月到期。",
			},
			{
				q: "每個計劃大概可以整幾多圖或片？",
			...
			{
				q: "生成失敗會扣 token 嗎？",
				body: "如果 AI 任務扣費後失敗，我哋會把今次運行扣走嘅 token 退回餘額。失敗生成唔應該被收費。退款 token 同樣由退款日起計 6 個月到期。",
			},
			{
				q: "生成內容可以商用嗎？",
			...
			{
				q: "適合代理或團隊嗎？",
				body: "支援。喺收費頁訂閱 Enterprise 即有 3 個席位：擁有人喺帳戶邀請隊友，各自保留獨立作品庫（可選擇分享檔案到團隊資料夾），生成會用擁有人嘅共用 40,000 token 池。Light、Standard、Pro 同 Master 仍然係單人自助計劃。",
			},
			{
				q: "幾時可以買額外 token？",
				body: "訂閱任何付費計劃之後（包括 Pro 試用期內／試用後已付費）。Free 用戶需先開始試用或升級，之後可按需要加購。加購 token 同樣 6 個月到期。",
			},
			{
				q: "點樣升級計劃？",
				body: "登入後喺呢個收費頁揀更高計劃（Light → Standard → Pro → Master → Enterprise）確認即可。升級會由今日起開新帳單期：Stripe 退回舊計劃未用時間嘅差額，再由今日起收新計劃費用 — 我哋唔會改 Stripe 產品標價。你保留剩餘 token，並即時獲得新計劃完整份額。下次續費由升級日起重新計算（月付／年付取決於你揀嘅計劃）。升級唔使經「管理帳單」。",
			},
			{
				q: "點樣降級計劃？",
				body: "喺收費頁揀較低計劃。降級會排程到下一個帳單日生效 — 之前你仍然用緊目前計劃、功能同剩餘 token。較低價錢同計劃 token 由下個週期開始。",
			},
			{
				q: "喺邊度改計劃或取消訂閱？",
				body: "升級或排程降級：登入後喺收費頁操作。取消 Pro 試用或排程付費取消：喺帳戶頁，或使用「管理帳單」（Stripe）改卡同發票。試用期取消會即時結束 Pro 功能並保留剩餘 token。付費取消後，目前週期完結前仍然可用付費功能。",
			},
			{
				q: "點樣付款？",
				body: "訂閱同加購經 Stripe 安全付款（信用卡、Apple Pay、Google Pay、Link 等）。Pro 月付試用需要留卡，7 日後會自動收費，除非你先取消。訂閱 Checkout 唔支援微信支付同支付寶。",
			},
		],
		footnote:
			"價格以美元計。Token 6 個月到期（先用最舊）。影片解像度同片長會影響 token。經 Stripe 付款。Free：註冊送 300 token。餘額唔夠時可選 7 日 Pro 月付試用（+700 token）。喺收費頁升級會由今日起開新計劃月；降級由下個週期生效。取消試用或續訂請用帳戶／管理帳單。",
		plans: {
			free: {
				name: "免費",
				description: "試用圖片同影片引導路徑",
				features: [
					"註冊一次 300 token",
					"引導精靈 + 入門模板",
					"影片最高 480p · 圖片最高 1K",
			...
			custom: {
				...
				yearlySave: "慳 50%",
				tokens: "40,000",
				description: "團隊 3 席，共用一個 token 池",
				badge: "3 席",
				seatsLabel: "3 席 · 共用 token 池",
				features: [
					"每月 40,000 token",
					"3 個席位（擁有人 + 2 位隊友）",
					"生成扣擁有人嘅共用 token 池",
		...
		comparisonRows: [
			...
			},
			{
				feature: "大約產能",
				free: "試用圖片同影片路徑",
				light: "最多 46 張圖或 9 條 8 秒 480p",
				standard: "最多 123 張圖或 24 條 8 秒 480p",
				pro: "最多 246 張圖或 48 條 8 秒 480p",
				master: "最多 430 張圖或 85 條 8 秒 480p",
	...
	wizard: {
		...
		workflowModes: {
			"image-only": {
				...
				cardDescription: "生成高質宣傳圖。",
				tags: ["社交媒體貼文", "產品圖", "靜態廣告"],
			},
			"video-only": {
				title: "只要單場景短片",
				description: "單場景連續鏡頭 — 可直接發佈短片",
				cardDescription: "Alchemy 會按你嘅產品圖同偏好風格設計一段短片。",
				tags: ["單場景", "短片", "影片廣告"],
				sceneBadge: "只得單場景",
			},
			combined: {
				...
				cardDescription:
					"Alchemy 會為你嘅產品生成多段短片，再合併成一條多場景影片。",
				tags: ["多場景", "分鏡", "動態廣告"],
				sceneBadge: "多場景分鏡",
			},
		},
		...
		imageOutputLabel: "你的圖片輸出",
		imageOutput: {
			title: "宣傳靜圖",
			pipeline: "上傳產品／參考 → AI 規劃風格與文案 → 生成可下載圖片",
			confidence: "適合 feed 貼文、Carousel、產品照同靜態廣告 — 冇影片步驟",
		},
		...
		visualStyles: {
			...
			"info-poster": {
				title: "賣點資訊圖",
				description:
					"白底賣點條列 — 產品＋圖示清單，唔係大字廣告海報",
			},
			"designed-poster": {
				title: "商業設計海報",
				description:
					"Feed 廣告海報 — 大標題＋標語＋圓章，唔係白底資訊清單",
			},
			"parts-poster": {
				title: "零件拆解",
				description:
		...
		visualStyleHints: {
			...
			"creative-video": "",
			"explosion-unbox":
				"病毒感開箱 Reel — 主題盒打開、房間組裝、道具飄浮。純文字出片，唔使產品相。",
			"concept-cinematic":
		...
		explosionUnbox: {
			intro:
				"揀主題 — 蜘蛛俠睡房、麥當勞、Tom & Jerry、你嘅品牌。我哋會預填電影感 JSON brief，可再改。唔使產品相。",
			steps: [
				"輸入主題（蜘蛛俠、麥當勞、你嘅品牌）",
				"檢查或修改 JSON brief",
				"直接出片 — 跳過出圖步驟",
			],
			themePlaceholder: "例如：蜘蛛俠睡房、麥當勞、Tom & Jerry",
			...
			briefHint: "進階：可改鏡頭、光線或元素。description 請配合你嘅主題。",
			planNote: "由主題 + brief 文字出片 — 唔經出圖。此模板需 Pro 方案。",
			videoStepIntro:
				"爆炸開箱 prompt 已在 Setup 填好。直接 Generate ~10s 純文字出片 — 唔使關鍵幀。",
		},
...
"brand-fit": "分析後會自動填；你可再微調產品或場景",
			...
			"explosion-unbox":
				"主題在上面；可改 JSON brief 或補充運鏡 — 唔使產品相",
			"concept-cinematic":
		...
		imageOutputModes: {
			...
			carousel: {
				title: "輪播",
				description: "3–7 張串連圖 — 產品推廣或教學 Tips",
			},
			"teaching-carousel": {
				title: "教學輪播",
		...
		carouselSettings: {
			intentLabel: "輪播類型",
			intentHint: "產品推廣 = 3 張銷售系列。教學 Tips = 封面、重點、總結。",
			intentTeaching: {
				title: "教學 Tips",
				description: "封面 → 教學重點 → 總結（保留現有教學設定）",
			},
			intentPromo: {
				title: "產品推廣",
				description: "主打 → 賣點 → 優惠/CTA（固定 3 張）",
			},
			slideCountLabel: "幾張？",
			slideCountOption: "{count} 張",
			slideCountHint: "建議 5 張（封面 → 3 個重點 → 總結）。3–7 張可更短或更深。",
			promoSlideCountNote: "產品推廣固定為 3 張銷售系列。",
		},
		...
		researchStoryboardMode: {
			title: "參考帖分鏡模式",
			body: "節奏與構圖沿用你選的參考內容；此路徑不另選分鏡配方。可在下方編輯大綱或簡述。",
		},
		researchStoryboardPlanReady: "參考分析完成 — 分鏡大綱已就緒。",
		...
		storyboardRecipes: {
			...
			"swift-chroma": {
				title: "疾行幻彩",
				desc: "濕潤城市奔跑 + 霓虹拼貼 · 街追 → 手持產品 → 騰躍 → 定格 · 4 或 6 場",
			},
		},
		...
		h3ToSeedanceFallbackNote:
			"單鏡出片暫時未能用 — 已改用備用影片模式，並混入音樂庫 BGM",
		...
		researchReelAnalyzeEtaHint: "通常約 2–3 分鐘，較長嘅 reel 可能更耐。",
		...
		videoCreativeModes: {
			...
			"impact-poster": {
				title: "衝擊海報",
				description:
					"大透視衝擊海報 — 更強產品衝鏡 + 粒子特效。可揀調性同特效 → 約 6 秒。",
			},
			"social-drip": {
			...
			"swift-chroma-run": {
				title: "疾行幻彩",
				description:
					"人物喺濕潤城市奔跑 + 霓虹幾何拼貼。產品：跑者手持 SKU。街追／騰躍衝擊／圖形定格。約 8–10 秒。",
			},
			...
			"bullet-product-elevate": {
				title: "子彈時間產品升格",
				description:
					"生活方式行走 → 絲線轉折 → 產品懸浮環繞 → 回落。預設 10 秒（8/10/12）一鏡。",
			},
			"ecom-orbit": {
				title: "電商環繞",
				description:
			...
			"h3-triangle-light-mg": {
				title: "三角光品牌片頭",
				description:
					"毛玻璃三角 + 焦散光線 + 動能大字 → 品牌鎖。Exhibit／Flow 兩卡。",
			},
			"h3-glass-type-mg": {
				title: "透明3D立體字",
				description:
					"明亮玻璃立體字 + 光標點擊 → 品牌鎖。Click／Parade 兩卡。",
			},
			"h3-design-studio-mg": {
				title: "設計台玻璃片頭",
				description:
					"設計台形態研究 → 玻璃字標作品集片頭。Form study／Brand desk。",
			},
			"h3-movie-title": {
				title: "電影標題",
				description:
...
"reference-concept": {
    ...
    impactPosterToneTitle: "調性（色彩世界）",
    impactPosterToneHint:
      "整片色調會鎖死：火辣＝橙紅熱感；高端＝金黑奢感；賽博＝紫青霓虹。選不同調性，成品色調必須明顯不同。",
    impactPosterToneAuto: "自動 · 最合適",
    impactPosterTones: {
      fiery: { title: "火辣", desc: "橙紅火焰 · 零食／辣味" },
      rugged: { title: "粗獷", desc: "橄欖褐塵土 · 戶外／越野" },
      premium: { title: "高端", desc: "金黑奢華 · 耳機／奢品" },
      cyber: { title: "賽博", desc: "紫青霓虹 · 科技／電競" },
    },
    impactPosterEffectTitle: "衝擊特效（爆炸方式）",
    impactPosterEffectHint:
      "與調性分開：特效只改「怎麼炸」——碎玻璃、神光、碎屑、閃電。同一產品選不同特效，動態形狀應明顯不同。",
    impactPosterEffectAuto: "自動 · 匹配調性",
    impactPosterEffects: {
      "shatter-burst": { title: "碎裂爆發", desc: "玻璃碎片徑向炸開" },
      "energy-rays": { title: "能量射線", desc: "背後長神光／聲波" },
      "debris-splash": { title: "碎屑飛濺", desc: "土屑／零件衝向鏡頭" },
      "lightning-pulse": { title: "閃電脈衝", desc: "電弧叉狀爆閃" },
    },
    ...
    motionPosterDialects: {
		...
		blockbusterSceneHintBridge:
			"「天橋上」建議留空 — 影片會緊跟首幀；錯誤首幀易導致倒車、箱子亂印圖案。角度由提示詞控制。",
		...
		blockbusterCameraBridge: {
			title: "天橋上（迎面）",
			desc: "高角度 — 車頭朝鏡頭鑽橋底，箱向上飛來",
		},
		blockbusterCameraBridgeDownRoad: {
			title: "天橋俯視公路",
			desc: "企喺橋頂順著公路睇落去 — 貨車迎面駛來，箱喺公路上方漂浮飛來",
		},
		...
		blockbusterCameraHintBridge:
			"天橋視角唔用場景靜圖 — 成片只跟提示詞（避免倒車／箱子亂印圖案）。",
		...
		h3ShotHeroHint: {
			...
			"h3-triangle-light-mg":
				"上傳 Logo／字標 + 品牌中英文名。包裝圖僅當標識清晰可讀時可用。",
			"h3-glass-type-mg":
				"上傳 Logo／字標 + 品牌字母（英文更佳）。明亮玻璃立體字 — 不是暗場三角光。",
			"h3-design-studio-mg":
				"需要：Logo／字標 + 品牌字母（英文更佳）。設計台玻璃片頭 — 不是單純立體字升起。",
			"h3-movie-title":
		...
		h3ShotHint: {
			...
			"h3-triangle-light-mg":
				"三角光品牌片頭 · Exhibit／Flow · 約 10–12 秒 · 允許動能大字。",
			"h3-glass-type-mg":
				"透明3D立體字片頭 · Click／Parade · 約 10–12 秒 · 允许动能大字。",
			"h3-design-studio-mg":
				"設計台玻璃片頭 · Form study／Brand desk · ~10–12秒 · 可用動能大字。",
			"h3-movie-title":
		...
		h3TriangleLightMgSchemeTitle: "三角光風格",
		h3TriangleLightMgSchemeHint:
			"同一暗場三角方言 — Exhibit（藝術展標題）或 Flow（流動符號）。自動會挑合適卡。",
		h3TriangleLightMgSchemeAuto: "自動 · 最佳匹配",
		h3TriangleLightMgSchemes: {
			exhibit: {
				title: "Exhibit",
				desc: "三角光藝術展 — 玻璃三角 → 動能 3D/TVC 標題 → 品牌鎖",
			},
			flow: {
				title: "Flow",
				desc: "流動三角 — 柔光稜鏡漂浮 → 映射／片頭能量 → 品牌鎖",
			},
		},
		h3GlassTypeMgSchemeTitle: "透明立體字風格",
		h3GlassTypeMgSchemeHint:
			"同一明亮玻璃字方言 — Click reveal（壓印+光標）或 Type parade（等距字列）。",
		h3GlassTypeMgSchemeAuto: "自動 · 最佳匹配",
		h3GlassTypeMgSchemes: {
			"click-reveal": {
				title: "Click reveal",
				desc: "壓印平面 → 光標点击漣漪 → 玻璃字升起",
			},
			"type-parade": {
				title: "Type parade",
				desc: "等距彩虹玻璃字母，字内微型場景",
			},
		},
		h3DesignStudioMgSchemeTitle: "設計台風格",
		h3DesignStudioMgSchemeHint:
			"明亮繪圖台片頭 — Form study（軟墊→球體→字母）或 Brand desk（玻璃字標 + 情緒板）。",
		h3DesignStudioMgSchemeAuto: "自動 · 最佳匹配",
		h3DesignStudioMgSchemes: {
			"form-study": {
				title: "Form study",
				desc: "軟墊形 → 剖切球體 → 虹彩字母 → 品牌鎖",
			},
			"brand-desk": {
				title: "Brand desk",
				desc: "玻璃字標 + UI 面板 → 情緒板網格 → 鎖",
			},
		},
		recipePathUxTitles: {
			need: "你需要",
		...
		recipePathUx: {
			...
			"h3-triangle-light-mg": {
				need: ["Logo／字標（優先）+ 品牌名（中／英）", "清晰輪廓與配色以便身份鎖定"],
				attention: ["選 Exhibit（藝術展標題）或 Flow（流動符號）", "暗場三角玻璃焦散 — 不是電商環繞", "允許動能大字；上傳標識始終鎖定", "輸出 16:9 品牌片頭（10／12 秒）"],
				output: ["約 10–12 秒 16:9 三角光品牌片頭"],
			},
			"h3-glass-type-mg": {
				need: ["Logo／字標 + 品牌字母（英文更佳）", "清晰輪廓以便身份鎖定"],
				attention: ["選 Click reveal（壓印+光標）或 Type parade（等距字列）", "明亮工作室玻璃字 — 不是暗場三角光", "允许动能大字／光標；上傳標识始终鎖定", "輸出 16:9 品牌片頭（10／12 秒）"],
				output: ["約 10–12 秒 16:9 透明3D立體字片頭"],
			},
			"h3-design-studio-mg": {
				need: [
					"Logo／字標 + 品牌字母（英文更佳）",
				...
				attention: [
					"選 Form study（形態）或 Brand desk（情緒板）",
					"明亮設計台 — 不是黑場三角光，也不是單純立體字升起",
					"可用動能大字／光標；上傳標識保持鎖定",
				],
				output: [
					"~10–12秒 16:9 設計台玻璃品牌片頭",
					"形態研究或品牌台情緒板 → 品牌鎖",
				],
			},
			"h3-movie-title": {
...
"material-letters": {
			...
			"type-behind-cutout": {
				need: [
					"產品圖（SKU）— 會加展示者手持；或人像／品牌形象靜圖（概念）",
					"短詞巨型字 — 例如 POWER 或 KEEP MOVING（唔好寫完整廣告句）",
				],
				attention: [
					"產品：人展示 SKU — 唔好用獨佔畫面嘅產品圖遮住大字",
					"畫面只顯示短詞 — 長標題會變成 POWER → ANYWHERE",
					"大字喺抠圖身後並從兩側露出；城市／衝擊用夜街底板",
					"鎖定精確 SKU／面孔身份",
				],
				output: [
					"~8–10秒豎版字夾廣告",
			...
			"bullet-product-elevate": {
				...
				attention: ["行走 → 轉折 → 子彈時間環繞 → 回落（8/10/12 秒）", "唔係棚拍拆解 — 生活方式一鏡"],
				output: ["約 2 張靜圖 + 8–12 秒子彈時間升格片"],
			},
			"motion-poster": {
			...
			"impact-poster": {
				need: ["產品圖（產品）— 或 Logo／主題靜圖（概念）", "結尾衝擊海報要用嘅標題"],
				attention: ["揀調性 + 衝擊特效（或自動）", "比動態海報更強嘅產品衝鏡 — 大透視衝擊"],
		...
		h3ShotGenerateStillBusy: {
			...
			"h3-triangle-light-mg": "正在生成三角光靜圖…",
			"h3-glass-type-mg": "正在生成透明立體字静图…",
			"h3-design-studio-mg": "正在生成設計台静图…",
		...
		h3ShotAnimating: {
			...
			"h3-triangle-light-mg": "正在生成三角光品牌片頭…",
			"h3-glass-type-mg": "正在生成透明3D立體字…",
			"h3-design-studio-mg": "正在生成設計台玻璃片頭…",
		...
		webBoundaryHint:
			"打破網頁邊界 — 模特穿過假想購物網頁拿起產品。~8–10秒 · 貨架伸手／穿欄手持。填寫「品牌/商家」可控制導航欄品牌名（如 SOCIAL DRIP）。",
		webBoundarySchemeTitle: "邊界突破風格",
		webBoundarySchemeHint:
			"同一網頁 UI 玩法 — 貨架伸手（從貨架拿起）或 穿欄手持（產品已穿過導航欄）。",
		webBoundarySchemeAuto: "自動 · 最佳匹配",
		webBoundarySchemes: {
			"shelf-reach": {
				title: "貨架伸手",
				desc: "手穿過導航欄，從貨架拿起產品",
			...
			"hold-through": {
				title: "穿欄手持",
				desc: "產品已穿過 UI — 輕推近景手持",
			},
		},
		webBoundaryBuildingStill: "第 1/2 步：網頁邊界起始靜圖…",
		webBoundaryBuildingEnd: "第 2/2 步：網頁邊界結束靜圖…",
		webBoundaryAnimatingCard: "正在生成打破網頁邊界…",
		webBoundaryNeedKeyframe:
			"請先上傳模特圖（最好帶產品）— 未上傳前無法按生成。",
		typeBehindHint:
			"字夾產品／字夾人像 — 人像抠圖在前、身後短詞巨型字（須可讀）、電影感夜街底板。產品：展示者手持你嘅 SKU。請填短詞（KEEP MOVING），唔好寫完整廣告句。~8–10秒 · 城市奔跑／極簡奔跑／衝擊收尾。",
		typeBehindDialectTitle: "字夾風格",
		typeBehindDialectHint:
			"同一字夾構圖 — 城市奔跑（夜街向鏡頭慢跑）、極簡奔跑（奶油留白）、或衝擊收尾（夜街 → END CUT 重擊）。大字須喺身後仍可讀。",
		typeBehindDialectAuto: "自動 · 最佳匹配",
		typeBehindDialects: {
			"city-run": {
				title: "城市奔跑",
				desc: "夜街慢跑 · 人＋產品 · 大字從兩側露出",
			},
			"minimal-run": {
				title: "極簡奔跑",
				desc: "奶油留白 · 一個超大字 · 兩側露出",
			},
			"impact-end": {
				title: "衝擊收尾",
				desc: "夜街字夾 → END CUT 硬衝擊定格",
			},
		},
		...
		tornPaperHint:
			"撕紙揭示 — 乾燥雪梨紙蓋住產品 → 纖維撕口沿產品方向展開（自動橫／豎／斜）→ Logo 清晰。~6–8秒 · 細條撕／掀捲／闊撕。不是濕玻璃。保留 H3 撕紙音效 — 需要配樂可稍後喺字幕頁加。",
		tornPaperKeepNativeAudioNote:
			"已保留 MiniMax 原聲音效（撕紙）。需要配樂請稍後喺字幕頁添加。",
		tornPaperDialectTitle: "撕紙風格",
		tornPaperDialectHint:
			"同一揭示 — 細條撕（纖維撕口，方向按產品自動橫／豎）、掀捲（常斜向掀開）、或闊撕（更寬鋸齒撕口）。",
		tornPaperDialectAuto: "自動 · 最佳匹配",
		tornPaperDialects: {
			"strip-tear": {
				title: "細條撕",
				desc: "細纖維撕口（自動橫／豎）露出 Logo",
			},
			"peel-curl": {
				title: "掀捲",
				desc: "紙張掀捲開口（常斜向）",
		...
		tornPaperBuildingStill: "第 1/2 步：撕紙起始靜圖…",
		tornPaperBuildingEnd: "第 2/2 步：撕紙結束靜圖…",
		tornPaperAnimatingCard: "正在生成撕紙揭示…",
		tornPaperNeedKeyframe:
			"請先上傳產品圖（概念用人像／品牌靜圖，且需有清晰標籤／標誌 — 單靠文字唔夠）。",
		swiftChromaHint:
			"疾行幻彩 — 人物喺濕潤城市奔跑 + 霓虹幾何拼貼（粉／橙／黃）。~8–10秒 · 街追／騰躍衝擊／圖形定格。產品：跑者手持 SKU 且產品要大、清晰。保留 H3 原聲 — 需要配樂可稍後喺字幕頁加。",
		swiftChromaKeepNativeAudioNote:
			"已保留 MiniMax 原聲音效。需要配樂請稍後喺字幕頁添加。",
		swiftChromaDialectTitle: "疾行風格",
		swiftChromaDialectHint:
			"同一能量 — 街追（連續奔跑）、騰躍衝擊（躍起衝擊）、或圖形定格（海報拼貼收尾）。",
		swiftChromaDialectAuto: "自動 · 最佳匹配",
		swiftChromaDialects: {
			"street-chase": {
				title: "街追",
				desc: "濕潤城市連續奔跑 + 霓虹圖形",
		...
		swiftChromaBuildingStill: "第 1/2 步：疾行幻彩起始靜圖…",
		swiftChromaBuildingEnd: "第 2/2 步：疾行幻彩結束靜圖…",
		swiftChromaAnimatingCard: "正在生成疾行幻彩…",
		swiftChromaNeedKeyframe:
			"請先上傳產品圖（概念用人像／品牌形象靜圖 — 單靠文字唔夠）。",
		magazineCoverHint:
		...
		bulletProductElevateHint:
			"生活方式行走 → 絲線轉折 → 產品懸浮子彈時間 → 回落。需清晰產品或生活方式圖（預設 10 秒；可選 8/10/12）。",
...
socialDripFitTitle: "呢個格式可以／唔可以做咩",
		...
		storyboardShotMapEmptyStill: "按下方「生成圖片」",
		tvcShotRoles: {
			establish: "開場建立",
			macro: "細節特寫",
			"logo-trace": "Logo 掃光",
		...
		imageSettingsResolution: "圖片解像度",
		imageResolutionPlanHint: "你目前方案最高 {max}。",
		imageResolutionUpgradeLink: "升級以解鎖 2K 圖片",
		...
		stepHelp: {
			...
			videoTitle: "出片步驟",
			noChatCoachNote:
				"跟住畫面卡片做 — 工作室內無 chat 導覽。開始前可在首頁問 AI 助手。",
			...
			videoExplosionUnboxSteps: [
				"Prompt 已由主題填好 — 可再改。",
				"睇 token 成本後 Generate video。",
				"完成後下載或去字幕工作室。",
			],
			videoConceptSteps: [
				"空白就撳 AI 寫 motion prompt。",
				"檢查時長同引擎。",
...
"material-letters": {
	...
	errors: {
		...
		proTrialOfferBody: "輸入信用卡後可獲得 +700 Token，並解鎖 Pro 功能 7 天。試用期內可在帳戶取消。",
		proTrialCta: "開始 7 日 Pro 試用",
		proTrialStarting: "正在開啟 Stripe…",
		proTrialStartError: "無法開始 Pro 試用。",
		tvcNeedsPaidPlan:
			"呢條片比免費額度貴。免費最多約 1 張圖 + 約 5 秒 480p（或約 4 張靜圖）。請到 Pricing 升級，或者餘額夠就用 拼接後備。",
	...
	captions: {
		...
		libraryBgmPreviewLabel: "試聽示範循環",
		libraryBgmDisclaimer:
			"示範配樂：柔和 / 活潑 / 溫暖（AI 生成器樂）。可快速試聽；正式成片可用「AI 生成」定製貼片曲。",
		aiMusicNeedBrief:
			"請喺上方輸入產品/主題（或用 AI 規劃），先可以生成音樂。",
		aiMusicGenerateHint: "可選氛圍 + 主題，再生成貼合片長嘅音樂。",
		...
		trimIn: "開始（秒）",
		trimOut: "結束（秒）",
		tryCaptions2: "打開字幕同成片（時間軸）",
	},
	captions2: {
		badge: "字幕同成片",
		title: "字幕同成片",
		subtitle:
			"一塊板：時間軸修剪／剪開，對揀中片段做 AI 畫面編輯，安排字幕同 BGM，再燒錄。",
		diffTitle: "呢塊板點用",
		diffBody:
			"一塊板搞掂：時間軸修剪／剪開、AI 改畫面、用主題規劃字幕+口播、混配音同 BGM，再燒錄 — 唔使離開字幕工作室。",
		openClassic: "經典字幕工具 →",
		phaseImport: "1 · 匯入",
		phaseCaptions: "3 · 字幕",
		phaseFinish: "4 · 完成",
		phasePictureName: "畫面",
		phaseStructureName: "結構",
		phaseCaptionsName: "字幕",
		phaseFinishName: "完成",
		phaseHowToPicture:
			"可選 AI 編輯：揀任務晶片、放參考圖、生成。或者跳過去結構。",
		phaseHowToStructure:
			"CapCut 式時間軸：拖片段修剪／排序、喺播放頭剪開、加片段 — 再繼續。",
		phaseHowToCaptions:
			"純字幕＝手寫／改行。語音＝片入面有人聲就自動抽出。啱就繼續燒錄。",
		phaseHowToFinish:
			"試聽／混配音，加曲庫或 AI BGM。字幕 AI 規劃喺「字幕」頁籤。然後匯出／燒錄。",
		dismissTip: "收起",
		showProcessed: "顯示已燒字幕",
		tokenCostHint: (n: number) => `約 ${n} tokens · 雲端語音轉文字`,
		emptyLinesHint: "未有字幕行 — 新增行、由語音，或者用 AI 規劃。",
		stickyPictureHint: "用 AI 改畫面，或者跳過去修剪／拼接。",
		stickyStructureHint: "喺時間軸修剪／剪開／綁定，再繼續字幕。",
		stickyCaptionsHint: "喺時間軸拖字幕塊，或者喺右邊改文字。",
		stickyFinishHint: (n: number) =>
			n > 0 ? `已有 ${n} 行可燒錄` : "燒錄前請先有字幕文字",
		backToCaptions: "返回字幕",
		backToStructure: "返回結構",
		continueStructure: "繼續結構",
		continueCaptions: "繼續字幕",
		importHint:
			"匯入影片 — 喺時間軸修剪，對片段做 AI 編輯，再加字幕同 BGM。",
		fromLink: "來自連結",
		uploadedVideo: "已上載影片",
		readyAuto: "影片就緒 — 可以撳語音自動字幕。",
		readyPicture: "影片就緒 — 喺時間軸修剪，對片段做 AI 編輯，再加字幕。",
		mediaBin: "素材",
		boardHint:
			"時間軸修剪／剪開，對揀中片段做 AI 編輯，安排字幕同 BGM。",
		tabEdit: "編輯",
		tabCaptions: "字幕",
		tabAudio: "音訊 · 完成",
		stickyBoardHint: "修剪 → AI 編輯揀中片段 → 字幕 → 就緒就燒錄。",
		pictureTitle: "AI 畫面編輯",
		pictureHint:
			"揀任務、放參考圖或者寫句短備註，再生成。改嘅係畫面，唔係成段重寫提示詞。",
		pictureHintSelected:
			"套用喺時間軸揀中嘅片段（如果只要一段，請先修剪嗰段）。",
		jobProduct: "換產品",
		jobScene: "換背景",
		jobStyle: "改風格",
		refPhoto: "參考圖",
		refHint: "用嚟替換嘅產品或背景靜幀。",
		editNoteLabel: "可選備註",
		editNotePlaceholder: "例如：保持樽身標籤可以睇得清",
		editGenerate: "生成編輯",
		editGenerating: "編輯緊影片…",
		editStageTrim: "修剪緊揀中片段…",
		editStageGenerate: "AI 畫面生成中…（可能要一兩分鐘）",
		editCancel: "取消編輯",
		skipPicture: "跳過 — 畫面已經啱",
		editCostHint: (n: number) => `約 ${n} tokens · AI 畫面編輯`,
		audioCostBgm: (n: number) => `約 ${n} tokens · 加 BGM`,
		audioCostVoice: (n: number) => `約 ${n} tokens · 混入口播`,
		audioCostMusic: (n: number) => `約 ${n} tokens · AI 音樂`,
		audioCostVoicePreview: (n: number) => `約 ${n} tokens · 口播預覽`,
		audioCostBurn: (n: number) => `約 ${n} tokens · 燒字幕`,
		needRefOrNote: "請加張參考圖或者寫句短備註。",
		editFailed: "畫面編輯失敗。",
		editDone: "畫面已更新 — 可先下載，或者繼續喺時間軸編輯。",
		editDoneOnClip: "已更新揀中片段 — 可以繼續喺時間軸安排。",
		downloadEdited: "下載已編輯影片",
		downloadingEdited: "下載中…",
		editDownloadFailed: "無法下載已編輯影片。",
		structureTitle: "時間軸 · 修剪同綁定",
		structureHint:
			"用下面 CapCut 式時間軸：拖邊緣修剪、剪刀剪開、拖片段排序（磁性吸附）。喺度加多啲片段。",
		addClip: "加入時間軸片段",
		addClipFromLibrary: "由作品庫加入",
		addClipFromFile: "上傳檔案加入",
		joinClips: "拼接片段",
		joining: "拼接緊…",
		clipN: (n: number) => `片段 ${n}`,
		needTwoClips: "請至少再加一段先可以拼接。",
		joinFree: "時間軸修剪同拼接免費。AI 畫面編輯會扣 tokens。",
		joinFailed: "拼接唔到片段。",
		joinDone: "已拼接 — 繼續字幕。",
		clipAdded: "已加入時間軸。",
		nleTitle: "時間軸",
		nleHint: "點片段放置紅色剪開線 · 再點剪開 · 拖邊緣修剪",
		nleShortcuts: "空白鍵播放 · S 剪開 · Del 刪除 · ⌘Z 復原 · ⌘/Ctrl+滾輪縮放",
		nleAudioTrack: "音訊",
		nleSplit: "剪開",
		nleDelete: "刪除片段",
		nleUndo: "復原",
		...
		nleZoomLabel: "縮放",
		nleCutAt: "剪開 @ {t}秒",
		libraryFileMissing: "呢個素材喺雲端冇檔案（上傳未完成）。請揀縮圖睇到嘅，或者重新上傳影片。",
		nleEmptyVideo: "未有片段",
		nleEmptyCaption: "喺「字幕」加行之後，會顯示喺呢條軌道",
		nleBgmLane: "BGM",
		nleVoLane: "配音",
		nleSelected: "已選",
		nleSplitDone: "已喺播放頭剪開。",
		nleSplitNeedInterior: "請將播放頭移去片段入面（唔好貼邊）再剪開。",
		nleKeepOne: "時間軸至少留一個影片片段。",
		bgmDragHint:
			"拖 BGM 整塊可平移；左右綠邊可拉長短。改完位置後請再按「加 BGM」寫入成片。",
		bgmStartNote: (s: number) => `混音入面 BGM 由 ${s.toFixed(1)}s 開始`,
		exportPlate: "匯出時間軸",
		exportingPlate: "烘烤緊時間軸…",
		...
		modeAi: "AI 規劃",
		aiPlanHint:
			"輸入產品/主題 — AI 寫好字幕行 + 口播稿。再到「音訊 · 完成」試聽配音、加 BGM。",
		openAudioForVo: "下一步：音訊 · 完成（混配音 + BGM）→",
		sectionAiCaption: "AI 為呢段加字幕",
		sectionAiVo: "為呢段生成口播",
		sectionAiHint:
			"先喺時間軸揀片段或字幕 — 呢段只會有一句字幕 + 一段連續口播。",
		sectionCaptionDone: "呢段字幕已就緒（約 {sec}s）— 可喺預覽拖動，再生成呢段口播。",
		sectionVoDone: "呢段口播已放喺時間軸 — 可拖動位置，再混入口播燒入影片。",
		planOnCaptionsTab: "AI 規劃字幕 + 口播 → 字幕頁籤",
		pureTitle: "純字幕",
		pureHint: "啱無聲 Alchemy 短片 — 喺右邊手寫或改時間軸字幕。",
		pureEditHint: "新增行 → 改文字同時間 → 繼續完成。",
		autoTitle: "語音自動字幕",
		autoHint:
			"抽音軌 → 轉文字 → 填入時間軸。雲端語音轉文字會扣少量 plan token。",
		autoCta: "語音自動字幕",
		transcribing: "聽緊同寫緊字幕…",
		transcribeDone: (n: number) => `已由語音填入 ${n} 行字幕`,
		transcribeFailed: "轉寫唔到呢條影片。",
		noSpeech:
			"聽唔到人聲（無聲 AI 片？）。請改用純字幕，或者打開「音訊 · 完成」用主題規劃配音。",
		silentHint: "無聲短片？",
		openClassicPlan: "要經典字幕工具？→",
		evenSplitNote: "時間軸為估算（冇語音分段）",
		asrCloud: "雲端語音",
		asrLocal: "本機語音",
		chargedTok: (n: number) => `${n} tok`,
		needVideo: "請先載入影片。",
		continueFinish: "繼續完成（BGM + 燒錄）",
		finishHint:
			"配音試聽同混音、曲庫或 AI BGM。字幕 AI 規劃喺「字幕」頁籤。然後匯出 / 燒錄。",
		classicVoiceNote:
			"配音試聽／混音同 BGM 喺「音訊」頁籤；字幕 AI 規劃喺「字幕」頁籤。",
		packNamePlaceholder: "專案名稱",
		packSave: "儲存",
		packSaving: "儲存中…",
		packSaved: "專案已儲存",
		packSaveAs: "儲存專案",
		packOpen: "開啟",
		packOpening: "開啟中…",
		packEmpty: "尚未有已儲存嘅字幕專案。",
		packSummary: (captions: number, clips: number) =>
			`${captions} 條字幕 · ${clips} 個片段`,
		packDelete: "刪除專案",
		packDeleteConfirm: "刪除呢個字幕專案？唔可以復原。",
		packNew: "新建",
		packNeedSignIn: "登入後先可以儲存字幕專案。",
		packSaveFailed: "儲存專案失敗。",
		packLoadFailed: "開啟專案失敗。",
		packNeedContent: "請先加字幕文字或影片片段再儲存。",
		packOpened: "專案已開啟",
		packMissingMedia:
			"部分本機媒體未儲存 — 請重新上傳片段或從作品庫選擇。",
	},
	editImage2: {
		title: "AI 智能圖層",
		subtitleShortcuts: "滾輪縮放 · 拖動背景平移 · 空白鍵平移 · ⌘Z 復原",
		upload: "上載",
		undo: "復原",
		redo: "重做",
		zoomOut: "縮小",
		...
		save: "儲存",
		clearAll: "清空",
		clearAllConfirm: "清空畫布並重新開始？未儲存嘅改動會冇咗。",
		dropTitle: "將圖片拖到呢度",
		dropHint: "上載平面 AI 海報 — 先抽出文字，再拆畫面圖層",
		tokenHint: (
			split: number,
			erasePerMp: number,
			heal: number,
			...
			`拆層 ${split} · AI 編輯 ${edit} · 擦除約 ${erasePerMp}/百萬像素 · 兜底 ${heal} · 摳圖 ${matte}`,
		uploading: "上載中…",
		detecting: (tokens: number) => `正在拆層…（${tokens} 點）`,
		splittingLayers: "正在拆成圖層…",
		suggestingText: "正在搵文字行…",
		sandwichSplitting: "混合拆層 — 先文字，再主體，再 Qwen…",
		sandwichReady:
			"已就緒 — Florence 文字在上、BiRefNet 主體、Qwen 組件 + 已填底圖。可自由拖動。",
		sandwichReadyPartial: (n: number) =>
			`已就緒 — ${n} 層（文字＋主體）。底圖已清洞 — 選一層再拖。剩餘圖形未拆，可用框選提起。`,
		sandwichPartialTokens:
			"文字與主體已抽出，但 Qwen 未跑（點數不足）。餘額足夠後再試混合拆層，或用框選提起。",
		sandwichNoObjects:
			"文字與主體已就緒；Qwen 沒有額外組件。Logo 可能仍在底圖 — 用框選或 Qwen 拆選區。",
		sandwichHow:
			"混合：Florence 抽字 → BiRefNet 主體 → Qwen 補其餘（唔用 Florence 爛修洞做底圖）。",
		sandwichAdvanced: "混合拆層",
		sandwichAdvancedHow:
			"Florence 文字 + BiRefNet 主體 + Qwen 其餘。難圖優先用呢個。",
		hybridSplit: (n: number) => `混合拆層 ${n}`,
		hybridSplitHow:
			"海報首選：Florence 抽可改文字、BiRefNet 切主體、Qwen 重建底圖＋剩餘圖形（如 SMASH）。唔再用 Florence 爛修洞。",
		liftTools: "提起同編輯",
		liftToolsHint: "框選 / 點選 / 筆刷提起一件 — 乾淨切割並填洞，其餘畫面保留。",
		cuttingCleanly: "正在乾淨切割…",
		cutReadyHealed: "切割完成 — 已填洞。可自由拖動。",
		matteSkippedFallback: "乾淨切割失敗 — 保留框選。可喺圖層再點去背。",
		florenceSamReady: (layers: number, sam: number) =>
			`已就緒 — ${layers} 層（${sam} 個 SAM 切割）。文字同組件已提起；底圖已修補。`,
		florenceMatchReady: (layers: number) =>
			`已就緒 — ${layers} 層。畫面同原圖一致；拖動一件先會清洞。`,
		florenceSamMatchReady: (layers: number, sam: number) =>
			`已就緒 — ${layers} 層（${sam} 個 SAM 切割）。畫面同原圖一致；拖動一件先會清洞。`,
		florenceSubjectReady: (layers: number, sam: number) =>
			`已就緒 — ${layers} 層（BiRefNet 主體${sam ? ` + ${sam} SAM` : ""}）。主角係完整一層；畫面同原圖，拖動先清洞。`,
		florenceSplitHow: "八月模式：Florence 文字 · BiRefNet 主體 · SAM 圖標。拆完同原圖一樣，拖動先清洞。",
		qwenSplitHow:
			"試驗：一個 Qwen 模型直接拆 RGBA 圖層 + 已填底圖（唔使 Florence 修洞）。難圖可同 Florence 拆層對比。",
		...
		qwenFullReady: (layers: number) =>
			`Qwen 完成 — ${layers} 層 + 已填底圖。可直接拖，唔使再清鬼影。`,
		changeWordsOneTap: (n: number) => `改文字 ${n}`,
		changeWordsHint: "輸入要顯示嘅完整新文案，一鍵改字。風格保留，但字必須同你輸入一致（唔好留舊字）。",
		grabClick: "點選提起",
		grabClickOn: "點選提起中",
		grabClickHint: "喺相片上點一下要提起嘅部分 — 自動摳出並修補底圖。",
		grabClickReady: "已提起 — 可拖動。邊緣唔乾淨可再點去背。",
		brushErase: "筆刷擦除",
		brushEraseOn: "筆刷擦除中",
		brushEraseHint: "塗抹多餘部分，再點「擦除塗抹」—— 唔新建圖層。",
		brushErasePlate: "筆刷清底圖",
		brushErasePlateOn: "筆刷清底圖中",
		brushErasePlateHint: "塗抹底圖殘留再套用 — 只清底圖，唔改圖層。",
		brushEraseLayer: "筆刷擦圖層",
		brushEraseLayerOn: "筆刷擦圖層中",
		brushEraseLayerHint: "喺選中圖層上塗抹 — 只喺呢塊打透明洞。",
		erasePainted: "擦除塗抹",
		eraseLayerPainted: "擦圖層塗抹",
		erasePaintedDone: "已從底圖擦除塗抹區域。",
		expandTitle: "AI 外擴補邊",
		expandHow:
			"唔係免費拉大畫布。AI 會畫出新背景像素，令底圖變成 1:1 / 9:16 等比例。圖層保留，淨係底圖變大。",
		expandCostHint: (n: number) =>
			`約 ${n} 點（tokens）— fal AI 補邊。比例已經啱就唔使撳；空白加邊會免費，但呢度唔做嗰種。`,
		expandSquare: (n: number) => `1:1 · ${n} 點`,
		expandStory: (n: number) => `9:16 · ${n} 點`,
		expandLandscape: (n: number) => `16:9 · ${n} 點`,
		expandWider: (n: number) => `4:5 · ${n} 點`,
		expanding: "AI 正在補邊…",
		expandDone: "底圖已 AI 外擴 — 可拖動圖層適配新構圖。",
		expandFailed: "外擴失敗",
		expandNeedHttpBg: "底圖需要伺服器網址 — 請先拆層，再外擴。",
		expandAlready: "已接近該比例 — 冇扣點。",
		magicChatTitle: "Magic 指令",
		magicChatHint:
			"用白話改整張圖 — 唔使先拆層。或：改成新文案（要先選文字層）",
		magicChatHintWithCosts: (c: { edit: number }) =>
			`描述整張圖要點改（約 ${c.edit} 點）。拆層係獨立按鈕，呢度唔使。免費：提起、貼上、可編輯文字。`,
		magicChatPlaceholder: "例如：背景改夜晚 · 標題改成夏季大促…",
		magicChatSend: "執行",
		magicChatHelp:
			"描述整張圖嘅修改。可選：改成 …（選中文字層）· 改這層：…（只改選中塊）",
		magicChatNeedLayer: "呢個指令要先選中圖層（或直接描述整張圖要點改）。",
		magicChatNeedText: "請選中文字層並輸入新文案（或寫「改成 …」）。",
		magicChatOk: "完成。",
		magicFullEditing: "AI 正在改整張圖…",
		magicFullEditDone: "整張圖已更新。",
		magicFullEditDoneClearedLayers:
			"整張圖已更新 — 已清走舊圖層，避免同新底圖打架。",
		magicFullEditFailed: "整圖編輯失敗",
		magicFullEditNeedPrompt: "請先描述整張圖要改咩。",
		magicFullEditNeedImage: "請先上傳圖片。",
		qwenSplitting: "正在拆層…",
		qwenRegionSplitting: "正在拆選區…",
		qwenRegionReady: "選區已拆 — 新圖層已加入，底圖已修補。",
		layersReadyHint:
			"圖層已就緒 — 未拆出嘅仍喺底圖。可用擦除，或框選後拆選區。",
		readyToEdit: "圖片已就緒 — 先拆層，再擦除殘留或拆選區。",
		readyLiftHint: "已開框選 — 框住一整塊組件，鬆手即提起。",
		readyManualHint: "圖像已就緒 — 拆層（文字＋物件），或框選提起一件。版面保留。",
		emptyLiftHint: "暫無圖層 — 試拆層，或框選/筆刷。",
		boxLift: "框選提起",
		boxLiftOn: "框選提起中",
		boxLiftHint: "框選一塊提起為圖層",
		detectAll: "拆層",
		detectAllQwen: (n: number) => `Florence 拆層 ${n}`,
		detectAllFlorence: (n: number) => `Florence 拆層 ${n}`,
		qwenFullSplit: (n: number) => `Qwen 拆層 ${n}`,
		suggestText: (n: number) => `識別文字 ${n}`,
		qwenBox: (n: number) => `拆選區 ${n}`,
		qwenBoxOn: "拆選區中",
		qwenBoxHint: "喺底圖上框住殘留組件 — 只對該區域再拆層。",
		qwenNeedHttpBg: "底圖地址未就緒 — 請重新拆層後再試。",
		erase: "清底圖",
		eraseOn: "清底圖中",
		eraseHint: "框選底圖上唔想要嘅殘留並清除（唔新建圖層）。",
		erasePlate: "清底圖",
		erasePlateOn: "清底圖中",
		erasePlateHint: "框選底圖殘留並修補 — 只清底圖，圖層保留。",
		erasePlateDone: "已從底圖擦除。",
		eraseLayer: "擦圖層",
		eraseLayerOn: "擦圖層中",
		eraseLayerHint: "先選中圖層，再框要打穿嘅部分（喺呢塊打透明洞）。",
		eraseLayerNeedSelect: "請先選中一個圖層，再擦圖層。",
		eraseLayerDone: "已從呢個圖層擦除。",
		erasingHole: "正在擦除…",
		eraseDone: "已從底圖擦除。",
		missTools: "殘留處理",
		missToolsHint: "漏拆可用：AI 改選區、清底圖、擦圖層、框選提起，或拆選區。",
		lifting: "正在切割並清底…",
		makeEditableText: "改為可編輯文字",
		makeEditableTextHint:
			"免費：把圖片字換成真正可改文字 — 25+ 字體、描邊／柔陰影／硬陰影／發光／霓虹，字色·描邊色·陰影色可分開設。",
		chargedErase: (n: number) => `已 AI 清底 · ${n} 點`,
		updatingLayers: "正在拆層…",
		layers: "圖層",
		itemsCount: (n: number) => `${n} 個`,
		lastTokens: (n: number) => `上次 ${n} 點`,
		ocrObj: (text: number, obj: number) => `文字 ${text} · 物件 ${obj}`,
		brushMappedWrong: "筆刷切割同塗抹唔對應（座標異常）。請清筆劃、喺主體再塗一次，再撳「生成圖層」。",
		brushOffCanvas: "筆刷冇畫喺圖上。請喺相片範圍內塗抹（唔好畫空白邊）。",
		brushTooLarge: "筆刷範圍太大（幾乎成張圖）。請只塗要提起嘅主體。",
		brushLayerReady: "筆刷圖層已建立 — 拖一下確認切割啱唔啱。",
		boxTooLarge: "框選太大 — 請只框住要提起嘅主體。",
		boxLayerReady: "框選圖層已建立 — 拖一下確認切割啱唔啱。",
		makeLayerHint: "喺主體上塗抹後撳「生成圖層」。「清除筆劃」只清紫色塗層，唔會擦走相片。",
		add: "新增",
		addHow: "加普通文字、形狀、Logo — 或用 AI 生成新貼紙落畫布。",
		aiAddComponent: "添加 AI 組件",
		aiAddHow: "描述角標、圖標、產品或貼紙。獨立透明圖層，可拖曳。",
		aiAddPlaceholder: "例如：金色限時角標 · 紅色減價爆炸貼 · 可愛吉祥物揮手",
		aiAddRun: (n: number) => `生成組件 ${n}`,
		aiAddGenerating: "正在生成組件…",
		aiAddReady: "AI 組件已加入 — 拖去定位。",
		aiAddFailed: "AI 組件失敗",
		aiAddNeedPrompt: "請先描述要生成嘅組件。",
		text: "文字",
		logo: "Logo",
		logoBusy: "Logo…",
		rect: "矩形",
		...
		makeLayer: "生成圖層",
		cutting: "切割中…",
		healTok: (n: number) => `清底約 ${n}+ 點（AI 填充）`,
		noLayersYet: "未有圖層",
		show: "顯示",
		hide: "隱藏",
		lock: "鎖定",
		...
		copyLayer: "複製",
		pasteLayer: "貼上",
		layerCopied: "已複製圖層 — 撳「貼上」或 ⌘V 放置。",
		layerPasted: "已貼上圖層。",
		layerClipboardEmpty: "未有可貼內容 — 請先複製一個圖層。",
		forward: "↑",
		backward: "↓",
		toFront: "置頂",
		toBack: "置底",
		...
		matting: "…",
		delete: "刪除",
		editTextPlaceholder: "輸入新文案…",
		editTextHintEnable: "先輸入新文案，再撳「AI 改字」保留風格，或「改為可編輯文字」",
		enablingText: "正在從底圖清除原文字…",
		textEditableNow: "文字已可編輯 — 可改內容、大小、字體或橫直排。",
		liveText: "改為可編輯文字",
		liveTextOn: "可編輯文字已開",
		aiRewrite: (n: number) => `AI 改字 ${n}`,
		aiRewriteHint: "OCR 亂碼可忽略 — 直接輸入正確新文案。AI 按裁切圖保留風格。",
		qwenTextEditHint:
			"圖層係視覺裁切。改字：輸入新文案 → AI 改字。可編輯文字係普通字體兜底。",
		cropEditIdle: "喺畫布點選圖層，或用「AI 改選區」框出要改嘅地方。",
		aiEditRegion: "AI 改選區",
		aiEditRegionOn: "AI 改選區中",
		aiEditRegionHint: "框選要改嘅地方 → 鬆手後寫清楚點改 → AI 淨係改呢塊裁切。",
		aiEditRegionReady: "選區已提起 — 喺下面講要改咩，再撳 AI 編輯。",
		cropEditTitle: "編輯選中",
		cropEditHow: "呢塊有兩種改法 — 揀下面分頁。",
		cropEditModeText: "改文字",
		cropEditModeAi: "AI 改樣",
		cropEditModeTextHint: "保留字體風格，只改文案（約圖像點數）。",
		cropEditModeAiHint: "改顏色／國旗／人臉／產品（約圖像點數）。唔係打精確新字。",
		editInstructionPlaceholder: "例如：改成「夏季大促」· 英國旗改中國旗 · 把臉換成微笑女生",
		aiEditCrop: (n: number) => `AI 改樣 ${n}`,
		aiEditCropHint: "淨係改選中裁切。要打精確新文案，用「改文字」。",
		aiEditingCrop: "AI 正在改選區…",
		aiEditCropDone: "選區已更新。",
		aiEditCropFailed: "AI 選區編輯失敗",
		aiEditNeedInstruction: "請先說明呢塊區域要改成咩。",
		chargedAiEditCrop: (n: number) => `AI 選區編輯 · ${n} 代幣`,
		aiRewriting: "AI 正在改字…",
		aiRewriteDone: "改字完成 — 已按原風格重繪。",
		aiRewriteFailed: "AI 改字失敗",
		aiRewriteNeedText: "請先輸入新文案。",
		aiRewriteNeedHttpCrop: "呢個裁切暫唔支援 AI 改字 — 已改用可編輯文字。",
		chargedAiRewrite: (n: number) => `AI 改字 · ${n} 點`,
		bold: "粗體",
		color: "顏色",
		strokeColor: "描邊色",
		effectColor: "陰影色",
		effectColorHint: "陰影或發光顏色（可同字色唔同）",
		fontStyle: "字體",
		fontGroupSystem: "系統",
		fontGroupCjk: "中文",
		fontGroupSans: "無襯線",
		fontGroupSerif: "襯線",
		fontGroupDisplay: "海報／標題",
		fontGroupScript: "手寫",
		fontSystem: "系統",
		fontPingFang: "蘋方／黑體",
		fontSongtiSystem: "宋體（系統）",
		fontYuantiSystem: "圓體（系統）",
		fontNotoSansSc: "Noto 黑體簡",
		fontNotoSansTc: "Noto 黑體繁",
		fontNotoSerifSc: "Noto 宋體簡",
		fontZcoolXiaowei: "站酷小薇",
		fontZcoolQingke: "站酷慶科",
		fontMaShanZheng: "馬善政毛筆",
		fontInter: "Inter",
		...
		textEffect: "效果",
		textEffectNone: "無",
		textEffectOutline: "描邊",
		textEffectHeavyOutline: "粗描邊",
		textEffectSoftShadow: "柔陰影",
		textEffectHardShadow: "硬陰影",
		textEffectGlow: "發光",
		textEffectNeon: "霓虹",
		textEffectOutlineShadow: "描邊+陰影",
		textEffectShadow: "陰影",
		newText: "新文字",
		seedreamCopyrightBlocked:
			"Seedream 拒絕咗呢張圖（版權／品牌／肖像過濾）。點數已退回。用戶上傳同我哋 AI 海報都可能踩到（有 Logo／角色時）。請用框選提起／清底圖，或換一張圖。",
		seedreamNoLayersRefunded: (n: number) =>
			`冇可提起圖層 · 已退回 ${n} 點`,
		brushCutoutLabel: "筆刷摳圖",
		brandLogoLabel: "品牌 Logo",
		layerText: (s: string) => `文字：${s}`,
		layerLogo: (s: string) => `Logo：${s}`,
		layerShape: (s: string) => `形狀：${s}`,
		layerObject: (s: string) => `物件：${s}`,
		chargedDetect: (n: number, bal?: number) =>
			bal != null ? `偵測已扣 ${n} 點 · 餘額 ${bal}` : `偵測已扣 ${n} 點`,
		chargedHeal: (n: number) => `本地清底兜底已扣 ${n} 點`,
		chargedMatte: (n: number) => `摳圖已扣 ${n} 點`,
		blurPunchFallback: "已用免費本地填充（伺服器修復唔可用）。",
		downloaded: "已下載合成 PNG（背景 + 圖層）。",
		downloadLayer: "下載呢塊",
		downloadLayerHint: "只下載選中圖層 PNG — 唔係成板。",
		downloadedLayer: "已下載呢個圖層 PNG。",
		downloadLayerNeedImage: "呢層暫時冇圖片檔（可編輯文字／形狀）。請用頂部「下載」成板，或先轉成圖片裁切。",
		downloadLayerFailed: "無法下載呢個圖層。",
		savedLibrary: "已儲存到作品庫",
		noLayersDetected: "偵測唔到圖層。可用筆刷摳圖手動抬起區域。",
		detectMissHint: "漏檢區域請用「筆刷」或「框選」提起。",
		...
		somethingFailed: "出錯咗",
		logoLoadFailed: "Logo 載入失敗",
		couldNotAddLogo: "無法加入品牌 Logo",
		brushFailed: "筆刷摳圖失敗",
		matteFailed: "摳圖失敗",
		noCropForMatte: "冇可用於摳圖嘅裁切。",
		nothingToExport: "仲未有可匯出內容。",
		exportFailedLoading: "匯出失敗 — 圖片可能仲喺度載入，請再試。",
		exportFailedGeneric: "無法匯出 — 請等圖層載入完成再試。",
		saveFailed: "無法儲存到作品庫",
		titleShow: "顯示",
		titleHide: "隱藏",
		titleLock: "鎖定",
		...
		titleForward: "前移",
		titleBackward: "後移",
		titleBrandLogo: "品牌套件 Logo",
		titleNeedBrandLogo: "請先喺品牌套件上載 Logo",
	},
	imageCanvas: {
		badge: "獨立工具 · 唔使重新生成",
		title: "圖片畫布工作室",
	...
	contentResearch: {
		...
		busy: "搜尋網頁並分析中…",
		failed: "內容研究失敗，請再試。",
		signInRequired: "要登入先可以用平台內容研究（Standard 或以上）。",
		searchCooldown: "小紅書 API 需要冷卻 — 請等 {seconds} 秒再搜尋。",
		topicRequired: "請先輸入搜尋關鍵字。",
		topPicksTitle: "為你改寫嘅 3 個方向（參考爆款）",
		sendToUltraCanvas: "發送到 Ultra 畫布 →",
		sendToUltraMasterHint: "Ultra 畫布需要 Master 方案。",
		sendToUltraUpgrade: "升級至 Master →",
		inspiredBy: "參考爆款",
		...
		resultSubtitle: "根據 小紅書、Instagram 熱門帖整理。",
		...
		noResultsHintXhs: "可試更具體嘅中文品類詞（如 維他命C精華、護膚）。",
		noResultsHintTiktok: "用短英文關鍵詞（skincare routine、開箱）。",
		appliedContinue: "已套用 — 檢查主標題同出圖模式，然後去 Step 2。",
		scoreLabel: "適合度",
		allAnglesTitle: "全部角度",
		liveBadge: "即時網頁研究",
		playbookBadge: "AI 建議（無搜尋）",
		sourceNoteJustOneLive: (platform: string) => `${platform} 貼文搜尋（即時）`,
		sourceNoteWebLive: (provider: string) => `即時網頁研究（${provider}）`,
		sourceNotePlaybook: "AI 建議（無網頁搜尋）",
		sourceNoteDirectPost: "已釘選參考貼文（即時）",
		sourceNoteDirectPostImage: "已釘選參考貼文（即時）· 圖文／輪播",
		sourceNoteDirectPostVideo: "已釘選參考貼文（即時）· 影片／Reels",
		justOneFallbackGateway:
			"Just One API 伺服器暫時故障（HTTP 502）— 已改用公開網頁搜尋（無貼文封面）。請等 10–30 分鐘再試，或聯繫 Just One API 客服。",
		justOneFallbackPermission: (platform: string) =>
			`Just One API 未開通 ${platform} 搜尋權限（code 600）— 請到 dashboard 開通對應 endpoint。已改用公開網頁搜尋，無貼文封面。`,
		justOneFallbackBalance:
			"Just One API 餘額不足（code 601）— 請到 dashboard 充值。已改用公開網頁搜尋，無貼文封面。",
		justOneFallbackBudget:
			"Just One API token 用量上限已滿（code 602）— 請在 dashboard 提高 token 預算。已改用公開網頁搜尋，無貼文封面。",
	...
	studioAssistant: {
		...
		welcomeLanding:
			"你好！問我 Alchemy — 精靈 vs Ultra 畫布 vs 字幕 vs 修圖、免費 300 token 夠唔夠。或者話你想推廣咩，我幫你開正確路徑。",
		welcomeStart:
		...
		welcomePro:
			"Ultra 畫布 — 節點工作流：上傳→圖片→影片、修飾節點、劇本流水線、儲存畫布。跑之前可以問我順序、模板或 token 成本。",
		welcomeBrandKit:
		...
		studioContinued:
			"已開工作室 — 跟嗰頁卡片（揀出圖／出片／圖+片，再 Continue）。想問 tokens 或工具，返首頁再問就得。",
		...
		signInToChat:
			"登入可儲存專案同生成作品 — 唔登入都可以喺呢度問問題。",
		openLauncher: "開啟工作室助理",
		dialogLabel: "工作室助理對話",
		errorNetwork: "連線有啲唔穩，請稍後再試。",
		quotaExceeded: "今日 AI 規劃次數用晒 — 聽日再試，或者 [查看方案](/pricing) 升級。有帳號可 [登入](/sign-in) 享更高每日額度。",
	...
	microWizard: {
		...
		resumeCta: {
			freeBadge: "唔扣 Token",
			paidBadge: "會扣 Token",
			hint: "紫色：睇你已經出好嘅成品（唔扣）。白色：用上面新設定再出新成品（會扣 Token）。",
		},
    ...
    intakeFuse: {
      stepEyebrow: "第 3 步",
      title: "研究風格，或選模板。",
      hint: "平臺研究借用熱門帖排版，再改寫成你的產品文案。模板則跳過研究，用預設（或空白「直接創作」）。",
      conceptTitle: "研究風格，或選模板。",
      conceptHint: "平臺研究找排版參考。模板 + 概念助手直接寫簡報，不必先研究。",
      pathOptionsPhysical:
        "只選一種開始：① 平臺研究 · ② 模板（含「直接創作」）。切換會清空另一路徑。",
      pathOptionsConcept:
        "只選一種開始：① 平臺研究 · ② 模板 + 概念助手。切換會清空另一路徑。",
      tabsAriaLabel: "怎樣開始",
      tabResearch: "平臺研究",
      tabTemplate: "模板",
      tabDirect: "直接創作",
      ...
      tipTitle: "參考風格，不抄內容。",
      tipIntro:
        "AI 會分析排版、語氣、色調和構圖 — 唔會抄帖子內容或品牌。靜圖廣告研究請用 小紅書／Instagram。",
      tip1: {
        title: "效果更好",
        body: "關鍵詞寫得具體一點，研究結果會更接近你想要的風格。",
      },
      tip2: {
        title: "先由小紅書／Instagram 開始",
        body: "呢兩個 feed 通常畀到最乾淨嘅靜圖廣告排版。",
      },
      tip3: {
        title: "風格大於內容",
      ...
      templateDirectBody: "空白排版 — 用助手填寫大字／標題與輔助句。",
      templatePickHint: "請先在上方選風格模板或直接創作，再填寫文案。",
      templateSelectedNote: "已選：{name}",
      switchPathConfirm:
        "切換會清走另一路徑 — 研究揀選或模板揀選，同埋呢步文案。確定繼續？",
      researchSelectedBanner:
        "已揀：{title} · {platform} · 撳「繼續」之後會套用風格",
      copyHookLabel: "大字／標題",
      copyHookPlaceholder: "吸睛的主標語",
      copySublineLabel: "輔助句",
      copySublinePlaceholder: "賣點、證明或副標",
      copyOfferLabel: "優惠／CTA",
      copyOfferPlaceholder: "可選促銷或行動呼籲",
      researchAdaptTitle: "改寫成你的產品文案",
      researchAdaptProvenance: "靈感來自：{post} · 已改寫畀：{product}",
      researchAdaptProductFallbackProduct: "你嘅產品",
      researchAdaptProductFallbackConcept: "你嘅概念",
      researchAdaptHint: "保留帖子方向，把 hook／受眾／文案改寫成你的產品或概念。",
      researchAdaptBusy: "改寫中…",
      researchAdaptDone: "文案已改寫 — 繼續前可再編輯。",
      researchAdaptFailed: "無法自動改寫，請手動編輯欄位。",
      researchAdaptNeedProduct: "請先填產品或概念名稱，才能改寫文案。",
      ...
      productAssistTypeBehindHint:
        "巨型大字只用短詞（約 10 個字母）— 例如 “Power Anywhere: The Portable…” → POWER → ANYWHERE。請填 KEEP MOVING，唔好寫完整廣告句。輔助句只作氣氛指引。",
      ...
      productAssistNeedProduct: "請先輸入產品名稱。",
      directTitle: "現在跳過研究",
      directBody: "下一步會在設定頁選風格、尺寸與解析度。",
      directBullets: [
        "不必先做平臺搜索",
        "在上方選模板或直接創作",
        "在此填文案，下一頁再設風格",
      ],
      videoDirectBody: "在此填好文案後，下一頁再設時長與解析度。",
      videoDirectBullets: [
        "不必先做平臺搜索",
        "模板或直接創作，再用助手填寫",
        "時長與解析度會顯示預計點數",
      ],
      assistantIntro: "選好模板（或直接創作）後，描述你的服務 — AI 幫你填標題和視覺方向。",
    },
		...
		productNameStep: {
			stepEyebrow: "第 3 步",
			title: "你嘅產品係點樣嘅？",
			hint: "會用於研究關鍵字、標題、prompt，以及需要時嘅分鏡規劃。",
			label: "產品",
			labelHint: "寫短啲嘅產品名 — 例如「金砂石手鏈」，唔好淨係寫「飾品」，亦唔好寫成長篇賣點。",
		...
		preGenerateSetup: {
			...
			fromIntakeTitle: "創作方式已設定",
			fromIntakePathResearch: "路徑：平台研究",
			fromIntakePathTemplate: "路徑：模板",
			fromIntakePathDirect: "路徑：直接創作（無模板）",
			fromIntakeStyle: "風格／參考：{name}",
			fromIntakeHeadline: "主標：{text}",
			fromIntakeNeedPhoto: "仲需要：產品相",
			fromIntakeReadyMaterials: "核對下面素材之後就可以生成。",
			browseContinueScenes: "睇已有場景圖 →",
			browseContinueImage: "睇已有圖片 →",
			browseContinueHint:
				"紫色：直接睇你已經出好嘅成品（唔扣 Token）。白色：用上面新設定再出新成品（會扣 Token）。",
			regenerateScenes: "重新出新場景",
			regenerateImage: "重新出新圖",
			directHint:
			...
			stylePickerHint:
				"揀一個：直接產品廣告、商業設計海報、零件拆解、或模特兒佩戴／使用。",
...
stylePickerModelLabel: "模特兒佩戴／使用",
			...
			copyCollapsedHint: "文案已經跟創作方式設定好。展開可以再改。",
			hideCopyFields: "收起文案欄位",
			conceptCopyFocus: {
				info: {
					title: "呢個方向：重點填「賣點條列」",
					body: "大字／標題係主句；輔助句請一行一個賣點 — 會直接變成資訊圖 bullets。",
				...
				designed: {
					...
					body: "大字／標題 = 海報大標題（你填咩就畫咩，唔會換成產品名或亂發明標語）。輔助句 = 短標語。額外要求只寫色調／場景。",
					hookLabel: "海報主標題",
				...
				parts: {
					...
					body: "大字／標題 = 海報標題。輔助句 = 一行一個零件短說明 — 會變成爆炸圖標註。額外要求寫燈光／零件數量／背景氣氛。",
					hookLabel: "海報主標題",
				...
				"gaming-cover": {
					title: "呢個方向：填封面大字",
					body: "大字／標題會變成場景入面嘅大字。上傳圖鎖英雄／產品身份。輔助句＝HUD。額外＝場景／燈光。",
					hookLabel: "封面標題",
				...
				"sports-big-words": {
					title: "呢個方向：填巨大動作詞",
					body: "大字／標題驅動巨大疊層字（SMASH／SPIKE…）。上傳＝運動員或產品動作。輔助句＝HUD 數據。",
					hookLabel: "大字／標題",
				...
				"jelly-3d": {
					title: "呢個方向：填少量品牌字",
					body: "大字／標題＝頂部稀疏字。上傳引導果凍造型／品牌。輔助句＝底部品牌行。畫面保持極簡。",
					hookLabel: "頂部品牌行",
...
"material-letters": {
				...
				brand: {
					title: "呢個方向：重點係品牌風格",
					body: "有網站／社交請先做品牌分析。大字／標題同輔助句會跟品牌色調排版，唔係價卡。",
					supportingLabel: "品牌訊息／副標",
					supportingPlaceholder: "例如：專業顧問 · 可信賴 · 本地服務",
				},
				pricing: {
					title: "呢個方向：重點填「優惠／CTA」",
					body: "大字／標題寫方案名；優惠欄會變成價卡／套票上嘅 CTA。冇填優惠就唔會發明價錢。",
				...
				website: {
					...
					body: "大字／標題寫上線賣點；輔助句寫功能／好處。畫面會偏網站／App mockup。",
			...
			mainPhotoHint: "清晰正面產品相 — 輸出會以呢張做產品身份。人像生活照較適合「模特兒佩戴／使用」。",
		...
		preVideoSetup: {
			...
			browseContinueExport: "睇已有影片 →",
			browseContinueHint:
				"紫色：直接睇你已經出好嘅片（唔扣 Token）。白色：用上面新設定再出一條新片（會扣 Token）。",
			regenerateVideo: "重新出新片",
			assistantHint:
			...
			typeBehindCopyFocus: {
				title: "只用短詞",
				body: "身後只畫 1–2 個短詞（須可讀）。長廣告句會自動縮短 — 例如 “Power Anywhere: The Portable…” → POWER → ANYWHERE。",
				hookLabel: "巨型字",
		...
		conceptNameStep: {
			...
			hint: "會用於研究關鍵字、標題、prompt，以及需要時嘅分鏡規劃。",
			label: "概念",
			labelHint: "寫清楚就得 — 唔好太闊（如「生意」），亦唔好寫成整份活動方案。",
			placeholder: "例如：瑜伽會員招募",
			examplesLabel: "試下例子",
			examples: ["瑜伽會員招募", "護膚品牌煥新", "週末早午餐推廣"],
		},
		conceptTitle: "概念助手",
		...
		blockReasons: {
			...
			pick_intake: "請揀平台研究或模板以繼續。",
			complete_research:
				"未完成：請先揀一張研究卡片（或貼帖連結）— 或改揀模板。",
			pick_template: "未完成：請先揀模板或直接創作，並填主標。",
			...
			need_product_name: "請輸入你嘅產品。",
			need_concept: "請輸入你嘅概念。",
			...
			research_adapting: "等陣：正在將文案改寫成你嘅產品…",
			need_headline: "未完成：請先填主標（hook）再繼續。",
			image_busy: "請等圖片生成完成。",
	...
	ultraCanvas: {
		...
		title: "Ultra 畫布",
		subtitle:
			"節點工作流：新增節點、用 @ 引用素材、逐步或一次運行。",
		costHint:
			"Ultra 畫布按次扣 Token。每次出圖或出片會從你嘅 Alchemy Token 餘額扣除。",
		mobileDesktopOnly:
		...
		runAllEmpty: "冇可運行節點 — 請新增圖片、影片、劇本或音訊節點。",
		runAllConfirmTitle: "全部運行？",
		runAllConfirm:
			"將按順序運行 {nodes} 個節點 — 預估 ~{tokens} tokens。劇本規劃用方案配額（唔扣 token）。繼續？",
		queueSkipped: "已跳過（上游失敗）",
		discardConfirm: "捨棄呢塊畫布未儲存嘅改動？",
		discardConfirmTitle: "捨棄改動？",
		busyBanner: "運行中 — 儲存／載入已鎖定",
		spawnBlockedExistingScenes: "場景節點已存在 — 請先刪除已生成嘅 image/video 節點再重新生成。",
		researchHandoffImported: "已將 Studio 研究匯入 Research 節點。",
		staleOutputBadge: "上游已變更 — 請重新執行以刷新輸出。",
		creativeBHint: {
			title: "導演檢查清單",
			staleTag: "需重跑",
			steps: [
				...
				"角色 — 人臉 + 可選多角度。",
				"場景 — 場景聖經 + 構建空間。",
				"劇本 — 規劃（靜幀 + 動態 + 每場 VO 台詞）。",
				"靜幀 — 分鏡同步 → 關鍵幀（或生成 Image）。",
				"配音 — 由已接劇本拉取 → 生成 TTS（影片前或同時）。",
				"影片 — 每場生成（動態含台詞表演）。",
				"拼接 — 合併場景 + 按時間軸混入配音。",
			],
			dismiss: "關閉",
		...
		mobileNodes: "+ 添加節點",
		stopRun: "停止",
		busyNavBlocked: "請等運行完成後再切換畫布。",
		runCancelled: "已取消",
		aliasPlaceholder: "@別名（例如 Ava）",
		imagePromptPlaceholder: "描述廣告圖片… 用 @ 引用多圖素材",
		runImage: "生成圖片",
		refineImage: "微調靜幀（可選）",
		imageFromStoryboard: "分鏡靜幀已就緒 — 下一步生成影片（唔使再生成圖片）。",
		tokenBadge: "{n} tok",
		...
		directorChipsHint:
			"可選：撳一下會把提示文字貼入上方輸入框。做動作片請先唔好撳呢啲 — 自己寫運動提示，或者淨係撳「動作衝擊」。",
		scriptNode: {
			sceneCountLabel: "場景數量",
			beatsTitle: "導演節拍（幕 · 時間 · 情緒 · 鏡頭 · 台詞）",
			beatActPlaceholder: "Act 1 · Pain",
			beatTimePlaceholder: "0-8秒",
			beatEmotionPlaceholder: "情緒 / 氛圍",
			beatFramingPlaceholder: "景別（如中近景）",
			beatCameraPlaceholder: "運鏡（如慢推）",
			beatBlockingPlaceholder: "走位 / 動作",
			beatLinePlaceholder: "台詞或螢幕文字",
			beatSpeakerPlaceholder: "說話人別名（PersonA）",
			spawnCastHint:
				"生成流水線時會按劇情分派角色並串起連續鏡頭（上一場圖→下一場）。如需調整，直接改各場景圖裡嘅 @PersonA / @PersonB / @brand。",
		},
		characterNode: {
			hint: "可以 AI 生成人臉參考圖，或者上傳 / 從作品庫選擇 — 再「生成多角度」做三視圖，連到場景或 @提及。",
			uploadPlaceholder: "上傳人臉 / 三視圖",
			biographyPlaceholder: "人物小傳 — 年齡、穿搭、性格…",
			generatePromptPlaceholder: "可選：AI 生成外貌提示（留空就用人物小傳）…",
			generate: "AI 生成角色",
			generateNeedPrompt: "請先填人物小傳或外貌提示再生成。",
			aiGeneratedFileName: "AI 角色參考圖",
			orUpload: "— 或者上傳 / 作品庫 —",
			aliasPlaceholder: "別名（如 PersonA）",
			generateAngles: "生成多角度",
			generatingAngles: "生成角度中…",
			anglesNeedFace: "請先上傳或生成人臉。",
			anglesReady: "角度表就緒 — 可用作 @鎖定。",
			openAngleSheet: "打開角度表",
		},
		brainstormNode: {
			hint: "想法 + 目標時長 → 多個創意方向。揀一個填入劇本。",
			ideaPlaceholder: "你的想法 / 產品鉤子…",
			durationLabel: "目標時長（秒）",
			brainstorm: "腦暴選項",
			brainstorming: "腦暴中…",
			needIdea: "請先輸入想法。",
			applied: "已套用到劇本 — 請檢查節拍並按需規劃。",
			pick: "用呢個 → 劇本",
			optionFallback: "選項",
		},
		researchNode: {
			hint: "調研摘要會流入劇本同場景提示。可從 Studio 調研匯入。",
			summaryPlaceholder: "貼上調研摘要、鉤子、創意方向…",
			importHandoff: "匯入 Studio 調研",
			handoffImported: "調研內容已匯入。",
			handoffMissing: "搵唔到 Studio 調研交接 — 請先喺 Studio 完成調研。",
			openStudioResearch: "喺 Studio 做調研 →",
		},
		proControls: {
			title: "專業控制",
			aspectRatio: "畫幅比例",
		...
		toolbar: {
			...
			newBoard: "清空畫布",
			load: "載入",
			emptyBoards: "仲未有儲存嘅畫布。",
			nodeCount: "{n} 個節點",
			undo: "撤銷",
			redo: "重做",
			templates: "模板",
			shortcuts: "⌘Z 撤銷 · ⌘⇧Z 重做 · ⌘D 複製 · Del 刪除 · ⌘S 儲存",
			deleteBoard: "刪除畫布",
			deleteBoardConfirm: "刪除呢個已儲存畫布？呢個操作無法還原。",
			deleteBoardConfirmTitle: "刪除畫布？",
			clearBoardConfirmTitle: "清空畫布？",
			clearBoardConfirm: "清除所有節點並回到空白起步板（上傳→圖片→影片）？未儲存嘅更改會冇咗。",
		},
		videoPromptLabel: "影片動態／劇情",
		videoPromptHint:
			"呢格控制片入面發生咩事（動作、對白感覺、節奏）— 唔係靜幀樣貌。場景圖片＝畫面；呢個節點＝動態。",
		videoVsTextVideoHint:
			"需要已連接或 @提及 嘅靜幀。仲未有圖？由左側面板加「文字生影片」（或者用起始板嘅文字生影片節點）。",
		videoPromptPlaceholder: "例如：男人傾前講：仲搞緊？半夜啦。產品廣告喺邊？",
		videoPromptEmptyWarn:
			"動態框係空嘅 — 而家淨係靠鏡頭運動。請填入劇情／動作，再撳生成影片。",
		textVideoPromptHint:
			"由諗法直出片段：喺呢度描述成場戲，唔使靜幀。已經確認參考圖就用「圖生影片」。",
		textVideoPromptPlaceholder: "電影感文字生影片提示…",
		paletteTextVideoHint: "冇靜幀？用「文字生影片」— 描述場景之後直接生成。",
		paletteScrollUp: "向上",
		paletteScrollDown: "向下",
		runVideo: "生成影片",
		runTextVideo: "文字生影片",
		runScript: "規劃劇本",
		scriptBriefPlaceholder: "輸入創意簡報，AI 會規劃分鏡…",
		scriptSceneLabel: "場景 {n}",
		spawnScenes: "生成 {n} 個文字生影片節點",
		spawnPipeline: "生成 {n} 條圖片→影片流水線",
		openCaptions: "喺字幕工作室開啟",
		missingLocalAsset: "本地檔案未儲存 — 請重新上傳或從作品庫揀選。",
		uploadPlaceholder: "上傳圖片 / 關鍵幀",
		uploadRefHint: "設定 @別名（如 Outfit、Gundam、Model）。連到圖片節點或者提示詞 @提及 當參考圖。",
		pickFromLibrary: "從作品庫揀選",
		audioNode: {
			uploadPlaceholder: "上傳 MP3 / WAV / M4A",
			uploadCloud: "上傳到雲端",
			uploading: "上傳中…",
		},
		worldNode: {
			hint: "場景聖經 + 可選場景圖 →「構建空間」展開成完整環境表。",
			descriptionPlaceholder: "同一間辦公室、暖色頂燈、凌亂桌面、左側窗光…",
			uploadPlaceholder: "可選場景參考圖",
			buildSpace: "構建空間",
			buildingSpace: "構建空間中…",
			buildNeedDescription: "請先填場景描述或上傳參考圖。",
			spaceReady: "空間表就緒 — 可連到場景。",
			openSpaceSheet: "打開空間表",
		},
		storyboardNode: {
			hint: "分鏡格 —「生成整幕」一次填三格；可單格重生成。再推送靜幀 / 生成流水線。",
			syncFromScript: "由劇本同步",
			spawnClips: "生成鏡頭流水線",
			empty: "先規劃劇本，再撳「由劇本同步」。",
			shotLabel: "第 {n} 鏡",
			actLabel: "第 {n} 幕",
			panelLabel: "面板 {n}",
			panelsWord: "面板",
			stillPlaceholder: "本鏡靜幀提示詞",
			statusPending: "待生成",
			statusOutline: "大綱就緒",
			statusStill: "有圖",
			statusVideo: "有片",
			voWindow: "配音 {start}–{end}s",
			needScript: "請先連接上游劇本節點。",
			needPlan: "請先執行「規劃劇本」生成場次。",
			needPanelPrompt: "請先喺呢個面板填靜幀提示詞。",
			generateKeyframe: "關鍵幀",
			regenerateKeyframe: "重生成靜幀",
			generateVideo: "生成影片",
			regenerateVideo: "重生成影片",
			generateAct: "生成整幕靜幀",
			generatingAct: "生成靜幀中…",
			generateActVideos: "生成整幕影片",
			generatingActVideos: "生成影片中…",
			generatingKeyframe: "關鍵幀中…",
			needStillForVideo: "請先關鍵幀靜幀，再生成影片。",
			editPrompt: "改提示",
			hidePrompt: "收起",
			applyStillsToScenes: "推送靜幀 → 場景圖片",
			stillsApplied: "已將 {n} 張分鏡靜幀推入場景圖片節點。",
			stillsNoneToApply: "冇可推送嘅靜幀 — 請先關鍵幀，再生成流水線。",
		},
		voiceNode: {
			hint: "配音嚟自你接進嚟嘅劇本或分鏡。改上游台詞 → 拉取 → 可選生成預覽 → 拼接按場放置。",
			stepsHint: "1) 接劇本（或分鏡）→ 配音  2) 改上游台詞  3) 拉取對時  4) 可選生成預覽  5) 執行拼接。",
			scriptPlaceholder: "口播文案…（或由已連接嘅劇本／分鏡拉取）",
			pullDialogue: "由已連接劇本／分鏡拉取",
			generate: "生成配音",
			generating: "生成中…",
			needDialogue: "已連接嘅劇本／分鏡仲未有台詞 — 請加 beat line 或分鏡 dialogue，再拉取。",
			needWireScript: "請先將劇本或分鏡接到配音節點 — 拉取只讀你接嘅線，唔會偷其他節點嘅文案。",
			needPullBeforeSplice:
				"已接配音但未有對時台詞 — 請先由劇本／分鏡拉取，再拼接（否則口播唔會按場放置）。",
			timedLinesTitle: "對時台詞（來自已連接劇本／分鏡）",
			timedLinesHint: "時段跟場景順序 + 影片時長。改完上游要再拉取。拼接用呢啲線做配音。",
			timedLinesEmpty: "仲未有對時台詞 — 請先由已連接劇本／分鏡拉取。",
			sourceHint:
				"拉取只會用接住呢個配音節點嘅劇本／分鏡。淨係清空呢個框冇用 — 要改上游台詞再拉取。",
		},
		runSplice: "拼接影片",
		spliceHint: "連接影片節點（可選音訊做 BGM）。喺下面列表調整剪輯順序。",
		spliceOrder: {
			title: "剪輯順序",
			empty: "將影片節點連到呢個拼接 — 然後喺呢度排序。",
			hint: "↑↓ 決定播放順序。畫布位置唔再決定剪輯順序。",
			moveUp: "提前",
			moveDown: "延後",
			ready: "已就緒",
			waiting: "請先生成影片",
			needClips: "請先連接已生成嘅影片片段再拼接。",
		},
		videoProControls: {
			title: "影片專業控制",
			engine: "AI 模型",
			engineMinimaxH3: "單鏡出片（預設）",
			engineSeedance: "參考片模式",
			engineHint:
				"預設單鏡：人臉／產品鎖定、單鏡衝擊力更強。需要參考片／多靜幀風格先再切參考片模式。",
			aspectRatio: "畫幅比例",
			camera: "鏡頭運動",
			cameraAuto: "自動（跟提示詞）",
			cameraAutoHint: "唔加模板鏡頭 — 動態跟你嘅提示。",
			cameraFromPromptHint: "已偵測到提示詞入面嘅鏡頭描述 — 跳過模板鏡頭。",
			cameraMultiRefHint: "多參考影片跟提示詞運動 — 跳過模板鏡頭。",
			duration: "時長",
			resolution: "解像度",
			motionStrength: "運動強度",
			motionHint: "越高動作越大",
		...
		libraryPicker: {
			...
			close: "關閉",
			loading: "載入中…",
			empty: "作品庫暫時冇素材 — 喺 Studio 或 Ultra 畫布生成後匯出到作品庫。",
			unnamed: "未命名",
		},
		export: {
			saveToLibrary: "儲存到作品庫",
			saving: "儲存中…",
			saved: "已儲存到作品庫",
		},
		modifierNodes: {
			lightingHint: "連接到圖片或影片節點 — 將燈光效果合併到下游提示詞。",
			backgroundHint: "連接到圖片或影片節點 — 設定場景背景。",
			gradeHint: "連接到圖片或影片節點 — 套用畫面風格（影片安全）。",
		},
		cameraNode: {
			preset: "預設",
			spin: "旋轉",
		...
		textNode: {
			placeholder: "備註、簡介或提示片段…",
		},
		brandNode: {
			hint: "將品牌 Logo 作為 @brand 供圖片引用 — 可直接上傳、從作品庫選，或用品牌套件。",
			empty: "仲未有 Logo — 可喺下面上傳或打開品牌套件。",
			uploadLogo: "上傳 Logo",
			editKit: "編輯品牌套件 →",
			aliasPlaceholder: "別名（預設：brand）",
		},
		templates: {
			productHero: {
				name: "產品主圖",
			...
			storyDifferenceAd: {
				name: "故事差異廣告",
				desc: "Creative B V2 — 三幕（痛點→方案→收尾）· 9:16 · 約 23 秒拼接",
			},
			comicToPhotoreal: {
				name: "漫畫→真人漫遊",
				desc: "上傳漫畫角色 → 寫成真人並在場景中走動展示 · 靜幀→影片",
			},
			comicRedCarpet: {
				name: "漫畫紅毯",
				desc: "原創華麗角色的漫畫風紅毯秀 · 禁止真人明星臉",
			},
		},
	},
  ...
  ultraCanvas2: {
    badge: "Ultra",
    title: "Ultra 畫布",
    subtitle: "先選起點，再喺同一塊 Ultra 畫布自由改。可用左側加任何節點。",
    backClassic: "Ultra →",
    tryBeta: "Ultra 畫布",
    costHint: "按次扣 Token。每次圖像或影片生成會從 Alchemy 餘額扣除。",
    howTitle: "你想怎樣創作？",
    howSubtitle: "先選起點，之後仍可自由加節點、改連線。",
    noImageHint: "",
    laneA: "A · 完整影片廣告",
    laneAHint: "適合多場景投放",
    laneB: "B · 快速影片片段",
    ...
    badgeRequired: "必需",
    badgeOptional: "可選",
    restoredSession: "已還原你上次的編輯工作階段。",
    dismissRestore: "關閉",
    saveStatusSaving: "儲存中…",
    saveStatusSaved: "已全部儲存",
    saveStatusFailed: "儲存失敗",
    saveNow: "儲存",
    versionHistory: "已存畫布",
    dirtyUnsaved: "有未儲存變更",
    cards: {
      ...
      imagesToVideo: {
        title: "圖片 → 影片",
        desc: "把圖片（上傳或生成）變成短動態片段。",
        flow: "上傳 → 圖片 → 圖生影片",
      },
      storyboard: {
        title: "分鏡廣告",
        desc: "規劃場景、靜圖、配音並拼成多段廣告。",
        flow: "劇本 → 分鏡 → 配音 → 拼接",
      },
      scratch: {
        title: "從零搭建",
    ...
    useWorkflow: "使用此流程 →",
    recommended: "推薦",
    loadSavedTitle: "載入已存畫布",
    loadSavedHint: "繼續你已儲存到 Ultra 的畫布。",
    loadSavedEmpty: "尚未有已存畫布 — 請先選上方起點。",
    continueBoard: "繼續目前畫布",
    changeStart: "起始選擇",
    changeStartConfirmTitle: "打開起始選擇？",
    changeStartConfirm:
      "目前畫布會保留，直至你選新起點（會取代現有節點）。若要先清空，請用「清除畫布」。",
    textVideo: {
      useWhen: "已知畫面且不需要參考圖時使用。",
      purpose: "根據文字場景描述生成一條影片片段。",
      tip: "描述畫面上發生的事，不必寫模型指令。",
      example:
    ...
    spliceReview: {
      ...
      complete: "已完成",
      notAdded: "未加入",
      addBgmHint: "匯出前建議加背景音樂。可連接 Audio 節點，或選擇無音樂匯出。",
      completeAd: "先補齊廣告",
      exportWithoutMusic: "無音樂匯出",
    },
    askAlchemy: {
      title: "問 Alchemy",
      askAnything: "隨便問…",
      howToUse:
        "這裡還不能打字提問 — 請點下面的問題晶片。Alchemy 會根據你畫布上現有的節點回答。",
      checkWorkflow: "檢查我的工作流",
      skipUpload: "可以跳過上傳嗎？",
      estimateCost: "估算總費用",
      improvePrompt: "優化我的 Prompt",
      tip: "點上面的晶片即可得到回答。",
      answers: {
        missingScript: "請新增或打開「劇本規劃」（完整廣告必需）。",
        missingStoryboard: "劇本之後請加「分鏡」（必需）。",
        missingSplice: "最後請加「影片拼接」來合併片段。",
        uploadOptional: "上傳是可選的 — 沒有產品圖也可以從劇本開始。",
        laneBAlternate: "文字生成影片是快捷路徑（B 道），不是劇本後面的一步。",
        singleClipPath: "你在「單一片段」：在文字生成影片裡寫場景，再點生成。不需要圖片。",
        needUploadStill: "請先用「上傳」節點加入已確認的圖片。",
        animateFlow: "流程：上傳 → 圖片 → 圖生影片。",
        scratchBoard: "空白畫布 — 左側點「新增節點」，連線後再執行。",
        pickWorkflow: "請先選一種起始工作流（那四張卡片）。",
        coreOk: "核心節點看起來齊全 — 接下來跑劇本 / 生成片段。",
        skipYes: "可以。跳過上傳，用文字生成影片：寫清主體、動作、場景和運鏡。",
        skipNeedUpload: "「圖片轉動畫」必須先上傳（或從素材庫選圖）。",
        skipCompleteAd: "完整影片廣告裡，上傳可選。沒有照片也可以先寫劇本。",
        costEstimate: "現在點「全部執行」大約消耗 {n} Token。劇本規劃走計劃額度（不扣 Token）。",
        promptEmpty: "打開文字生成影片，按「主體 + 動作 + 場景 + 運鏡」寫。例如：黑玻璃上的精華瓶、金色透光、鏡頭緩慢推進。",
        promptStrengthen: "把 Prompt 寫清楚：主體是誰/什麼、做一個動作、在哪裡、鏡頭怎麼動。描述畫面，不要寫模型指令。",
      },
    },
    library: {
      search: "依名稱搜尋…",
