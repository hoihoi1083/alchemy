...
export const zh = {
  ...
  pricing: {
    ...
    comparisonRows: [
      ...
      { feature: "圖片最高解像度", free: "1K", standard: "1K", pro: "2K", master: "4K" },
  ...
  microWizard: {
    ...
    cinematicModeHint: "單場 8 秒快速試片，或多場拼接做 ~30 秒 pre-roll。",
    ...
    primaryStyleHint: "與經典設定相同 — 快速產品圖、參考匹配、模特穿搭、UGC 等。",
    ...
    blockReasons: {
      ...
      pick_combined_style: "請揀電影感拼接或關鍵幀動畫。",
    ...
    combinedStyleHint: "電影感拼接做多場 pre-roll；或 poster 關鍵幀再動畫。",
