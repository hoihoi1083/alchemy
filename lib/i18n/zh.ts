...
stylePickerModelLabel: "模特兒佩戴／使用",
  ...
  ultraCanvas2: {
    badge: "Ultra 2 · 測試",
    title: "Ultra 畫布 2",
    subtitle: "先選任務再進專業畫布；保留 Prompt 與自由連線。",
    backClassic: "經典 Ultra →",
    tryBeta: "Ultra 2（測試）",
    costHint: "與 Ultra 相同：按次扣 Token。",
    howTitle: "你想怎樣創作？",
    howSubtitle: "先選起始工作流，之後仍可改每一步。",
    noImageHint: "沒有參考圖？選「單一影片片段」。",
    laneA: "A · 完整影片廣告",
    laneAHint: "適合多場景投放",
    laneB: "B · 快速影片片段",
    laneBHint: "已知畫面時快速生成",
