...
socialDripFitTitle: "呢個格式可以／唔可以做咩",
	...
	editImage2: {
		...
		changeWordsHint: "輸入新文案，一鍵改字 — 盡量保留呢塊字嘅排版風格。",
		grabClick: "點選提起",
		grabClickOn: "點選提起中",
		...
		expandTitle: "擴展畫布",
		expandHow: "把底圖擴到社媒尺寸。圖層保留，只擴展背景。",
		expandSquare: (n: number) => `1:1 · ${n}`,
		expandStory: (n: number) => `9:16 · ${n}`,
		expandLandscape: (n: number) => `16:9 · ${n}`,
		expandWider: (n: number) => `4:5 · ${n}`,
		expanding: "正在擴展畫布…",
		expandDone: "畫布已擴展 — 可拖動圖層適配新構圖。",
		expandFailed: "擴展失敗",
		expandNeedHttpBg: "底圖需要伺服器網址 — 請先拆層，再擴展。",
		expandAlready: "已接近該比例 — 已略微外擴邊緣。",
		magicChatTitle: "Magic 指令",
		magicChatHint:
			"試試：拆層 · 改成新文案 · 點選提起 · 筆刷擦除 · 擴展 9:16 · 或描述對當前圖層嘅 AI 改",
		magicChatPlaceholder: "話俾 Magic 聽要做咩…",
		magicChatSend: "執行",
		magicChatHelp:
			"拆層 · 改文字 · 點選提起 · 筆刷擦除 · 擴展 1:1 / 9:16 / 16:9 · 或描述對選中圖層嘅修改",
		magicChatNeedLayer: "請先選中一個圖層。",
		...
		eraseDone: "已從底圖擦除。",
		missTools: "殘留處理",
		missToolsHint: "漏拆可用：AI 改選區、擦除、框選提起，或拆選區。",
		lifting: "正在切割並清底…",
		...
		textEditableNow: "文字已可編輯 — 可改內容、大小或顏色。",
		liveText: "改為可編輯文字",
		...
		cropEditTitle: "編輯選中",
		cropEditHow: "任意圖層都可改：改字、換國旗、換臉 — 用白話說明，AI 淨係改呢塊。",
		cropEditModeText: "改文字",
		cropEditModeAi: "AI 改呢塊",
		editInstructionPlaceholder: "例如：改成「夏季大促」· 英國旗改中國旗 · 把臉換成微笑女生",
		aiEditCrop: (n: number) => `AI 編輯 ${n}`,
		aiEditCropHint: "文字或畫面圖層都可（國旗、人臉、徽章…）。一次改一塊。",
