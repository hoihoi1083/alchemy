...
export const zhTw = {
  ...
  landing: {
    ...
    toolCaptionsDesc: "為任意 MP4 燒錄字幕、背景音樂和配音。",
...
socialDripFitTitle: "這個格式可以／不可以做什麼",
  ...
  captions: {
    ...
    trimIn: "開始（秒）",
    trimOut: "結束（秒）",
    tryCaptions2: "試用 Caption studio 2（語音自動字幕）",
  },
  captions2: {
    badge: "Caption studio 2 · 語音優先",
    title: "Caption studio 2",
    subtitle:
      "新流程：由片內人聲自動抽出時間軸字幕，再用 FFmpeg 修剪／BGM／燒錄。可與經典版對比。",
    diffTitle: "與經典 Captions 有何不同",
    diffBody:
      "經典版＝自己寫，或用主題 AI 規劃字幕 + 完整配音。Studio 2＝聽片裡的聲音（Whisper/OpenAI）填時間軸再燒錄。無聲 Seedance 片不會自動出字 — 請手寫或用經典版用主題規劃。",
    ...
    noSpeech: "聽不到人聲（可能是無聲 AI 片）。請手寫字幕，或去經典版用主題規劃。",
    silentHint: "無聲短片？",
    openClassicPlan: "去經典版用主題規劃字幕 →",
    evenSplitNote: "時間軸為估算（ASR 沒有分段）",
    asrCloud: "雲端 ASR",
    asrLocal: "本機 Whisper",
    chargedTok: (n: number) => `${n} tok`,
    needVideo: "請先載入影片。",
    continueFinish: "繼續完成（BGM + 燒錄）",
    finishHint: "可選 BGM，然後燒字幕（FFmpeg，與經典版同一引擎）。",
    classicVoiceNote: "需要 AI 配音／主題規劃？請用經典 Caption studio。Studio 2 專注語音→燒錄。",
  },
  editImage2: {
    title: "AI 智慧圖層",
