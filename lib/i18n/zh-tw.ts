...
export const zhTw = {
  ...
  microWizard: {
    ...
    preVideoSetup: {
      ...
      scenesReadyHint:
        "場景圖已準備 — 選擇每場 Kling 時長（5 秒或 10 秒），再串成一條無聲短影片（字幕之後再加）。",
      scenesReadyTitle: "分鏡場景已準備",
      scenesReadyBody: "這些靜幀會串成短影片。調好 Kling 每場時長後再生成。",
      assistantHint:
      ...
      klingTip2: {
        title: "先試 5 秒",
        body: "每場先用 5 秒再試 10 秒 — 更便宜，通常已夠動態。",
      },
      klingTip3: {
        title: "總長 = 場數 × 時長",
        body: "四場各 5 秒 ≈ 20 秒拼接片，不是 Seedance 那條 8 秒片。",
      },
      conceptTip1: {
        title: "照片可以不傳",
