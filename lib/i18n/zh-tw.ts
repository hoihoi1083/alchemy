...
export const zhTw = {
  ...
  footer: {
    tagline: "任何想法，幾分鐘變成停滑吸睛內容 — 圖片、影片和 Reels 一次完成。",
    productTitle: "產品",
    legalTitle: "法律資訊",
    studio: "開始製作",
    pricing: "方案與點數",
  ...
  landing: {
    ...
    subtitle:
      "上傳產品相或貼參考帖。Alchemy 分析風格、引導設定，再生成可編輯廣告圖同影片，5 分鐘搞定。",
    openStudio: "開啟工作室",
    startCreating: "開始製作",
    tryFree: "免費試用",
    floatingCta: "立即開始",
    ...
    toolkitHubSubtitle: "品牌套件、改圖、字幕與 Pro 畫布 — 開箱即用。",
    ...
    brandKitCta: "繼續去工作室",
    toolsTitle: "更多創作工具",
    toolsSubtitle: "品牌套件、圖片編輯、字幕和 Pro 畫布 — 開箱即用。",
    toolsOpenCta: "打開",
    toolBrandTitle: "品牌套件",
    ...
    planFeaturesCustom: ["每月 40,000 點數", "3 席 · 共用池", "團隊資料夾 · Pro 畫布 · 2K"],
    planFeaturesFree: ["引導式圖片與影片流程", "註冊贈 300 點數", "480p 影片 · 1K 圖片"],
    planFeaturesLight: ["每月 3,000 點數", "480p 影片 · 1K 圖片", "郵件支援 · 可加購"],
    planFeaturesStandard: ["每月 8,000 點數", "720p 影片 · 1K 圖片", "Campaign 模式 · 可加購"],
    planFeaturesPro: ["每月 16,000 點數", "1080p 影片 · 1K 圖片", "Campaign · 1080p 模板"],
    planFeaturesMaster: ["每月 28,000 點數", "2K 圖片 · Pro 畫布", "優先支援"],
  ...
  pricing: {
    ...
    comparisonRows: [
      ...
      { feature: "大約產能", free: "試用工作流程", light: "最多 46 張圖或 9 條 8 秒 480p", standard: "最多 123 張圖或 24 條 8 秒 480p", pro: "最多 246 張圖或 48 條 8 秒 480p", master: "最多 430 張圖或 85 條 8 秒 480p", custom: "最多 615 張圖或 121 條 8 秒 480p" },
      ...
      { feature: "平臺研究 / 合併流程 / 故事板", free: "✓", light: "✓", standard: "✓", pro: "✓", master: "✓", custom: "✓" },
      { feature: "A/B 與教學輪播", free: "✓", light: "✓", standard: "✓", pro: "✓", master: "✓", custom: "✓" },
      { feature: "Campaign 模式", free: "—", light: "—", standard: "✓", pro: "✓", master: "✓", custom: "✓" },
      { feature: "郵件支持", free: "—", light: "✓", standard: "✓", pro: "✓", master: "✓", custom: "✓" },
      { feature: "Pro 畫布", free: "—", light: "—", standard: "—", pro: "—", master: "✓", custom: "✓" },
...
socialDripFitTitle: "這個格式可以／不可以做什麼",
  ...
  microWizard: {
    ...
    preGenerateSetup: {
      ...
      copyCollapsedHint: "文案已在第 4 步設定。展開可再編輯。",
