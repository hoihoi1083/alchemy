...
export const zhTw = {
  ...
  landing: {
    ...
    howReadMore: "完整指南 →",
    demoItems: ["產品相輸入", "風格 + Prompt 引導", "故事分鏡場景", "影片輸出"],
    steps: [
      { no: "01", title: "理解產品", body: "用產品資料加可選品牌資訊，先定創作方向。" },
      { no: "02", title: "生成素材", body: "生成生活感廣告圖或故事分鏡場景圖。" },
      { no: "03", title: "輸出最終影片", body: "用引導 prompt + 影片生成最終 Reels。" },
    ],
    quickStart: { quickAd: "快速廣告開始", storyboard: "故事分鏡開始" },
    highlightsTitle: "為什麼呢個流程有效",
    highlights: [
      { title: "新手友好預設", body: "預設設定夠簡單，會避開常見出圖/出片錯誤。" },
      { title: "先圖後片更易改", body: "先生成照片，再做影片，修改成本更低。" },
      { title: "為中小企宣傳而設", body: "模板和 prompt 針對 IG/FB reels。" },
    ],
    sampleTitle: "典型輸出路徑",
    sampleTimeline: [
      "上傳產品相 + 填寫主標題",
    ...
    faqTitle: "常見問題",
    faq: [
      { q: "一條片大概多久？", a: "快速出圖約 10-30 秒；分鏡場景組約 2-5 分鐘；影片通常約 1-3 分鐘。" },
      { q: "重新生成會不會多用點數？", a: "會。每次 AI 重新生成都是新模型調用，會再用點數。" },
      { q: "一定要上傳參考影片？", a: "唔一定。參考 MP4 係選填。" },
      { q: "係咪全部都要先分鏡？", a: "唔係。只要影片可直接出片；先圖後片先走分鏡靜幀。" },
      {
        q: "如何升級計劃？",
        a: "登入後在「定價」頁選擇更高計劃即可。升級會從今天起開啟新的更高計劃帳單期：Stripe 會退回舊計劃未用天數的差額，再從今天起收取新計劃費用（產品標價不變）。你保留剩餘點數，並即時獲得新計劃完整月份額。下次續費日改為升級日起計一個月。例如：8 月 1 日 Standard → 8 月 15 日升 Master → 下次是 9 月 15 日再發放完整 Master 點數。",
      },
      {
        q: "如何降級計劃？",
        a: "在「定價」頁選擇較低計劃。降級會排程到下一個帳單日生效 — 此前仍可使用當前計劃、功能與剩餘點數。較低價格與每月點數從下個週期開始。",
      },
      {
        q: "如何取消訂閱？",
        a: "在定價頁使用「管理帳單」（Stripe）取消續訂或改卡。取消後，當前週期結束前仍可使用付費功能。升級／降級請在定價頁操作，不要在 Portal 改計劃。",
      },
    ],
    builtFor: [
      "市場營銷",
  ...
  pricing: {
    ...
    tokenItems: [
      ...
      {
        title: "對應真實 AI 用量",
        body: "費用反映 系統 圖片/影片和規劃 API — 不是虛擬點數。",
      },
      {
        title: "加購不必升級",
    ...
    faq: [
      ...
      {
        q: "生成失敗會扣點數嗎？",
        body: "不會 — AI 任務失敗會釋放預留點數回餘額。",
      },
      {
        q: "免費計劃可以做商業用途嗎？",
        body: "可以試用完整流程。商業大量使用建議升級付費計劃以獲得更高分辨率和限額。",
      },
      {
        q: "什麼時候可以買額外點數？",
      ...
      },
      {
        q: "如何升級計劃？",
        body:
          "登入後在本定價頁選擇更高計劃（Standard → Pro → Master）並確認即可。升級會從今天起開啟新帳單期：Stripe 退回舊計劃未用天數的差額，再從今天起收取新計劃費用 — 我們不會改 Stripe 產品標價。你保留剩餘點數，並即時獲得新計劃完整每月份額（例如 Standard 3,000 → Master 會再加 16,000）。下次續費日改為升級日起計一個月。升級不必經過「管理帳單」。",
      },
      {
        q: "如何降級計劃？",
        body:
          "在定價頁選擇較低計劃。降級會排程到下一個帳單日生效 — 此前你仍可使用當前計劃、功能與剩餘點數。較低價格與每月點數從下個週期開始。這樣可避免中途用低價享用高計劃權益。「管理帳單」用於取消續訂／改卡，不是選擇較低計劃。",
      },
      {
        q: "在哪裡改計劃或取消訂閱？",
        body:
          "升級或排程降級：登入後在定價頁操作。取消續訂或更新付款方式：使用「管理帳單」（Stripe）。取消後，當前週期結束前仍可使用付費功能。",
      },
    ],
    footnote:
