...
export const zhTw = {
  ...
  landing: {
    ...
    demoModal: {
      title: "四步出圖廣告",
      subtitle: "真實 Studio 操作錄影 — 不用寫 prompt。",
      close: "關閉示範",
      tryCta: "免費試用 — 做第一張廣告",
      hint: "真實錄影 · 已加速 · 點步驟可跳轉",
      steps: [
        { title: "選產品", body: "從首頁開始，選實體產品，然後進入 Studio。" },
    ...
    tokensBody:
      "免費方案是 1 張圖 + 1 條 8 秒 480p 一起用。付費方案顯示點數全用來出 1K 單圖，或者全用來出 8 秒影片的粗略產能。",
    tokensUnit: "點數",
    ...
    tokensCapacityVideosFree: "條 8 秒 480p 影片",
    ...
    tokenCostMusic: "音樂床",
    tokensVideoNote:
      "免費：1 張圖 + 1 條 8 秒 480p 一起計。付費估算用方案最高解析度的 8 秒影片（或約 10 秒兩場分鏡）。更長片、更多場、Logo 會多用點數。",
  ...
  pricing: {
    ...
    capacityFreeVideos: "1 條 8 秒 480p 影片",
    ...
    comparisonRows: [
      ...
      { feature: "大約產能", free: "1 張圖 + 1 條 8 秒 480p", standard: "約 46 張圖或約 5 條 8 秒 720p", pro: "約 123 張圖或約 9 條 8 秒 1080p", master: "約 246 張圖或約 18 條 8 秒 1080p" },
      { feature: "圖片最高分辨率", free: "最高 1K", standard: "最高 1K", pro: "最高 1K", master: "最高 2K" },
      { feature: "影片最高分辨率", free: "最高 480p", standard: "最高 720p", pro: "最高 1080p", master: "最高 1080p" },
