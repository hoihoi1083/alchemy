...
export const zhTw = {
  ...
  landing: {
    ...
    subtitle:
      "上傳產品相或貼參考帖。Alchemy 分析風格、引導設定，再生成可編輯廣告圖同影片，適合 IG、Facebook、TikTok。",
    openStudio: "開啟工作室",
    startCreating: "開始製作",
    tryFree: "免費試用",
    ...
    navCaptions: "字幕",
    navPro: "Pro",
    heroTrust: ["不用空白 prompt", "參考風格不抄內容", "可編輯畫布", "支持 9:16 / 4:5 / 1:1"],
    ...
    tplTitleBefore: "即用模板，覆蓋每個",
    tplTitleHighlight: "平臺",
    tplTitleAfter: "",
    tplSubtitle: "先選渠道和格式，再進 Studio 換成你的品牌。",
    ...
    whyItems: [
      { title: "引導式，唔係空白框", body: "MicroWizard 一次一個決定，不用面對空白 chat。" },
      { title: "參考風格，不抄內容", body: "學排版同色調，保留你的產品同資訊。" },
      { title: "需要先分鏡先分鏡", body: "先圖後片會確認靜幀；只要影片就直接出片。" },
      { title: "輸出可再編輯", body: "生成後改字、Logo、排版，不用整套重跑。" },
      { title: "產品同概念都行", body: "實物產品 同服務／品牌概念各自有路徑。" },
      { title: "點數計費", body: "用多少付多少；計劃包月點數，用完可加購。" },
    ],
    ...
    faq: [
      ...
      {
        q: "計劃如何升級／降級？",
        a: "付費計劃每月會補發點數。升級可在「定價」頁即時生效（補差價並補發差額點數）；降級會排程到下個帳單週期。詳情見定價頁的收費常見問題。",
      },
    ],
    builtFor: [
      "市場營銷",
  ...
  pricing: {
    ...
    subscriptionUpgraded: "已即時升級。新計劃功能和額外 點數 本週期即時生效。",
    ...
    faq: [
      ...
      },
      {
        q: "如何升級計劃？",
        body:
          "在本定價頁選擇更高計劃（Standard → Pro → Master）並確認即可。升級即時生效：Stripe 會按比例補差價，即時開通新計劃功能，並補發本帳單期的點數差額（例如 Pro 8,000 → Master 16,000 會加 8,000 點）。升級不必經過「管理帳單」。",
      },
      {
        q: "如何降級計劃？",
        body:
    ...
    footnote:
      "價格以美元計。影片分辨率和片長會影響點數。通過 Stripe 付款。可在定價頁即時升級；降級從下個週期生效。取消請用「管理帳單」。",
    plans: {
      free: {
        name: "免費",
  ...
  wizard: {
    ...
    storyboardStampLogoHint:
      "最後一幕：居中印上 Brand kit Logo（不經 AI、不收費）。",
    ...
    cinematicLogoModeBNote:
      "勾選「影片靜幀使用品牌 Logo」時，每張影片關鍵幀會印上 Brand kit Logo（角標；最後一幕居中）。",
    ...
    brandKit: {
      ...
      endWithLogoHint:
        "僅用於影片 — 給每張影片關鍵幀/靜幀加 Logo（2 倍出圖 點數；最後一幕居中）。圖片請到「編輯圖片」隨時加 Logo。",
      useLogoLabel: "影片靜幀使用品牌 Logo",
      useLogoHint:
        "僅用於影片 — 給每張影片關鍵幀/靜幀加你的 Logo（2 倍出圖 點數；最後一幕居中）。圖片請到「編輯圖片」隨時、任意位置加 Logo。",
      primaryColor: "主色",
      secondaryColor: "副色",
      accentColor: "強調色",
      tagline: "預設標語",
