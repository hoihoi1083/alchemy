...
export const zhTw = {
  ...
  landing: {
    ...
    toolEditTitle: "圖片編輯",
    toolEditDesc: "為任意靜圖加標題、Logo 和精修效果。",
...
socialDripFitTitle: "這個格式可以／不可以做什麼",
  ...
  editImage2: {
    ...
    changeWordsHint: "輸入新文案，一鍵改字 — 盡量保留這塊字的排版風格。",
    grabClick: "點選提起",
    grabClickOn: "點選提起中",
    ...
    magicChatHint:
      "試試：拆層 · 改成新文案 · 點選提起 · 筆刷擦除 · 擴展 9:16 · 或描述對當前圖層的 AI 改",
    magicChatPlaceholder: "告訴 Magic 要做什麼…",
    magicChatSend: "執行",
    magicChatHelp:
      "拆層 · 改文字 · 點選提起 · 筆刷擦除 · 擴展 1:1 / 9:16 / 16:9 · 或描述對選中圖層的修改",
    ...
    cropEditTitle: "編輯選中",
    cropEditHow: "任意圖層都可改：改字、換國旗、換臉 — 用白話說明，AI 只改這塊。",
    cropEditModeText: "改文字",
    cropEditModeAi: "AI 改這塊",
