...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  editImage2: {
    ...
    changeWordsHint: "输入新文案，一键改字 — 尽量保留这块字的排版风格。",
    grabClick: "点选提起",
    grabClickOn: "点选提起中",
    ...
    expandTitle: "扩展画布",
    expandHow: "把底图扩到社媒尺寸。图层保留，只扩展背景。",
    expandSquare: (n: number) => `1:1 · ${n}`,
    expandStory: (n: number) => `9:16 · ${n}`,
    expandLandscape: (n: number) => `16:9 · ${n}`,
    expandWider: (n: number) => `4:5 · ${n}`,
    expanding: "正在扩展画布…",
    expandDone: "画布已扩展 — 可拖动图层适配新构图。",
    expandFailed: "扩展失败",
    expandNeedHttpBg: "底图需要服务器地址 — 请先拆层，再扩展。",
    expandAlready: "已接近该比例 — 已略微外扩边缘。",
    magicChatTitle: "Magic 指令",
    magicChatHint:
      "试试：拆层 · 改成新文案 · 点选提起 · 笔刷擦除 · 扩展 9:16 · 或描述对当前图层的 AI 改",
    magicChatPlaceholder: "告诉 Magic 要做什么…",
    magicChatSend: "执行",
    magicChatHelp:
      "拆层 · 改文字 · 点选提起 · 笔刷擦除 · 扩展 1:1 / 9:16 / 16:9 · 或描述对选中图层的修改",
    magicChatNeedLayer: "请先选中一个图层。",
    ...
    eraseDone: "已从底图擦除。",
    missTools: "残留处理",
    missToolsHint: "漏拆可用：AI 改选区、擦除、框选提起，或拆选区。",
    lifting: "正在切割并清底…",
    ...
    textEditableNow: "文字已可编辑 — 可改内容、大小或颜色。",
    liveText: "改为可编辑文字",
    ...
    cropEditTitle: "编辑选中",
    cropEditHow: "任意图层都可改：改字、换国旗、换脸 — 用白话说明，AI 只改这块。",
    cropEditModeText: "改文字",
    cropEditModeAi: "AI 改这块",
    editInstructionPlaceholder: "例如：改成「夏季大促」· 英国旗改中国旗 · 把脸换成微笑女生",
    aiEditCrop: (n: number) => `AI 编辑 ${n}`,
    aiEditCropHint: "文字或画面图层都可（国旗、人脸、徽章…）。一次改一块。",
