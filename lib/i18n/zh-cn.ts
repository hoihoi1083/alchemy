...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  captions: {
    ...
    trimIn: "开始（秒）",
    trimOut: "结束（秒）",
    tryCaptions2: "试用 Caption studio 2（语音自动字幕）",
  },
  captions2: {
    badge: "Caption studio 2 · 语音优先",
    title: "Caption studio 2",
    subtitle:
      "新流程：从片内人声自动抽出时间轴字幕，再用 FFmpeg 修剪／BGM／烧录。可与经典版对比。",
    diffTitle: "和经典 Captions 有什么不同",
    diffBody:
      "经典版＝自己写，或用主题 AI 规划字幕 + 完整配音。Studio 2＝听片里的声音（Whisper/OpenAI）填时间轴再烧录。无声 Seedance 片不会自动出字 — 请手写或用经典版用主题规划。",
    openClassic: "打开经典 Caption studio →",
    phaseImport: "1 · 导入",
    phaseCaptions: "2 · 自动字幕",
    phaseFinish: "3 · 完成",
    phaseCaptionsName: "字幕",
    phaseFinishName: "完成",
    phaseHowToCaptions: "点语音自动字幕，再在右侧改时间轴。合适就继续完成。",
    phaseHowToFinish: "可选 BGM，然后烧字幕。完成后下载。",
    dismissTip: "收起",
    showProcessed: "显示已烧字幕",
    tokenCostHint: (n: number) => `约 ${n} tok · 云端语音转文字`,
    emptyLinesHint: "还没有字幕行 — 点语音自动字幕，或添加一行。",
    stickyCaptionsHint: "语音 → 时间轴，再继续烧录。",
    stickyFinishHint: (n: number) =>
      n > 0 ? `已有 ${n} 行可烧录` : "烧录前请先有字幕文字",
    backToCaptions: "返回字幕",
    importHint: "导入方式同经典版 — 接着点「语音自动字幕」。",
    fromLink: "来自链接",
    uploadedVideo: "已上传视频",
    readyAuto: "视频就绪 — 可以点语音自动字幕。",
    autoTitle: "语音自动字幕",
    autoHint: "抽音轨 → 转文字 → 填入时间轴。云端 ASR 会扣少量 plan token。",
    autoCta: "语音自动字幕",
    transcribing: "正在听写字幕…",
    transcribeDone: (n: number) => `已由语音填入 ${n} 行字幕`,
    transcribeFailed: "转写失败。",
    noSpeech: "听不到人声（可能是无声 AI 片）。请手写字幕，或去经典版用主题规划。",
    silentHint: "无声短片？",
    openClassicPlan: "去经典版用主题规划字幕 →",
    evenSplitNote: "时间轴为估算（ASR 无分段）",
    asrCloud: "云端 ASR",
    asrLocal: "本地 Whisper",
    chargedTok: (n: number) => `${n} tok`,
    needVideo: "请先加载视频。",
    continueFinish: "继续完成（BGM + 烧录）",
    finishHint: "可选 BGM，然后烧字幕（FFmpeg，与经典版同一引擎）。",
    classicVoiceNote: "需要 AI 配音／主题规划？请用经典 Caption studio。Studio 2 专注语音→烧录。",
  },
  editImage2: {
    title: "AI 智能图层",
