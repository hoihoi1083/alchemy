...
export const zhCn = {
  ...
  pricing: {
    ...
    comparisonRows: [
      ...
      { feature: "图片最高分辨率", free: "1K", standard: "1K", pro: "2K", master: "4K" },
  ...
  microWizard: {
    ...
    cinematicModeHint: "单场 8 秒快速试片，或多场拼接做 ~30 秒 pre-roll。",
    ...
    blockReasons: {
      ...
      pick_combined_style: "请选择电影感拼接或关键帧动画。",
    ...
    combinedStyleHint: "电影感拼接做多场 pre-roll；或 poster 关键帧再动画。",
