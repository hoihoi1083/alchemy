...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  editImage2: {
    ...
    seedreamFullSplit: (_n?: number) => `一键拆成可编辑图层`,
...
stylePickerModelLabel: "模特佩戴／使用",
  ...
  ultraCanvas2: {
    badge: "Ultra 2 · 测试",
    title: "Ultra 画布 2",
    subtitle: "先选任务再进专业画布；保留 Prompt 与自由连线。",
    backClassic: "经典 Ultra →",
    tryBeta: "Ultra 2（测试）",
    costHint: "与 Ultra 相同：按次扣 Token。",
    howTitle: "你想怎样创作？",
    howSubtitle: "先选起始工作流，之后仍可改每一步。",
    noImageHint: "没有参考图？选「单一视频片段」。",
    laneA: "A · 完整视频广告",
    laneAHint: "适合多场景投放",
    laneB: "B · 快速视频片段",
    laneBHint: "已知画面时快速生成",
