...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  contentResearch: {
    ...
    directPostHint:
      "已有目标帖就不用搜关键词 — 支持 xhslink、小红书 explore、Instagram /p/ 或 /reel/、以及公开 Facebook 帖/视频（最好用 facebook.com/{pageId}/posts/… 或 /videos/…）。实体产品请先填上方产品名称。xhslink 失效时，请在 App 内「分享 → 复制链接」粘贴完整链接。",
