...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  ultraCanvas: {
    ...
    creativeBHint: {
      ...
      steps: [
        "填写角色与产品/UI 上传，然后运行剧本。",
        "生成 image→video 管线 — 会按剧情分派角色并串连续镜头；演示场请核对 @PersonA/@PersonB/@brand。",
        "全部运行 → 拼接 + 音频 → 在字幕工作室添加配音/字幕。",
      ],
      dismiss: "关闭",
    },
    confirmOk: "确认",
    ...
    characterNode: {
      hint: "可 AI 生成人脸参考图，或上传 / 从作品库选择 — 再连到场景图片或 @提及。",
    ...
    videoPromptPlaceholder: "动作 / 场景描述…",
    ...
    templates: {
      ...
      storyDifferenceAd: {
        name: "故事差异广告",
        desc: "Creative B — 痛点 → Alchemy 调研 → 产品 → CTA（预置主角与节拍）",
      },
    },
  },
} as const;
