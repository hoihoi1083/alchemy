...
export const zhCn = {
  ...
  landing: {
    ...
    tokensBody:
      "免费方案是 1 张图 + 1 条 8 秒 480p 一起用。付费方案显示点数全用来出 1K 单图，或者全用来出 8 秒视频的粗略产能。",
    tokensUnit: "点数",
    tokensPlanGrant: "{n} 点数",
    tokensCapacityImages: "张单图",
    tokensCapacityOr: "或",
    tokensCapacityAnd: "加",
    tokensCapacityVideos: "条 8 秒视频",
    tokensCapacityVideosFree: "条 8 秒 480p 视频",
    ...
    tokenCostMusic: "音乐床",
    tokensVideoNote:
      "免费：1 张图 + 1 条 8 秒 480p 一起计。付费估算用计划最高分辨率的 8 秒视频（或约 10 秒两场分镜）。更长片、更多场、Logo 会多用点数。",
    ...
    faq: [
      ...
      {
        q: "可以创作哪些内容？",
        a: "产品广告、促销横幅、上新帖、Instagram／Facebook 素材、小红书帖子、Reels 短视频、服务推广、评价口碑、教学轮播等。",
      },
      {
        q: "可以做短视频吗？",
  ...
  pricing: {
    ...
    capacityVideosFeature: "或约 {n} 条 8 秒视频",
    capacityFreeImages: "1 张宣传图",
    capacityFreeVideos: "1 条 8 秒 480p 视频",
    ...
    faq: [
      ...
      {
        q: "每个计划大概能做多少图或视频？",
        body: "取决于格式和参数。定价卡片会给出大致产能（例如单图 vs 分镜短视频）。清晰度越高、片长越长，单次消耗的点数越多。",
      },
      {
        q: "生成失败会扣点数吗？",
    ...
    comparisonRows: [
      ...
      { feature: "大约产能", free: "1 张图 + 1 条 8 秒 480p", standard: "约 46 张图或约 5 条 8 秒 720p", pro: "约 123 张图或约 9 条 8 秒 1080p", master: "约 246 张图或约 18 条 8 秒 1080p" },
...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  contentResearch: {
    ...
    platformsLabel: "搜索平台",
    platformsHint: "选择一个平台，找 trending 内容作为风格参考。",
    ...
    resultSubtitle: "根据小红书、Instagram、TikTok 热门帖整理。",
  ...
  microWizard: {
    ...
    intakeFuse: {
      stepEyebrow: "第 3 步",
      title: "研究风格，或直接创作。",
      hint: "平台研究借用排版和风格 — 产品名仍然是你的。直接创作会跳过研究，继续设置。",
      conceptTitle: "研究风格，或用概念助手。",
      conceptHint: "平台研究找排版参考。概念助手直接写简报，不必先研究。",
      pathOptionsPhysical:
        "任选一种开始：① 平台研究 · ② 直接创作 · ③ 或在下方粘贴参考帖链接。",
      pathOptionsConcept:
        "任选一种开始：① 平台研究 · ② 概念助手 · ③ 或粘贴参考帖 / 稍后再设。",
      tabsAriaLabel: "怎样开始",
      tabResearch: "平台研究",
      tabDirect: "直接创作",
      tabAssistant: "概念助手",
      pickTabHint: "先选一个分页再继续 — 研究或直接创作。",
      tipTitle: "参考风格，不抄内容。",
      tipIntro: "AI 会分析排版、语气、色调和构图 — 不会抄帖子内容或品牌。",
      tip1: {
        title: "效果更好",
      ...
      tip2: {
        title: "多个平台",
        body: "觉得不对可以换平台试 — 每个 feed 风格不同。",
      },
      tip3: {
        title: "风格大于内容",
        body: "我们借用设计和构图规律 — 文案仍然讲你的产品。",
      },
      tipSecure: {
        title: "你的数据安全",
      ...
      videoDirectBody:
        "下一步会选短视频方向（产品动态、参考视频或 UGC），再在同一个设置页填文案、上传产品照和时长。",
      videoDirectBullets: [
        "不必先做平台搜索",
        "产品动态：照片 → 短视频（最快）",
        "时长和分辨率会显示预计 点数",
    ...
    blockReasons: {
      ...
      pick_intake: "请选择平台研究或直接创作。",
      complete_research: "请先选择一个研究方向（或粘贴参考帖），再点继续 — 或改选直接创作。",
