...
export const zhCn = {
  ...
  wizard: {
    ...
    pathReferenceVideoDesc: "上传参考短片 MP4 — 跟运镜与剪辑概念（不是逐格复制）。",
    ...
    videoReviewHeroHint: "预览、下载、加字幕，或者重新生成。",
  ...
  microWizard: {
    ...
    videoResultHint: "预览、下载，或打开字幕工作室加音乐和文字。",
    ...
    preVideoSetup: {
      titleBefore: "设定你的",
      titleAccent: "影片详情",
      hint: "填写文案、上传产品照、选择时长和分辨率，再生成短片。",
      assistantHint: "上传产品照，等 AI 写运镜 prompt，检查后再生成。",
      assistantTitle: "AI 影片方案",
      assistantBody: "DeepSeek 会看你的产品照，写好 Seedance 运镜 prompt。",
      assistantNeedPlan: "请先分析照片 — 没有方案前不能生成。",
      assistantTip1: {
        title: "先分析再生成",
        body: "点「分析照片并规划视频」，等 AI 写好运镜 prompt。",
      },
      assistantTip2: {
        title: "可改 prompt",
        body: "生成前可以改 AI 写好的运镜文字。",
      },
      conceptHint: "确认主题和文案，照片选填，选择时长，再生成短片。",
      conceptCreativeHint: "写清创作方向，照片选填，选择时长，再生成。",
      conceptBrandHint: "加品牌网站线索，照片选填，选择时长，再生成品牌短片。",
      contentTitle: "内容详情",
      hookLabel: "主标题 (hook)",
      supportingLabel: "辅助文案",
      extraLabel: "额外要求",
      ...
      productPhotoHint: "清晰产品照 — 产品短片必须上传。",
      conceptPhotoTitle: "参考照片",
      conceptPhotoHint: "选填 — 有画面参考时动态会更稳。",
      brandTitle: "品牌网站",
      brandHint: "选填分析 — 帮品牌短片抓语气和视觉。",
      dragDrop: "上传",
      settingsTitle: "影片设定",
      ...
      stylePickerTitle: "影片创作方向",
      stylePickerHint: "选择怎么做短片 — 和图像「创作方向」一样放在设定页。",
      referenceHint: "上传参考 MP4、填写文案，再跟运镜感觉生成。",
      ...
      referenceVideoHint: "跟运镜／剪辑感觉 — 不是逐格复制。",
