...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  contentResearch: {
    ...
    directPostHint:
      "已有目标帖就不用搜关键词 — 支持 xhslink、小红书 explore、Instagram /p/ 或 /reel/。实体产品请先填上方产品名称。xhslink 失效时，请在 App 内「分享 → 复制链接」粘贴完整链接。",
  ...
  studioAssistant: {
    ...
    chipUltraCanvas: "Ultra 画布",
    chipContentResearch: "研究平台内容方向",
    researchNeedsSignIn:
      "平台内容研究需要登录（Standard 或以上）。[登录](/sign-in) — 再点一次「研究平台内容方向」。不登录也可以继续问 Tokens 和路径。",
