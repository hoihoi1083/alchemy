...
export const zhCn = {
  ...
  landing: {
    ...
    brandKitBody: "建议上传透明底 PNG。工作室生成分镜同品牌路径時會用到。",
    brandKitLogoTip: "提示：接近正方形、Logo 佔画面大部分、约 512–1024px。",
    brandKitCta: "继续去工作室",
  ...
  microWizard: {
    ...
    conceptTopicTitle: "研究主题",
    conceptTopicHint: "你推广的服务或概念 — 用作平台研究搜索锚点，不会跑概念助手。",
    conceptTopicLabel: "概念 / 服务主题",
