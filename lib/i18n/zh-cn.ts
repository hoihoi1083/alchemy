...
export const zhCn = {
  ...
  start: {
    ...
    tipTitle: "该选哪个？",
    tipChoose: "选择",
    tipPhysical: "—— 如果你有真实货品可以拍照 / 寄送给顾客。",
    tipConcept: "—— 如果你推广无形服务、网站或概念。",
    tipNote: "之后随时可以更改",
    tipNoteBody: "现在还不确定也可以 — 之后可在 Studio 里再切换。",
    secureNote: "你的数据安全，不会对外分享。",
    roadmapTitle: "如何运作",
    roadmapSubtitle: "五个阶段 — 创作路径会分支（只要图、只要片，或两者）。",
    phases: ["选择推广类型", "选择创作路径", "设定", "生成", "完成"],
    phaseBodies: [
      "选择实体产品或服务 / 概念。",
      "只要相片、只要影片，或先图再片。",
      "填写资料、研究、风格与素材。",
      "跑相片和／或影片 — 只显示你这条路径需要的步骤。",
      "下载适合 IG / FB / TikTok 的广告。",
    ],
    physicalShort: "有真实货品可以拍照 — 护肤套装、家居、服装等。",
    conceptShort: "推广品牌、网站、服务或概念，不需要实体货。",
    examplesLabel: "例如",
    templateBanner: "模板：{name} — 实体产品模式",
    templateBannerHint: "选择下方「实体产品」以用此版型进入向导。",
    templateContinuePhysical: "用此模板继续",
    welcomeTitle: "欢迎加入！",
    welcomeBody: "你已获得 {n} 免费 tokens，可以开始创作。请先选择下方路径。",
  },
  header: {
  ...
  landing: {
    ...
    subtitle:
      "上传产品相或贴参考帖。Alchemy 分析风格、引导設定，再生成可编辑广告圖同影片，適合 IG、Facebook、TikTok。",
    openStudio: "開啟工作室",
    startCreating: "开始製作",
    tryFree: "免费试用",
    ...
    howSteps: [
      ...
      { title: "改文案同规划", body: "确认标题、格式；需要时先看分镜静帧，再花 token。" },
      { title: "生成和编辑", body: "出图或出片後，再在画布改字、加 Logo、导出尺寸。" },
    ],
    refTitle: "参考风格，出你品牌。",
    refBody: "学你喜欢的视觉风格，同时保持你自己的产品、賣点同品牌身份。",
    refCardLabel: "参考风格",
    ...
    tplTitleAfter: "",
    tplSubtitle: "由场景卡开始，跟着 Studio 向导完成。",
    tplTabAll: "全部",
    tplTabProduct: "产品广告",
    tplTabVideo: "Reels / 影片",
    tplTabService: "服务业",
    whyTitle: "点解 Alchemy AI Lab 不同",
    whyItems: [
      ...
      { title: "产品同概念都行", body: "实体 SKU 同服務／品牌概念各自有路径。" },
      { title: "Token 计费", body: "用多少付多少；計劃包月 token，用完可加购。" },
    ],
    scenariosTitle: "覆盖常見营销场景",
    scenariosSubtitle: "选贴近你下一个 campaign 的行业方向。",
    scenarios: [
      { title: "电商零售", body: "一张产品相做出海报、套图同短片。" },
      { title: "美容护肤", body: "適合 IG／TikTok 的干净生活感画面和 Reel。" },
      { title: "餐饮食品", body: "跟热门帖學风格，做出食欲感排版。" },
      { title: "教育教练", body: "概念同教学轮播路径，不一定要有实体貨。" },
      { title: "地产", body: "重点賣点圖同由静帧做成短片。" },
      { title: "金融／SaaS", body: "清晰 offer 海報同品牌片，不乱发明价格。" },
    ],
    pricingSubtitle: "真实计划：Free／Standard／Pro／Master／Custom，全部用 Tokens。",
    pricingFreeCta: "免费开始",
    pricingProCta: "开始 Pro",
    pricingCustom: "联系我们",
    pricingCustomHint: "大量 token 与自定义上限",
    tokensTitle: "AI Tokens 点计",
    tokensBody:
      "粗略每月产能：token 全用来出单图，或者全用来出约 10 秒分镜短片。实际可以混搭。",
    tokensUnit: "tokens",
    tokensPlanGrant: "{n} tokens",
    tokensCapacityImages: "张单图",
    tokensCapacityOr: "或",
    tokensCapacityStoryboards: "条分镜短片（约 {sec} 秒）",
    tokenCostPlan: "AI 规划／brief",
    tokenCostImage: "单张图片",
    tokenCostStoryboard: "分镜套组（约 4 场）",
    tokenCostMusic: "音乐床",
    tokensVideoNote:
      "仅供估算 — 以典型约 10 秒分镜短片计算。更长片、更多场、Logo 和音乐会多用 token。",
    ...
    faqTitle: "常見問題",
    faq: [
      { q: "一条片大概多久？", a: "快速出图约 10-30 秒；分镜场景組约 2-5 分鐘；影片通常约 1-3 分鐘。" },
      { q: "重新生成会不会多用 token？", a: "会。每次 AI 重新生成都是新模型调用，会再用 token。" },
  ...
  pricing: {
    ...
    title: "按创作量选计划",
    subtitle:
      "每个计划都包含 AI 图片和视频 token。用多少付多少 — 订阅后可随时加购 token。",
    pricingLink: "收费方案",
    monthly: "月付",
    yearly: "年付",
    yearlyBadge: "省高达 50%",
    ...
    subscriptionUpgraded: "已即时升级。新计划功能和额外 token 本周期即时生效。",
    subscriptionDowngradeScheduled:
      "已安排于 {date} 降级至 {plan}。在此之前仍保持当前计划和剩余 token；较低价格从下一个账单周期开始。",
    ...
    tokenItems: [
      {
        title: "生成前透明显示",
        body: "在图片和视频步骤会先显示 token 费用，确认后再生成。",
      },
      {
        title: "对应真实 AI 用量",
      ...
      {
        title: "加购不必升级",
        body: "需要推广旺季？$10 买 1,000 额外 token 即可。",
      },
    ],
    faqTitle: "收费常见问题",
    faq: [
      ...
      {
        q: "生成失败会扣 token 吗？",
        body: "不会 — AI 任务失败会释放预留 token 回余额。",
      },
      {
        q: "免费计划可以做商业用途吗？",
      ...
      {
        q: "升级或降级会怎么收费？",
        body: "升级即时生效（按比例补差价，并即时补发较高计划 token）。降级会排程到下一个账单周期生效 — 在此之前保持当前计划，避免中途用较低价格享用较高计划权益。",
      },
    ],
    footnote:
      "价格以美元计。视频分辨率和片长会影响 token。通过 Stripe 付款。可在定价页即时升级；降级从下个周期生效。取消请用「管理账单」。",
    plans: {
      free: {
        name: "免费",
        description: "试用完整引导流程",
        features: [
          "1,000 token（约 1 张图 + 1 条 480p 短片）",
          "引导精灵 + 模板",
          "视频上限 480p",
          "平台研究",
          "图片→视频合并流程",
    ...
    comparisonRows: [
      { feature: "每月 token", free: "1,000", standard: "3,000", pro: "8,000", master: "16,000" },
      ...
      { feature: "加购 token（$10 / 1k）", free: "—", standard: "✓", pro: "✓", master: "✓" },
    ],
  },
  steps: {
    setup: "设定",
  ...
  wizard: {
    ...
    workflowModes: {
      "image-only": {
        ...
        cardDescription: "生成高质量宣传图，适合社交帖、广告与横幅。",
        tags: ["社交帖", "产品照"],
      },
      "video-only": {
        title: "只要影片",
        description: "短片广告 — 分镜（可预览）或单图动态",
        cardDescription: "用 AI 场景与片段，直接产出可发布短片。",
        tags: ["短片", "视频广告"],
      },
      combined: {
        title: "先要相片，再要影片",
        description: "先出宣传图再做片 — 分镜片或单图动态",
        cardDescription: "先出图、检查与微调，再做成吸引人的短片。",
        tags: ["广告企划", "产品故事"],
      },
    },
    creationPath: {
      stepEyebrow: "第 2 步",
      title: "选择你的创作路径。",
      hint: "选择只要图片、只要视频，或先出图再做片。",
      chooseLabel: "选择此路径",
      bestForLabel: "适合：",
      tipTitle: "该选哪条？",
      tipImage: "适合需要 feed 图、轮播或静态广告。",
      tipVideo: "适合已有静态图，或以短片为主的流程。",
      tipCombined: "适合想先确认画面，再加动态。",
      tipNote: "之后随时可以更改",
      tipNoteBody: "现在还不确定也可以 — 之后可在进阶工作室再切换。",
      backToStep1: "返回第 1 步",
      continueToSetup: "继续",
      nextTitle: "接下来会怎样",
      nextSubtitleUnset: "上面选路径后，Studio 只会显示那条路需要的步骤。",
      nextSubtitleImage: "你的路径：设定 → 相片 → 完成（没有影片步骤）。",
      nextSubtitleVideo: "你的路径：设定 → 影片 → 完成（一般没有相片步骤）。",
      nextSubtitleCombined: "你的路径：设定 → 相片 → 影片 → 完成。",
      nextStepsUnset: [
        { title: "设定", body: "填写资料、研究、风格与素材。", icon: "setup" },
        { title: "生成", body: "相片、影片，或两者 — 只跑你这条路需要的。", icon: "generate" },
        { title: "完成", body: "下载并重用你的广告。", icon: "done" },
      ],
      nextStepsImage: [
        { title: "设定", body: "填写资料、研究、风格与素材。", icon: "setup" },
        { title: "相片", body: "生成并检视静态图。", icon: "image" },
        { title: "完成", body: "下载并重用你的广告。", icon: "done" },
      ],
      nextStepsVideo: [
        { title: "设定", body: "填写资料、研究、风格与素材。", icon: "setup" },
        { title: "影片", body: "生成你的短片。", icon: "video" },
        { title: "完成", body: "下载并重用你的广告。", icon: "done" },
      ],
      nextStepsCombined: [
        { title: "设定", body: "填写资料、研究、风格与素材。", icon: "setup" },
        { title: "相片", body: "先生成并检视静态图。", icon: "image" },
        { title: "影片", body: "将确认过的画面做成短片。", icon: "video" },
        { title: "完成", body: "下载并重用你的广告。", icon: "done" },
      ],
    },
    ...
    videoOutputTypes: {
      "storyboard-reel": {
        ...
        pipelineVideoOnly:
          "设定 → 场景图（如需要）→ 拼接成一条片 — 以视频为主，不是先做广告图再出片",
    ...
    creativeVideoIntro:
      "用文字描述你想拍的短片（例如：功夫对打后饮能量饮品）。AI 会写动态 prompt（镜头怎么动 — 不是口播）。产品照或关键图选填。",
    ...
    videoPathsHint: "选择怎么做 Reel — 产品照写动态 prompt，或跟参考短片。",
    videoAssistantStepHint:
      "已选 AI 影片助手 — 按「继续」到步骤 3 上传产品、包装和角度照片，AI 会分析并写动态 prompt。",
    ...
    pathReferenceVideoDesc:
      "上传参考短片 MP4 — 会分析运镜／剪辑感觉（不是逐格复制）。你的产品照仍然是 @Image1。",
    ...
    conceptVideoPromptSectionHint:
      "不必关键图 — 影片生成 会从文字出片。请先在上面点「AI 写动态 Prompt」。",
    ...
    imageReviewEditCanvasBtn: "加 Logo／编辑",
    ...
    productVideoUploadFirstHint: "请先上传主产品相片，再点「分析照片并写动态 Prompt」。",
  ...
  microWizard: {
    ...
    intakeFuse: {
      stepEyebrow: "第 3 步",
      title: "研究风格，或直接创作。",
      hint: "平台研究借用排版和风格 — 产品名仍然是你的。直接创作会跳过研究，继续设定。",
      ...
      tipTitle: "参考风格，不抄内容。",
      tipIntro: "AI 会分析排版、语气、色调和构图 — 不会抄帖文内容或品牌。",
      tip1: {
        title: "效果更好",
      ...
      videoDirectBody:
        "下一步会选短片方向（产品动态、参考片或 UGC），再在同一个设置页填文案、上传产品照和时长。",
      videoDirectBullets: [
        "不必先做平台搜索",
        "产品动态：照片 → 短片（最快）",
        "时长和分辨率会显示预计 token",
    ...
    preVideoSetup: {
      ...
      productPhotoHint: "清晰产品照 — 必须。会做短片里的主体。",
      productPhotoWithRefHint:
        "必须 — 你的产品做 @Image1。参考 MP4 只提供运镜／剪辑感觉。",
      conceptPhotoTitle: "参考照片（选填）",
      conceptPhotoHint: "选填 — 帮画面落地；概念短片也可以只靠简报 + 动态 prompt。",
      brandTitle: "品牌网站",
      ...
      stylePickerTitle: "怎么做这条短片",
      stylePickerHint:
        "AI 按产品照写动态 prompt，或者跟参考／研究短片的运镜方案。",
      referenceHint:
        "上传参考 MP4（会分析运镜）。产品短片还要上传产品照做 @Image1，再生成。",
      ugcHint: "UGC 要先出对嘴关键帧 — 继续去设定 presenter 短片。",
      ugcContinueLabel: "继续去关键帧",
      ugcNextNote: "下一步会生成对嘴关键帧、检查画面，再出 UGC 短片。",
      ugcPhotoHint: "清晰产品照，方便 presenter 展示。",
      referenceVideoTitle: "参考短片（MP4）",
      referenceVideoHint:
      ...
      ugcTip2: {
        title: "讲稿下一步再填",
        body: "关键帧之后再设定 presenter pack 和对嘴讲稿。",
      },
      secureNote: "你的选择安全保存，不会对外分享。",
    },
    conceptNameStep: {
