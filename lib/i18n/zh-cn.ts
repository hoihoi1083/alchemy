...
export const zhCn = {
  ...
  inputLanguage: {
    ...
    unsupportedBody: (script: string) =>
      `检测到${script}。请改用英文或中文（简体／繁体）再继续，研究和广告效果会更稳定。`,
    scriptJapanese: "日文",
    scriptKorean: "韩文",
    scriptOther: "暂未支持的语言",
    continueAnyway: "仍然继续",
    voiceNeedScript: "请先输入旁白稿再试听。",
    voiceNeedEnglish:
      "该音色为英文。请用英文写旁白（纯中文稿与此音色不匹配）。",
    voiceNeedChinese:
      "该音色为中文。请用中文写旁白，或切换到英文音色。",
    generateBlocked: "请先修正标示字段的语言，再继续。",
  },
  auth: {
    signIn: "登录",
    signInTab: "登录",
  ...
  account: {
    ...
    consumeKinds: {
      ...
      research_reel_with_plan: "研究短片分析 + 分镜规划",
      refine_research_video_script: "研究视频文案优化",
      storyboard: "分镜图生成",
      storyboard_scenes: "分镜图生成（{count} 个场景）",
      image: "图片生成",
      image_ab: "A/B 图片生成（2 个版本）",
      image_refine: "图片微调",
      campaign: "Campaign 套图（3 张）",
      ...
      smart_layers_detect: "智能图层 — 检测",
      smart_layers_sam: "智能图层 — SAM 切边",
      smart_layers_matte: "智能图层 — 抠图",
      smart_layers_heal: "智能图层 — 修复",
      smart_layers_qwen: "智能图层 — 拆层",
      smart_layers_seedream: "智能图层 — 拆成可编辑图层",
      smart_layers_expand: "智能图层 — AI 外扩补边",
    },
    team: {
      title: "企业席位",
  ...
  library: {
    ...
    noMedia: "尚未保存媒体",
    linkExpiredHint:
      "旧项目可能仍使用已过期的临时链接 — 请打开「已保存文件」分页，或重新生成。新输出会永久保存。",
    updatedLabel: "更新于",
    imageBadge: "图片",
    videoBadge: "视频",
    accountLink: "账户与账单",
    ...
    projectsTitle: "项目",
    projectsSubtitle:
      "可在工作室重新打开的向导进度 — 名称取自产品、概念或标题。点卡片即可继续。",
    highlightNewVersion: "新版本",
    resumeChipExport: "打开于导出",
    resumeChipScenes: "打开于分镜",
    resumeChipImage: "打开于图片",
    resumeChipSetup: "打开于设置",
    audioBadge: "音频",
    voiceoverBadge: "配音",
    download: "下载",
    editCaptions: "加字幕／配音",
  ...
  footer: {
    tagline: "任何想法，几分钟变成吸睛内容 — 图片、视频和 Reels 一次完成。",
    productTitle: "产品",
    legalTitle: "法律信息",
    studio: "开始制作",
    pricing: "方案与点数",
  ...
  studio: {
    ...
    loadingHint: "正在还原项目，并打开最合适的步骤。",
    hydrateErrorTitle: "无法还原此项目",
    hydrateErrorBody: "加载失败，没有覆盖你的存档。可以重试或返回作品库。",
    hydrateErrorTimeout: "还原超时。请检查网络后再试。",
    hydrateErrorLibrary: "返回作品库",
    resumeBannerTitle: "正在浏览已保存项目",
    resumeBannerLibrary: "作品库",
    regenForksHint:
      "编辑会保存到当前项目。重新生成会消耗代币并另存为新卡片 — 旧卡片的成片仍在原处。",
    forkCreatedTitle: "已创建新版本",
    forkCreatedBody: "你现在在新项目卡片上编辑。作品库中的旧卡片未改动。",
    forkCreatedDismiss: "知道了",
    forkCreatedLibraryLink: "在作品库查看",
    phaseStepper: {
      ariaLabel: "项目步骤",
      setup: "设置",
      image: "图片",
      video: "视频",
      export: "导出",
      hint: "点已完成步骤可查看输入与结果。重新生成会另存新项目。",
    },
  ...
  start: {
    ...
    physicalExamples: "例如：护肤、食品饮料、珠宝、服装、家具",
    physicalTags: ["护肤", "食品饮料", "珠宝", "服装", "家具"],
  ...
  landing: {
    ...
    titleBefore: "做营销内容，",
    titleHighlight: "不用",
    titleAfter: "自己写 prompt。",
    title: "做营销内容，不用自己写 prompt。",
    subtitle:
      "上传产品照或粘贴参考帖。Alchemy 分析风格、引导设定，再生成可编辑广告图和视频，5 分钟搞定。",
    openStudio: "开启工作室",
    startCreating: "开始制作",
    tryFree: "免费试用",
    floatingCta: "立即开始",
    ctaPrimary: "免费试用 — 做你第一条广告",
    ctaSecondary: "查看使用方法",
    howItWorks: "想法如何变成现实",
    navHome: "首页",
    navProduct: "产品",
    ...
    transformTitleHighlight: "工作室级杰作。",
    transformTitleAfter: "",
    transformBody:
      "上传你的产品照。Alchemy 分析颜色、排版和语气，再帮你重塑成可编辑、可导出到各平台的生活方式广告。",
    transformPoints: [
      {
        title: "保留你真正的产品",
        body: "只改场景和光感 — 瓶身、标签与品牌细节保持真实。",
      },
      {
        title: "对齐你想要的风格",
        body: "AI 梳理颜色、排版与语气，让输出更有方向，不是乱撞。",
      },
      {
        title: "几分钟就能出广告",
        body: "做出适合 Instagram、Facebook、TikTok、小红书的吸睛静帧。",
      },
    ],
    transformCta: "帮我变产品图",
    transformHint: "不用空白 prompt，从你的产品照开始。",
    howTitleBefore: "想法如何变成",
    howTitleHighlight: "现实",
    howSubtitle: "由参考到成品，四个引导步骤。",
    howSteps: [
      { title: "上传或贴参考", body: "加产品照片，或带入你喜欢的帖／Reel 做风格参考。" },
      {
        title: "AI 分析你的风格",
        body: "AI 分析色板、排版、构图、语气与文案风格。",
      },
      {
        title: "改 Prompt 与分镜",
        body: "生成完整视频前，先审阅并编辑 AI 生成的 prompt 与分镜。",
      },
      {
        title: "自由生成与编辑",
        body: "一键生成图片与视频，再用画布工具微调。",
      },
    ],
    demoModal: {
      close: "关闭示范",
      ...
      demos: {
        ...
        video: {
          title: "四步产品短片",
          subtitle: "真实 Studio 操作 — AI 研究、产品图，再到无声成片。",
          hint: "真实录影 · 片尾有成片 · 点步骤可跳转",
          steps: [
            { title: "选产品", body: "选实体产品、填产品名，然后进入 Studio。" },
            { title: "AI 研究", body: "在 Instagram 搜热门 Reel 做节奏灵感，再选一个 style。" },
            { title: "产品图 + 参考片", body: "上传产品图，保留参考 Reel 做镜头／剪辑感觉。" },
            { title: "生成短片", body: "确认并生成。看无声成片，再下载或去字幕工作室。" },
          ],
        },
      },
    },
    ...
    refTitle: "参考不同风格，同时聚焦品牌与内容。",
    refBody:
      "选择你喜欢的帖或一条 Reel。Alchemy 会识别排版、色板、光线和语气，建议再套到你的产品或概念 — 学风格不抄内容，成品仍然是你的品牌+内容。",
    refCardLabel: "参考风格",
    refFeatureItems: [
      {
        title: "识别风格 DNA",
        body: "抽取参考的氛围与风格 — 不抄参考的文案或产品。",
      },
      {
        title: "保留你真正的产品",
        body: "品牌细节保持真实，只改场景和氛围。",
      },
      {
        title: "套用，不是抄袭",
        body: "对齐你的偏好，同时带上产品卖点和你想推广的信息。",
      },
      {
        title: "多平台输出",
        body: "做出适合 Instagram、TikTok、Facebook 等的图或片。",
      },
    ],
    ...
    storyboardTitle: "故事版模式 — 先规划场景，再合成影片",
    storyboardBody:
      "三格静帧合成一条故事片 — 先计划每个镜头，再生成语气和画面一致的影片。",
    storyboardFeatureItems: [
      {
        title: "先计划每个场景",
        body: "先选好镜头和时间，再花点数生成影片。",
      },
      {
        title: "故事和语气一致",
    ...
    tplTabService: "服务业",
    whyTitle: "Alchemy AI Lab 有什么不同",
    whyItems: [
      {
        title: "免写 Prompt",
        body: "一步步省心引导。只需点击几下就能交付内容。",
      },
      {
        title: "智能市场研究",
        body: "用最新风格的热门参考，不用再乱猜。",
      },
      {
        title: "先分镜再出片",
        body: "一切由你掌控。先选好场景再全片渲染 — 不白费点数。",
      },
      {
        title: "输出可再编辑",
        body: "生成后连小细节都能改。即时修正，不用整套重跑。",
      },
      {
        title: "产品与概念都行",
        body: "实体产品、服务、概念，甚至抽象想法都一样好用。",
      },
      {
        title: "订阅 + 点数",
        body: "订阅方案与额外点数的混合模式。需要时再升级或充值。注册即享免费方案！",
      },
    ],
    scenariosTitle: "覆盖常见营销场景",
    scenariosSubtitle: "选贴近你下一个营销活动的行业方向。",
    scenarios: [
      { title: "电商零售", body: "一张产品照做出海报、套图和短视频。" },
      { title: "美容护肤", body: "适合 IG／TikTok 的干净生活感画面和 Reel。" },
      { title: "餐饮食品", body: "跟热门帖学风格，做出食欲感排版。" },
      { title: "教育教练", body: "概念和教学轮播路径，不一定要有实体货。" },
      { title: "地产", body: "重点卖点图和由静帧做成短视频。" },
      { title: "金融／SaaS", body: "清晰 offer 海报和品牌片，不乱发明价格。" },
    ],
    ...
    toolLibraryTitle: "我的作品库",
    toolLibraryDesc: "已保存文件、项目与团队文件夹 — 继续编辑或下载。",
    toolEditTitle: "AI 智能图层与修图",
    toolEditDesc: "智能图层 + 图片编辑 — 移动文字／物件、改文案、笔刷抠图、导出。",
    toolSmartLayersTitle: "AI 智能图层与修图",
    toolSmartLayersDesc: "智能图层 + 图片编辑 — 检测拆层、拖动改文、笔刷抠图 — 所有方案可用。",
    toolCaptionsTitle: "字幕与成片",
    toolCaptionsDesc: "AI 改画面、裁切拼接、字幕、BGM 烧录 — 完整成片工作室。",
    ...
    recipes: {
      ...
      title: "可完成的视频配方",
      subtitle:
        "产品和概念同一套两条路。动态海报＝2 张静图 + 短片。免费额度最多约 1 张图 + 约 5 秒 480p（或约 4 张静图）。12 秒 TVC 需要付费方案。",
      cta: "用这个配方",
      physicalGroup: "产品",
      conceptGroup: "概念／服务",
      tvcPaidHint:
        "4 格静图 + 12 秒片需要付费方案（约 752 token）。免费额度（300）最多约 1 张图 + 约 5 秒 480p，或约 4 张静图 — 不够完整 2 图 + 短片。",
      needPrefix: "需要",
      ...
      items: {
        "motion-poster": {
          ...
          costHint:
            "约 2 张静图 + 短片 · 免费最多约 1 张图 + 约 5 秒 480p（或约 4 张静图）",
        },
        ...
        "product-tvc-12s": {
          ...
          costHint: "约 4 张静帧 + 12 秒高级影片 — 要付费 · 拼接后备 拼接或够免费额",
        },
        ...
        "concept-motion-poster": {
          ...
          costHint:
            "约 2 张 AI 静图 + 短片 · 免费最多约 1 张图 + 约 5 秒 480p（或约 4 张静图）",
        },
        ...
        "concept-blockbuster-9s": {
          ...
          costHint: "约 9 秒单镜 · Logo／吉祥物 + 品牌卡片 + 可选场景首帧",
				...
				"product-type-behind-cutout-8s": {
					title: "字夹产品 ~8s",
					description:
						"产品抠图 · 巨型大字在身后 · 电影感底板 · 冲击收尾。城市奔跑／极简奔跑／冲击收尾。",
					costHint: "~2 张静图 + 8–10秒 · 产品图 + 标题",
				},
				...
				"product-magazine-cover-morph-8s": {
					title: "杂志封面变装 ~8s",
					description:
						"时尚杂志封面 · 刊头在脑后 · 变装过渡。红刊头／粉梦／暗丝绒。",
					costHint: "~2 张静图 + 6–8秒 · 人像+产品图 + 标题",
				},
				...
				"product-ecom-orbit-6s": {
					title: "电商环绕 ~6s",
					description:
						"一张产品图 → 环绕/仰拍/旋转。身份锁定的转台广告。",
					costHint: "~6s 单镜 · 产品图",
				},
				"product-object-lock-6s": {
					title: "物体锁定运镜 ~6s",
					description:
						"镜头粘在商品上，世界在动，产品不动。SnorriCam 感。",
					costHint: "~6s 单镜 · 产品图",
				},
				...
				"concept-type-behind-cutout-8s": {
					title: "字夹人像（概念）~8s",
					description:
						"人像／品牌形象／吉祥物抠图 · 巨型大字在身后 · 城市奔跑／极简／冲击收尾。",
					costHint: "~2 张静图 + 8–10秒 · 人像／品牌静图 + 标题",
				},
				...
				"concept-magazine-cover-morph-8s": {
					title: "杂志封面变装（概念）~8s",
					description:
						"同一张脸的杂志封面 · 变装过渡。红刊头／粉梦／暗丝绒。",
					costHint: "~2 张静图 + 6–8秒 · 人像静图 + 标题",
				},
    ...
    planBlurbMaster: "高产量创意与商业用途的重度用户",

    planBlurbPro: "专业用户与创意天才",

    planBlurbStandard: "成长中的品牌与自由职业者",

    planFeaturesCustom: ["每月 40,000 点数", "3 席 · 共用池", "含 Master 全部 · 团队文件夹"],

    planFeaturesFree: ["引导式图片与视频路径", "注册送 300 点数", "480p 视频 · 1K 图片"],

    planFeaturesLight: ["每月 3,000 点数", "480p 视频 · 1K 图片", "邮件支持 · 可加购"],

    planFeaturesMaster: ["每月 28,000 点数", "2K 图片 · Ultra 画布", "含 Pro 全部 · 优先支持"],

    planFeaturesPro: ["每月 16,000 点数", "1080p 视频 · 1K 图片", "故事板 · 平台研究 · 轮播"],

    planFeaturesStandard: ["每月 8,000 点数", "720p 视频 · 1K 图片", "平台研究 · 轮播 · 可加购"],
    ...
    tplAdBranding: "学风格不抄内容 — 保留你的品牌 DNA",
    tplAdAmber: "阳光下的药珀 — 每颗都不同",
    tplAdCafe: "小店广告，把路过的人变成进店客",
  ...
  pricing: {
    ...
    checkoutSuccessGranted: "（+{granted} · 余额 {balance}）",
    checkoutSuccessBalance: "（余额 {balance}）",
    compareScrollHint: "← 左右滑动 →",
    ...
    comparisonRows: [
      ...
      { feature: "大约产能", free: "试用图片与视频路径", light: "最多 46 张图或 9 条 8 秒 480p", standard: "最多 123 张图或 24 条 8 秒 480p", pro: "最多 246 张图或 48 条 8 秒 480p", master: "最多 430 张图或 85 条 8 秒 480p", custom: "最多 615 张图或 121 条 8 秒 480p" },
  ...
  wizard: {
    ...
    workflowModes: {
      "image-only": {
        ...
        cardDescription: "生成高质量宣传图片。",
        tags: ["社交媒体帖子", "商品图", "静态广告"],
      },
      "video-only": {
        title: "只生成单场景视频",
        description: "单场景连续镜头 — 可直接发布的短视频",
        cardDescription: "Alchemy 会根据你的产品图和偏好风格设计一段短片。",
        tags: ["单场景", "短片", "视频广告"],
        sceneBadge: "仅单场景",
      },
      combined: {
        ...
        cardDescription:
          "Alchemy 会为你的产品生成多段短片，再合并成一条多场景视频。",
        tags: ["多场景", "分镜", "动态广告"],
        sceneBadge: "多场景分镜",
      },
    },
    ...
    imageOutputLabel: "你的图片输出",
    imageOutput: {
      title: "宣传静图",
      pipeline: "上传产品／参考 → AI 规划风格与文案 → 生成可下载图片",
      confidence: "适合信息流帖子、轮播、产品图和静态广告 — 无视频步骤",
    },
    ...
    visualStyleHint: "选风格会自动套用光线同氛围 — 适用任何产品类别",
    visualStyleHintVideoOnly:
      "只做视频：隐藏资讯海报、品牌出图、Campaign 套图（专为有照片无设计图的流程）",
    ...
    visualStyles: {
      ...
      "jelly-3d": {
        ...
        description:
          "极简透亮 3D 数字或造型、干净地面、少量品牌字 — 锁定单张静图",
			...
			"type-force": {
				title: "字体受力",
				description: "场景中大字受声波/折射/张力/冲击影响",
			},
			"spatial-layout": {
				title: "空间排版",
				description:
			...
			"screen-break": {
				title: "破屏出界",
				description:
					"从档案页撕开或巨型手机冲出 — 产品＝SKU 英雄；概念＝人物／品牌英雄",
			},
			"material-letters": {
				title: "材质大字",
				description: "羽绒/牛仔/帐篷尼龙/皮革立体大字",
			},
			"type-interaction": {
				title: "字体互动",
				description: "折叠/揭膜/运动切片/镜面 TRACE",
			},
			"product-lifestyle": {
				title: "生活方式产品",
				description: "产品极前景 + 人物 + 彩虹光 + 数字卖点",
			},
      "brand-fit": {
        title: "品牌风格分析",
      ...
      "brand-campaign": {
        ...
        description: "分析品牌 → 自动出 3 张串联 post（主打 / 卖点 / 优惠）",
      },
      "brand-video": {
        title: "品牌动态短视频",
    ...
    visualStyleHints: {
      ...
      "dark-premium": "深色奢华氛围、金色光点 — 不限水晶，珠宝/手表/护肤/礼品都可以",
      "warm-shop": "温暖亲切小店感，突出店铺名同优惠",
      "model-wear":
        "上传产品相 → AI 生成模特儿佩戴／使用的生活感广告（按产品类型自动调整，不是固定手链模板）",
      "info-poster": "",
      "designed-poster": "",
      "parts-poster": "",
      "gaming-cover": "",
      ...
      "storyboard-video":
        "似真商业片：AI 按你的产品类型规划场景（手链、洗鼻器、护肤等），不会固定手链模板",
      "ugc-presenter":
    ...
    modelWearIntro:
      "上传产品相，AI 会生成似真模特儿佩戴或使用产品的 9:16 广告图。手链／手串会上手；洗鼻器等会示范用法。进阶可选「主体取景」控制露脸或只手。",
    creativeVideoIntro:
    ...
    brandCampaignIntro:
      "分析完品牌后，会用 AI 规划 3 张串联 post，再逐张生成 — 同一品牌 DNA，不同 message。",
    ...
    infoPosterTechniqueIntro: "不要把所有字挤一张图。按这个流程，AI 会做精品白底资讯图：",
    ...
    requirementsPlaceholder: "例如：柔和日光、不要出人、街头穿搭感…",
    requirementsPlaceholders: {
      ...
      "jelly-3d": "例如：透亮果冻「1」、干净地面、少量品牌字、无杂乱场景…",
      			"type-force":
				"例如：耳机声波推开 LOUD、球拍冲击 SERVE…",
			"spatial-layout":
				"例如 BETWEEN PLANES 倾斜板、VOID 橙色镂空…",
			"photo-doodle":
				"例如：十字路口咖啡公仔、时代广场卡带插画…",
			"light-trail":
				"例如：群像猩红青蓝光轨、眼神横切光束、暗调英雄交叉光…",
			"screen-break":
				"例如：球鞋踏出金色手机、手从档案页撕洞伸出…",
			"material-letters":
				"例如：羽绒 WARM 坐压、牛仔 BREAK 撕破、皮革 FOLD 掀角…",
			"type-interaction":
				"例如：折叠屏 FOLD、面膜 REVEAL 揭膜、跑鞋 MOVE 切片…",
			"product-lifestyle":
				"例如：耳机极前景、彩虹折射、30小时续航与1年保修…",
"brand-fit": "分析后会自动填；你可再微调产品或场景",
    ...
    imageOutputModeHint: "Campaign 会出 3 张概念串联的图（约 3× API 成本 + AI 规划）",
    ...
    imageOutputModes: {
      ...
      ab: {
        title: "A / B 两版本",
        description: "同一设置出两张，选较满意那张",
      },
      campaign: {
        title: "Campaign 套图",
        description: "3 张串联 post — 主打、卖点、优惠",
      },
      carousel: {
        title: "轮播",
        description: "3–7 张串联图 — 产品推广或教学 Tips",
      },
      "teaching-carousel": {
        title: "教学轮播",
    ...
    carouselSettings: {
      intentLabel: "轮播类型",
      intentHint: "产品推广 = 3 张销售系列。教学 Tips = 封面、重点、总结。",
      intentTeaching: {
        title: "教学 Tips",
        description: "封面 → 教学重点 → 总结（保留现有教学设定）",
      },
      intentPromo: {
        title: "产品推广",
        description: "主打 → 卖点 → 优惠/CTA（固定 3 张）",
      },
      slideCountLabel: "几张？",
      slideCountOption: "{count} 张",
      slideCountHint: "建议 5 张（封面 → 3 个重点 → 总结）。3–7 张可更短或更深。",
      promoSlideCountNote: "产品推广固定为 3 张销售系列。",
    },
    ...
    storyboardIntro:
      "AI 会按产品类型规划分镜（几个场景、每张图拍什么），再自动写 视频生成 @Image 分镜 prompt — 不是固定手链模板。",
    ...
    researchStoryboardMode: {
      title: "参考帖分镜模式",
      body: "节奏与构图沿用你选的参考内容；此路径不另选分镜配方。可在下方编辑大纲或简述。",
    },
    researchStoryboardPlanReady: "参考分析完成 — 分镜大纲已就绪。",
    ...
    storyboardDurationHint: "会影响分镜场景数量。改了片长请重新生成场景图。",
    ...
    storyboardAllScenesImageHint: "全部场景会用于视频 — 不用在下面选「版本」。",
    ...
    storyboardEditorHint: "迷你编辑器：可调场景顺序、逐张替换，再在 app 内重生视频。",
    ...
    imagePreflightCampaign: "Campaign：3 张串联图 + 规划。",
    ...
    teachingCarouselSlideCountHint:
      "5 slides works well (cover → 3 tips → recap). Choose 3–7 for shorter or deeper tutorials.",
    ...
    pickCampaignSlideLabel: "选一张继续（或全部下载）",
    pickTeachingCarouselSlideLabel: "教学轮播 — 选一张预览（全部可下载）",
    ...
    imageCreativeLabel: "怎样做宣传图？",
    imageCreativeModes: {
      "promo-ai": {
        title: "AI 宣传图",
        description:
          "产品相 + 你填的资料 → 风格跟产品和文案自动推断（不是固定模板）",
      },
      "reference-concept": {
        title: "跟参考图概念",
        description:
          "保留参考广告排版和设计元素；场地、光线配合你产品／店铺；文案用你填的标题",
      },
    },
    imageRefConceptLabel: "参考广告图（设计参考）",
    imageRefConceptHint:
      "上传你喜欢的广告设计作参考 — AI 会保留排版、装饰元素、产品摆位姿势；场地和光线会配合你的产品／店铺；主标副标用你自己填的字。",
    imageRefConceptActiveHint:
      "保留参考图设计语言（排版、组件、上手/flat lay 姿势）+ 你的产品相真货 + 你的文案。场地、背景、光线会根据产品和店铺调整，不会照抄参考图原文字。",
    referenceConceptOverridesStyle:
      "参考图模式：设计跟参考广告；场地、光线、背景配合产品和画面风格（例如暗黑精品只影响光线氛围）。进阶可选「只出手」若参考图是上手佩戴。",
    ...
    imageRefAutoModeNote:
      "已侦测参考广告图 — 这次会用「跟参考图概念」生成（不是只是美化产品相）。",
    uploadPreviewLabel: "你上传的原图（未生成）",
    aiImageResultLabel: "AI 生成结果",
    originalImageLabel: "使用原图（未经 AI）",
    videoCreativeLabel: "怎样做视频？",
    ...
    videoCreativeModes: {
        ...
        description:
          "3 张图 → 9 秒单镜：纸箱飞出，产品（或 Logo／吉祥物）揭晓。不是分镜。",
			...
			"magazine-cover-morph": {
				title: "杂志封面变装",
				description:
					"杂志封面 · 刊头在脑后 · 变装过渡。红刊头／粉梦／暗丝绒。约 6–8 秒。",
			},
			"product-explode": {
				title: "产品拆解（风格化）",
				description:
      ...
      "reference-concept": {
        title: "跟参考视频概念",
        description: "产品 + 参考 MP4 → 跟运镜和剪辑概念（不是逐格复制）",
      },
      "image-to-video": {
        title: "图片变视频",
        description: "用步骤 2 的 AI 图 — 最适合「先要图后要片」",
      },
    },
    motionPosterHint:
    ...
    impactPosterToneTitle: "调性（色彩世界）",
    impactPosterToneHint:
      "整片色调会锁死：火辣＝橙红热感；高端＝金黑奢感；赛博＝紫青霓虹。选不同调性，成品色调必须明显不同。",
    impactPosterToneAuto: "自动 · 最合适",
    impactPosterTones: {
      fiery: { title: "火辣", desc: "橙红火焰 · 零食／辣味" },
      rugged: { title: "粗犷", desc: "橄榄褐尘土 · 户外／越野" },
      premium: { title: "高端", desc: "金黑奢华 · 耳机／奢品" },
      cyber: { title: "赛博", desc: "紫青霓虹 · 科技／电竞" },
    },
    impactPosterEffectTitle: "冲击特效（爆炸方式）",
    impactPosterEffectHint:
      "与调性分开：特效只改「怎么炸」——碎玻璃、神光、碎屑、闪电。同一产品选不同特效，动态形状应明显不同。",
    impactPosterEffectAuto: "自动 · 匹配调性",
    impactPosterEffects: {
      "shatter-burst": { title: "碎裂爆发", desc: "玻璃碎片径向炸开" },
      "energy-rays": { title: "能量射线", desc: "背后长神光／声波" },
      "debris-splash": { title: "碎屑飞溅", desc: "土屑／零件冲向镜头" },
      "lightning-pulse": { title: "闪电脉冲", desc: "电弧叉状爆闪" },
    },
    ...
    blockbusterAnimating: "正在生成 9 秒单镜…",
		...
		recipePathUx: {
			...
			"spatial-layout": {
				...
				attention: [
					"字即建筑 — 贴平面、镂空、挤出或包转角，不是平面贴图",
					"有产品图时产品落在空间里；概念模式用标题当建筑",
					"单张静帧 — 非轮播",
					"产品与概念都可用",
				],
				output: [
					"一张空间排版静帧（9:16）",
					"画面：大字 + 混凝土/天空 + 橙色点缀 + 小标签",
				],
			},
			"photo-doodle": {
				need: [
					"主题 / 氛围可选（标题驱动插画角色）",
					"产品 / 人物图可选（产品模式建议上传）",
					"方言：通勤 / 城市流行 / 人物环绕 / 自然框（或自动）",
				],
				attention: [
					"照片保持写实 — 插画是共享地面的 2D 叠加",
					"不要把产品画成卡通；插画围着 / 陪着产品",
					"标题可选 — 气氛可以只靠物件",
					"单张静帧 — 非轮播",
					"产品与概念都可用",
			...
			"light-trail": {
				need: [
					"主题 / 氛围可选（标题驱动光轨能量）",
					"产品 / 人物图可选（产品模式建议上传）",
					"方言：群像光轨 / 眼神横切 / 面具光束 / 侧脸剪切（或自动）",
				],
				attention: [
					"暗调电影感 — 猩红＋青蓝霓虹长曝光光轨是主画面",
					"主体保持写实；不要重画产品",
					"标题可选 — 气氛可以只靠光",
					"单张静帧 — 非轮播",
					"产品与概念都可用",
				...
				output: [
					"一张动感光轨静帧（9:16）",
					"画面：暗青底＋霓虹光轨＋主体＋可选小标签",
				],
			},
			"screen-break": {
				need: [
					"产品模式：建议上传产品图（SKU 是破屏英雄）",
					"概念模式：人物 / Logo / 品牌图可选（人／品牌是破屏英雄）",
					"主题 / 标题可选",
					"方言：撕开伸手 / 撕开探头 / 手机棚拍 / 手机地面（或自动）",
				],
				attention: [
					"一个门户平面（档案 UI 或巨型手机）被物理撕开／冲破",
					"产品模式：精确 SKU 踏出或弹出门户 — 身份锁定",
					"概念模式：人物／品牌冲出 — 不需要 SKU；浮动 UI 卖触达／气氛",
					"强制透视＋立体 likes／数据 — 不是平面 Canva 贴纸",
					"单张静帧 — 不是 web-boundary-break 短片配方",
					"产品与概念都可用",
				],
				output: [
					"一张破屏出界静帧（9:16）",
					"画面：门户破口＋冲出英雄＋浮动 3D UI＋可选大字／QR",
				],
			},
"material-letters": {
				need: ["标题（材质大字）", "建议上传产品或模特图"],
				attention: ["接触处的材质行为 > 平面贴图", "单张静图 — 不做轮播"],
				output: ["一张材质大字海报静图"],
			},
			"type-interaction": {
				need: ["标题（互动大字）", "建议上传产品图"],
				attention: [
					"折叠／揭膜／切片／镜面要跟产品相关",
					"MOVE 时人物保持完整",
					"单张静图 — 不做轮播",
			...
			"product-lifestyle": {
				need: ["产品图（极前景）", "标题（大字）", "带数字的卖点"],
				attention: [
					"产品在手前 + 人物在后 + 彩虹折射光",
					"单张或轮播 — 同一套 DNA，每张换卖点",
					"仅实体产品路径",
				],
				output: ["生活方式产品静图（单张或轮播）"],
			},
			"vacuum-inflate": {
			...
			"product-explode": {
				need: ["产品图（概念可用 Logo／吉祥物静图）", "棚拍可读的主体（不要太小 crop）"],
...
socialDripHint:
    ...
    socialDripPourAmounts: {
      ...
      extra: "多",
		...
		typeBehindBuildingEnd: "第 2/2 步：字夹结束静图…",
		typeBehindAnimatingCard: "正在生成字夹主体…",
		typeBehindNeedKeyframe:
			"请先上传产品图（概念用人像／品牌形象／吉祥物静图 — 单靠文字不够）。",
		wetGlassHint:
			"湿玻璃揭示 — 起雾湿玻璃 → 水珠划痕／指抹清晰 → Logo 变锐。~6–8秒 · 水珠划痕／指抹清晰／黑白微距。Logo 来自上传图透过玻璃显现。",
		wetGlassDialectTitle: "湿玻璃风格",
		wetGlassDialectHint:
			"同一揭示 — 水珠划痕（一滴水珠划开雾气）、指抹清晰（清晰擦痕、无手）、或黑白微距（黑白特写湿玻璃）。",
		wetGlassDialectAuto: "自动 · 最佳匹配",
		wetGlassDialects: {
			"droplet-trail": {
				title: "水珠划痕",
				desc: "一滴水珠滑过，擦开雾气露出 Logo",
			},
			"finger-wipe": {
				title: "指抹清晰",
				desc: "清晰擦痕（无手）揭示标志",
			...
			"mono-macro": {
				title: "黑白微距",
				desc: "黑白微距湿玻璃 — 同样揭示，不同观感",
			},
		},
		wetGlassBuildingStill: "第 1/2 步：湿玻璃起始静图…",
		wetGlassBuildingEnd: "第 2/2 步：湿玻璃结束静图…",
		...
		magazineCoverDialectHint:
			"同一变装配方 — 红刊头（街拍封面）、粉梦（粉色刊头）、或暗丝绒（皮革暗黑）。",
		magazineCoverDialectAuto: "自动 · 最佳匹配",
		...
		magazineCoverBuildingStill: "第 1/2 步：杂志封面起始静图…",
		magazineCoverBuildingEnd: "第 2/2 步：杂志封面结束静图…",
		magazineCoverAnimatingCard: "正在生成杂志封面变装…",
		magazineCoverNeedKeyframe:
			"请先上传人像图（产品路径：人+SKU 静图 — 单靠文字或 Logo 不够）。",
		productExplodeHint:
...
socialDripFitTitle: "这个格式可以／不可以做什么",
    ...
    storyboardShotMapEmptyStill: "点击下方「生成图片」",
    tvcShotRoles: {
      establish: "开场建立",
      macro: "细节特写",
      "logo-trace": "Logo 扫光",
    ...
    videoAutoSecondFrame: "自动做第二个画面（一张相 → 视频更有变化）",
    videoAutoSecondFrameHint:
      "AI 会生成另一个角度（例如上手佩戴）作为结尾画面，视频生成 由头行到尾 — 不是只是 zoom。",
    extraAnglesLabel: "更多产品角度（选填）",
    extraAnglesHint: "同一款货 2–3 张相 — 多角度动态，比单张 zoom 更好看",
    extraAnglesCta: "加入角度图片",
    endFrameLabel: "结尾画面（选填）",
    endFrameHint: "不用自动 — 自己 upload 第二张",
    videoRichMotionNote: "使用丰富动态 + 第二画面，比只是 zoom 更有广告感。",
    videoWearVarietyTitle: "想更多变化或上手佩戴？",
    videoWearVarietyTips: [
      "跟参考视频模式：动态主要跟 @Video1 — 参考视频没有上手，出来通常都不会有手。",
      "要上手佩戴：参考 MP4 选有手背/佩戴的片段；@Image1 用原始产品相（静物宣传图较难跟手）；进阶选「只出手」。",
      "要更多变化：动态丰富度选「丰富／电影感」；或改「产品宣传片」+ 开「自动第二画面」（静物→上手过渡）。",
      "亦可自己生成上手图做「结尾画面」，或视频 prompt 写：gentle hand lifts bracelet onto wrist, face never shown。",
      "完整露样模特：现在不支持，只做到手／脚／身体（不露脸）。",
    ],
    videoSettingsFast: "快速模式（更便宜、草稿质量）",
    ...
    step1Hint: "选只生成图片、只生成视频、还是两样都要。填好产品资料，AI 跟着做。",
    stepHelp: {
      setupTitle: "这步怎么做",
      videoTitle: "出片步骤",
      noChatCoachNote:
    ...
    setupCallouts: {
      "image-only": "只做图片 — 没有视频步骤。下一步选怎样生成图片。",
      "video-only": "只做视频 — 视频生成 + BGM。下一步上传产品相同可选参考广告 MP4。",
      combined: "完整广告 — 先生成/美化图片，再做动态。参考 MP4 沿用之前的运镜功能。",
    },
    imageInputLabel: "你想怎样做张图？",
    imageInputModes: {
      "product-ad": {
        title: "产品 → 广告图（推荐）",
        description: "只上传产品相 — AI 保留你产品，做成好看的广告图（不跟风格参考）",
      },
      "product-style": {
        title: "产品 + 风格参考",
        description: "产品相 + 第二张参考图，跟那张广告的构图、光线、氛围",
      },
      describe: {
        title: "纯文字描述",
        description: "不用上传 — 用 prompt 描述（步骤 1 产品名有帮助）",
      },
      reference: {
        title: "只用参考图",
        description: "上传一张广告/图片 — AI 跟它的视觉风格，配合你的产品描述",
      },
    },
    ...
    step2Hint: "上传产品相。AI 为你生成新广告图；若选了参考概念，会跟参考图重新设计（不照抄）。",
    step2Hints: {
      "image-only": "下面选一种方式，生成后下载 — 不会做视频。",
      combined:
        "预设只上传产品整好看的广告图。想跟另一张广告风格先选「产品 + 风格参考」。",
    },
    imageModelLabel: "图片品质",
    imageModels: {
      "nano-banana-2-edit": {
        label: "AI 出圖 Edit（预设）",
        hint: "上传产品相 → AI 设计新广告图，保留你产品",
      },
      "nano-banana-edit": {
        label: "AI 出圖 Edit（旧版）",
        hint: "上传产品相 → AI 美化，保留你产品",
      },
      "nano-banana": {
        label: "AI 出圖 — 纯文字",
        hint: "不用上传 — 靠步骤 1 产品名 + prompt",
      },
    ...
    twoVariantsHint: "同一设置出两张图，选较满意那张（约 2× API 成本）",
    pickVariantLabel: "选一个版本继续",
    variantA: "版本 A",
    variantB: "版本 B",
    exactTextHint: "要图上精确中文标题？AI 生图未必字字正确。",
    exactTextCta: "改用纸条贴纸模板 → 文字原字放上版面",
    uploadQualityLowRes: "图片分辨率偏低（建议至少 800×800）— 仍可生成，但产品细节可能不够清晰。",
    uploadQualityVerySmall: "图片太小（低于 512px）— 建议换一张更清晰的产品相。",
    imageRefLabel: "风格参考图（图片，选填）",
    imageRefHint:
      "只影响图片 AI — 构图/光线/氛围。视频参考 MP4 在「视频」步骤上传。",
    styleRefPromptActive:
      "已侦测风格参考图 — prompt 已改为跟参考图（构图、光线、图案）。请重新生成。",
    productAdHint:
      "AI 会用你填的主标题／副标／优惠设计宣传图 — 保留同一产品，加上广告文字和漂亮背景。不用上传参考图。",
    imageRefCta: "选择参考图",
    imageRefChange: "更换参考图",
    videoKeyframeLabel: "关键图（视频起点）",
    videoKeyframeHint: "视频生成 会将呢张图变成动态（你的相或 AI 生成图）",
    downloadImage: "下载图片",
    imageDoneTitle: "图片已完成",
    imageDoneHint: "下载图片。需要视频可另外选「只做视频」或「图片+视频」。",
    generateImageBtn: "生成图片",
    storyboardGenerateScenesBtn: "生成分镜场景图",
    regenerateImageBtn: "重新生成新图片",
    ...
    useOriginalImageOnlyBtn: "直接用原图（不经 AI）",
    imageReadyHint: "满意呢张图？继续制作视频。",
    imageReadyHintCombined: "呢张图会做视频 @Image1 — 满意就继续。",
    combinedVideoKeyframeCallout:
      "步骤 2 已生成的宣传图会做 视频生成 @Image1（图片变视频）。要跟参考视频运镜，请改选「跟参考视频概念」。",
    combinedCreativeImageHint:
      "请先在这步生成一张符合你创意简介的宣传图 — 视频步骤会用呢张图做动态起点。",
    combinedRefKeyframeNote:
      "跟参考视频模式：建议用原始产品相做 @Image1（不要用宣传图），视频生成 才容易跟 @Video1 运镜。",
    ...
    step3Hints: {
      ...
      combined: "步骤 2 的图系 @Image1。下面可加参考 MP4 跟运镜 — 同之前一样。",
    },
    ...
    referenceHint:
      "上传你想跟的短视频 MP4。AI 会将你的产品（@Image1）做成类似 @Video1 的运镜和风格。",
    referenceVideoOnlyHint: "MP4 或 MOV · 选填，但建议上传先有参考运镜",
    needKeyframeGoBack: "未有关键图 — 请按返回，生成图片或确认上传后再来呢步。",
    referenceImageOnlyHint:
      "你上传了图片 — 要跟参考视频运镜请上传 MP4 视频。",
    referenceModeNote: "已用参考视频模式：你的产品图片 + 参考广告。",
    referenceModeActive:
      "已侦测参考视频 — AI 会用上面关键图做 @Image1，跟 @Video1 的运镜和风格。",
    referenceVideoTooLong:
      "参考视频约 {seconds} 秒 — 视频生成 只会用首段 2–15 秒。请在 CapCut 剪一段 8–12 秒精华再上传，效果才会似。",
    referenceVideoTips:
      "跟参考视频贴士：① 剪短至 8–12 秒（不要整条 30 秒 Reels）② 产品相要同参考视频同一类产品 ③ 避免屏幕录影（IG 按钮会入镜）④ 选「跟参考视频概念」+ 720p。",
    videoRefAutoModeNote:
      "已侦测参考 MP4 — 会用「跟参考视频概念」生成（不会再用图片变视频忽略参考视频）。",
    videoRefProductMismatch:
      "参考视频是穿珠/上手动态 — 请用「产品图片」做 @Image1（不要用已生成宣传图），视频生成 才会跟到手和运镜。",
    videoRefUseProductPhoto:
      "提示：这次用 AI 宣传图做产品参考 — 建议改用上传的原始产品相，才容易跟参考视频动态。",
    videoGenPathLabel: "视频生成 路径",
    videoRefIgnoredOnImageMode:
      "你上传了参考 MP4，但这次是「产品动态」模式 — 参考视频不会用。要跟运镜请改选「跟参考视频概念」。",
    ...
    videoPreflightTierFast: "快速草稿（省钱）",
    videoPreflightTierQuality: "标准质量",
    videoPreflightStyle: "画面风格：{style}",
    videoPreflightSecondFrame:
      "会额外 call 1 次出图 API 自动做第二帧（约多 1× 图片费用）— 省钱请关闭「自动做第二个画面」",
    ...
    planVideoPromptDurationStale: "片長已改 — 你的腳本仍保留；要更新請再撳「AI 寫動態提示」。",
    ...
    videoKeyframeProductHint:
      "必须上传。你的产品或静态图 — 作为 @Image1。有参考 MP4 时，AI 会跟 @Video1 运镜。",
    ...
    extraLabel: "额外指示（选填）",
    extraPlaceholder: "例如：金色手链戴在手腕、户外自然光",
    ...
    promptFramings: {
      auto: { label: "自动（跟模板）", hint: "用你上面选的风格" },
      "product-only": { label: "只有产品 — 不要出人", hint: "产品特写，画面没有人" },
      "hands-only": {
        label: "只出手 — 不露脸",
        hint: "手持或佩戴产品，绝对不露脸",
      },
      "legs-feet": {
        label: "只出腿同脚",
        hint: "鞋、袜、裤脚 — 膝盖以上不入镜、不露脸",
      },
      "torso-no-face": {
        label: "身体 / 腰以上 — 不露脸",
        hint: "可以有手臂或身体，样要出镜外",
      },
      "no-people": { label: "完全不要出人", hint: "只有产品同背景" },
    },
    retry: "再试一次",
    bgmNote: "已加入背景音乐。",
    bgmFallbackNote: "找不到音乐文件 — 已用 AI 轻音乐。请执行：npm run setup:bgm",
    adPack: {
      title: "广告包 — 文案、字幕同音乐",
      ...
      voiceoverSkippedNote: "口播失败 — 保留 BGM 版本。请稍后重试或联系支持。",
      needVoiceoverScript: "请先填口播文案或字幕行。",
    },
    adStyleLabel: "你想做边种广告？",
    adStyleHint: "选最接近的款式 — 跟着做，第一次大约有 80–90% 似预期。",
    ...
    adStyles: {
      ...
      "copy-reference-ad": {
        title: "跟同款广告做",
        description: "选 sample 运镜片 + 你的产品图。最接近真实 Reels。",
      },
      "shop-promo": {
        title: "店铺 / 优惠宣传",
        description: "店铺、服务或限时优惠 — 温馨宣传感。",
      },
    },
    ...
    compositorCallout:
      "这个模板用固定 IG 版面 — 你填的标题、重点同品牌会原字放上图，不是 AI 乱写。",
    compositorImageHint: "上传产品相。我们会裁成圆形贴纸，和纸片笔记与你的文字合成。",
    compositorImageBtn: "合成广告图",
    compositorRegenerateImageBtn: "重新合成",
    compositorVideoHint: "输出 6 秒 Reels：慢 zoom、纸片浮动、闪光 + BGM。不用 视频生成 AI 视频。",
  ...
  templates: {
    "paper-sticker-reel": {
      name: "纸片 + 贴纸 Reels",
      description: "固定 IG 纸片版面 — 你的文字 + 产品贴纸，可出图同动画片",
    },
    "product-reel": {
      name: "产品展示",
    ...
    "spatial-layout": {
      name: "空间排版海报",
      description: "建筑感大字：平面、镂空、挤出或转角",
    },
    "photo-doodle": {
      name: "实景插画海报",
      description: "真实照片＋2D 卡通叠加（通勤、城市流行、人物、自然）",
    },
    "light-trail": {
      name: "动感光轨海报",
      description: "暗调电影感＋猩红 / 青蓝霓虹光轨与速度感",
    },
    "screen-break": {
      name: "破屏出界海报",
      description: "从档案页撕开或巨型手机冲出 — 产品 SKU 或概念人物为英雄",
    },
"material-letters": {
      name: "材质大字海报",
      description: "羽绒/牛仔/帐篷尼龙/皮革构成的立体大字",
    },
    "type-interaction": {
      name: "字体互动海报",
      description: "折叠/揭膜/运动切片/镜面 TRACE",
    ...
    "product-hold-poster": {
      name: "手持产品海报",
      description: "人物手持产品对镜 — 白棚、痛点？态度 标题",
    },
    "mold-word-poster": {
      name: "捏字趣味海报",
      description: "黏土／公仔风趣味大字做主角 — 产品或概念字梗场景",
    },
    "deconstruct-archive-poster": {
      name: "解构档案海报",
      description: "上半产品实拍 · 下半同款水彩技术拆解图",
    },
    "orbit-type-poster": {
      name: "环绕字海报",
      description: "主体置中 — 动能字环绕／穿隧／穿后，白棚",
    },
    "cloche-reveal-poster": {
      name: "餐罩揭晓海报",
      description: "银盘 + 餐罩 — 成分或隐喻，再揭产品或品牌",
    },
    "brand-fit": {
      name: "品牌风格分析",
  ...
  errors: {
    ...
    tvcNeedsPaidPlan:
      "这条视频比免费额度贵。免费最多约 1 张图 + 约 5 秒 480p（或约 4 张静图）。请到 Pricing 升级，或者余额够就用 拼接后备。",
    ...
    voiceoverFailed: "口播合成失败。请稍后重试，或关闭口播。",
    ugcPresenterFailed: "数字人视频生成失败。请稍后重试或联系支持。",
  ...
  captions: {
    ...
    matchVideoMusic: "按片内容配乐",
    matchVideoMusicHint:
      "AI 会分析片节奏再生成音乐。主题／氛围仍可引导风格。",
    ...
    libraryBgmPreviewLabel: "试听示范循环",
    libraryBgmDisclaimer:
      "示范配乐：柔和 / 活泼 / 温暖（AI 生成器乐）。可快速试听；正式成片可用「AI 生成」定制贴片曲。",
    aiMusicNeedBrief: "请在上方输入产品/主题（或用 AI 规划），才能生成音乐。",
    aiMusicGenerateHint: "可选氛围 + 主题，再生成贴合片长的音乐。",
    ...
    aiMusicMatchedVideoNote: "已按片内容生成 AI 音乐 — 下面试听后点击添加 BGM。",
    ...
    trimIn: "开始（秒）",
    trimOut: "结束（秒）",
    tryCaptions2: "打开字幕与成片（时间轴）",
  },
  captions2: {
    badge: "字幕与成片",
    title: "字幕与成片",
    subtitle:
      "一块板：时间轴修剪／剪开，对选中片段做 AI 画面编辑，安排字幕与 BGM，再烧录。",
    diffTitle: "这块板怎么用",
    diffBody:
      "一块板完成：时间轴修剪／剪开、AI 改画面、用主题规划字幕+口播、混配音与 BGM，再烧录 — 不用离开字幕工作室。",
    openClassic: "经典字幕工具 →",
    phaseImport: "1 · 导入",
    phaseCaptions: "3 · 字幕",
    phaseFinish: "4 · 完成",
    phasePictureName: "画面",
    phaseStructureName: "结构",
    phaseCaptionsName: "字幕",
    phaseFinishName: "完成",
    phaseHowToPicture:
      "可选 AI 编辑：选任务芯片、放参考图、生成。或跳过进入结构。",
    phaseHowToStructure:
      "CapCut 式时间轴：拖片段修剪／排序、在播放头剪开、加片段 — 再继续。",
    phaseHowToCaptions:
      "纯字幕＝手写／改行。语音＝片内有人声时自动抽出。合适就继续烧录。",
    phaseHowToFinish:
      "试听／混口播，加曲库或 AI BGM，再导出或烧录。",
    dismissTip: "收起",
    showProcessed: "显示已烧字幕",
    tokenCostHint: (n: number) => `约 ${n} tokens · 云端语音转文字`,
    emptyLinesHint: "还没有字幕行 — 添加行、从语音，或用 AI 规划。",
    stickyPictureHint: "用 AI 改画面，或跳过进入修剪／拼接。",
    stickyStructureHint: "在时间轴修剪／剪开／绑定，再继续字幕。",
    stickyCaptionsHint: "在时间轴拖字幕块，或在右侧改文字。",
    stickyFinishHint: (n: number) =>
      n > 0 ? `已有 ${n} 行可烧录` : "烧录前请先有字幕文字",
    backToCaptions: "返回字幕",
    backToStructure: "返回结构",
    continueStructure: "继续结构",
    continueCaptions: "继续字幕",
    importHint:
      "导入视频 — 在时间轴修剪，对片段做 AI 编辑，再加字幕与 BGM。",
    fromLink: "来自链接",
    uploadedVideo: "已上传视频",
    readyAuto: "视频就绪 — 可以点语音自动字幕。",
    readyPicture: "视频就绪 — 在时间轴修剪，对片段做 AI 编辑，再加字幕。",
    mediaBin: "素材",
    boardHint:
      "时间轴修剪／剪开，对选中片段做 AI 编辑，安排字幕与 BGM。",
    tabEdit: "编辑",
    tabCaptions: "字幕",
    tabAudio: "音频 · 完成",
    stickyBoardHint: "修剪 → AI 编辑选中片段 → 字幕 → 就绪就烧录。",
    pictureTitle: "AI 画面编辑",
    pictureHint:
      "选任务、放参考图或写短备注，再生成。改的是画面，不是整段重写提示词。",
    pictureHintSelected:
      "应用到时间轴上选中的片段（若只要一段，请先修剪该片段）。",
    jobProduct: "换产品",
    jobScene: "换背景",
    jobStyle: "改风格",
    refPhoto: "参考图",
    refHint: "用于替换的产品或背景静帧。",
    editNoteLabel: "可选备注",
    editNotePlaceholder: "例如：保持瓶身标签可读",
    editGenerate: "生成编辑",
    editGenerating: "正在编辑视频…",
    editStageTrim: "正在修剪选中片段…",
    editStageGenerate: "AI 画面生成中…（可能需要一两分钟）",
    editCancel: "取消编辑",
    skipPicture: "跳过 — 画面已合适",
    editCostHint: (n: number) => `约 ${n} tokens · AI 画面编辑`,
    audioCostBgm: (n: number) => `约 ${n} tokens · 加 BGM`,
    audioCostVoice: (n: number) => `约 ${n} tokens · 混入口播`,
    audioCostMusic: (n: number) => `约 ${n} tokens · AI 音乐`,
    audioCostVoicePreview: (n: number) => `约 ${n} tokens · 口播预览`,
    audioCostBurn: (n: number) => `约 ${n} tokens · 烧字幕`,
    needRefOrNote: "请添加参考图或简短备注。",
    editFailed: "画面编辑失败。",
    editDone: "画面已更新 — 可先下载，或继续在时间轴编辑。",
    editDoneOnClip: "已更新选中片段 — 可继续在时间轴安排。",
    downloadEdited: "下载已编辑视频",
    downloadingEdited: "下载中…",
    editDownloadFailed: "无法下载已编辑视频。",
    structureTitle: "时间轴 · 修剪与绑定",
    structureHint:
      "拖边缘修剪、剪刀剪开、拖片段排序（磁性吸附）。从素材栏加入更多片段。",
    addClip: "加入时间轴片段",
    addClipFromLibrary: "从作品库加入",
    addClipFromFile: "上传文件加入",
    joinClips: "拼接片段",
    joining: "拼接中…",
    clipN: (n: number) => `片段 ${n}`,
    needTwoClips: "请至少再加一段才能拼接。",
    joinFree: "时间轴修剪与拼接免费。AI 画面编辑会扣 tokens。",
    joinFailed: "无法拼接片段。",
    joinDone: "已拼接 — 继续字幕。",
    clipAdded: "已加入时间轴。",
    nleTitle: "时间轴",
    nleHint: "点片段放置红色剪开线 · 再点剪开 · 拖边缘修剪",
    nleShortcuts: "空格播放 · S 剪开 · Del 删除 · ⌘Z 撤销 · ⌘/Ctrl+滚轮缩放",
    nleAudioTrack: "音频",
    nleSplit: "剪开",
    nleDelete: "删除片段",
    nleUndo: "撤销",
    ...
    nleZoomLabel: "缩放",
    nleCutAt: "剪开 @ {t}秒",
    libraryFileMissing: "这个素材在云端没有文件（上传未完成）。请选缩略图能预览的，或重新上传视频。",
    nleEmptyVideo: "尚无片段",
    nleEmptyCaption: "在「字幕」里加行后，会显示在这条轨道上",
    nleBgmLane: "BGM",
    nleVoLane: "配音",
    nleSelected: "已选",
    nleSplitDone: "已在播放头剪开。",
    nleSplitNeedInterior: "请把播放头移到片段内部（不要贴边）再剪开。",
    nleKeepOne: "时间轴至少保留一个视频片段。",
    bgmDragHint:
      "拖动 BGM 整块可平移；左右绿边可拉长短。改完位置后请再点「添加 BGM」写入成片。",
    bgmStartNote: (s: number) => `混音中 BGM 从 ${s.toFixed(1)}s 开始`,
    exportPlate: "导出时间轴",
    exportingPlate: "正在烘烤时间轴…",
    ...
    modeAi: "AI 规划",
    aiPlanHint:
      "输入产品/主题 — AI 写好字幕行 + 口播稿。再到「音频 · 完成」试听配音、加 BGM。",
    openAudioForVo: "下一步：音频 · 完成（混配音 + BGM）→",
    sectionAiCaption: "AI 为这段加字幕",
    sectionAiVo: "为这段生成口播",
    sectionAiHint:
      "先在时间轴选片段或字幕 — 这段只会有一句字幕 + 一段连续口播。",
    sectionCaptionDone: "这段字幕已就绪（约 {sec}s）— 可在预览拖动，再生成这段口播。",
    sectionVoDone: "这段口播已放在时间轴 — 可拖动位置，再混入口播烧入视频。",
    planOnCaptionsTab: "AI 规划字幕 + 口播 → 字幕页签",
    pureTitle: "纯字幕",
    pureHint: "适合无声 Alchemy 短片 — 在右侧手写或改时间轴字幕。",
    pureEditHint: "添加行 → 改文字与时间 → 继续完成。",
    autoTitle: "语音自动字幕",
    autoHint:
      "抽音轨 → 转文字 → 填入时间轴。云端语音转文字会扣少量 plan token。",
    autoCta: "语音自动字幕",
    transcribing: "正在听写字幕…",
    transcribeDone: (n: number) => `已由语音填入 ${n} 行字幕`,
    transcribeFailed: "无法转写此视频。",
    noSpeech:
      "听不到人声（无声 AI 片？）。请改用纯字幕，或打开「音频 · 完成」用主题规划配音。",
    silentHint: "无声短片？",
    openClassicPlan: "需要经典字幕工具？→",
    evenSplitNote: "时间轴为估算（无语音分段）",
    asrCloud: "云端语音",
    asrLocal: "本机语音",
    chargedTok: (n: number) => `${n} tok`,
    needVideo: "请先加载视频。",
    continueFinish: "继续完成（BGM + 烧录）",
    finishHint:
      "配音试听与混音、曲库或 AI BGM。字幕 AI 规划在「字幕」页签。然后导出 / 烧录。",
    classicVoiceNote:
      "配音试听／混音与 BGM 在「音频」页签；字幕 AI 规划在「字幕」页签。",
    packNamePlaceholder: "项目名称",
    packSave: "保存",
    packSaving: "保存中…",
    packSaved: "项目已保存",
    packSaveAs: "保存项目",
    packOpen: "打开",
    packOpening: "打开中…",
    packEmpty: "还没有已保存的字幕项目。",
    packSummary: (captions: number, clips: number) =>
      `${captions} 条字幕 · ${clips} 个片段`,
    packDelete: "删除项目",
    packDeleteConfirm: "删除这个字幕项目？无法撤销。",
    packNew: "新建",
    packNeedSignIn: "登录后即可保存字幕项目。",
    packSaveFailed: "保存项目失败。",
    packLoadFailed: "打开项目失败。",
    packNeedContent: "请先添加字幕文字或视频片段再保存。",
    packOpened: "项目已打开",
    packMissingMedia:
      "部分本地媒体未保存 — 请重新上传片段或从作品库选择。",
  },
  editImage2: {
    title: "AI 智能图层",
    subtitleShortcuts: "滚轮缩放 · 拖动背景平移 · 空格平移 · ⌘Z 撤销",
    upload: "上传",
    undo: "撤销",
    redo: "重做",
    zoomOut: "缩小",
    ...
    save: "保存",
    clearAll: "清空",
    clearAllConfirm: "清空画布并重新开始？未保存的改动会丢失。",
    dropTitle: "将图片拖到此处",
    dropHint: "上传平面 AI 海报 — 先抽出文字，再拆画面图层",
    tokenHint: (
      split: number,
      erasePerMp: number,
      heal: number,
      ...
      `拆层 ${split} · AI 编辑 ${edit} · 擦除约 ${erasePerMp}/百万像素 · 兜底 ${heal} · 抠图 ${matte}`,
    uploading: "上传中…",
    detecting: (tokens: number) => `正在拆层…（${tokens} 点）`,
    splittingLayers: "正在拆成图层…",
    suggestingText: "正在找文字行…",
    sandwichSplitting: "混合拆层 — 先文字，再主体，再 Qwen…",
    sandwichReady:
      "已就绪 — Florence 文字在上、BiRefNet 主体、Qwen 组件 + 已填底图。可自由拖动。",
    sandwichReadyPartial: (n: number) =>
      `已就绪 — ${n} 层（文字＋主体）。底图已清洞 — 选一层再拖。剩余图形未拆，可用框选提起。`,
    sandwichPartialTokens:
      "文字与主体已抽出，但 Qwen 未跑（点数不足）。余额足够后再试混合拆层，或用框选提起。",
    sandwichNoObjects:
      "文字与主体已就绪；Qwen 没有额外组件。Logo 可能仍在底图 — 用框选或 Qwen 拆选区。",
    sandwichHow:
      "混合：Florence 抽字 → BiRefNet 主体 → Qwen 补其余（不用 Florence 烂修洞做底图）。",
    sandwichAdvanced: "混合拆层",
    sandwichAdvancedHow:
      "Florence 文字 + BiRefNet 主体 + Qwen 其余。难图优先用这个。",
    hybridSplit: (n: number) => `混合拆层 ${n}`,
    hybridSplitHow:
      "海报首选：Florence 抽可改文字、BiRefNet 切主体、Qwen 重建底图＋剩余图形（如 SMASH）。不再用 Florence 烂修洞。",
    liftTools: "提起与编辑",
    liftToolsHint: "框选 / 点选 / 笔刷提起一件 — 干净切割并填洞，其余画面保留。",
    cuttingCleanly: "正在干净切割…",
    cutReadyHealed: "切割完成 — 已填洞。可自由拖动。",
    matteSkippedFallback: "干净切割失败 — 保留框选。可在图层再点抠图。",
    florenceSamReady: (layers: number, sam: number) =>
      `已就绪 — ${layers} 层（${sam} 个 SAM 切割）。文字与组件已提起；底图已修补。`,
    florenceMatchReady: (layers: number) =>
      `已就绪 — ${layers} 层。画面与原图一致；拖动一件才会清洞。`,
    florenceSamMatchReady: (layers: number, sam: number) =>
      `已就绪 — ${layers} 层（${sam} 个 SAM 切割）。画面与原图一致；拖动一件才会清洞。`,
    florenceSubjectReady: (layers: number, sam: number) =>
      `已就绪 — ${layers} 层（BiRefNet 主体${sam ? ` + ${sam} SAM` : ""}）。主角是完整一层；画面与原图，拖动才清洞。`,
    florenceSplitHow: "八月模式：Florence 文字 · BiRefNet 主体 · SAM 图标。拆完与原图一样，拖动才清洞。",
    qwenSplitHow:
      "试验：一个 Qwen 模型直接拆 RGBA 图层 + 已填底图（不用 Florence 修洞）。难图可与 Florence 拆层对比。",
    seedreamSplitting: "正在拆成可编辑图层…",
    seedreamSplitHow:
      "把海报拆成可拖曳的文字／产品／人物图层，再逐块改或用 AI 改。",
    seedreamFullSplit: (n?: number) =>
      typeof n === "number" && n > 0
        ? `一键拆成可编辑图层 · 约 ${n} tok`
        : `一键拆成可编辑图层`,
    seedreamFullReady: (layers: number) =>
      `完成 — ${layers} 层。选中后可拖曳、隐藏，或 AI 改这块。`,
    qwenFullReady: (layers: number) =>
      `Qwen 完成 — ${layers} 层 + 已填底图。可直接拖，不必再清鬼影。`,
    changeWordsOneTap: (n: number) => `改文字 ${n}`,
    changeWordsHint: "输入要显示的完整新文案，一键改字。风格保留，但字必须与你输入一致（不要留旧字）。",
    grabClick: "点选提起",
    grabClickOn: "点选提起中",
    grabClickHint: "在照片上点一下要提起的部分 — 自动抠出并修补底图。",
    grabClickReady: "已提起 — 可拖动。边缘不干净可再点抠图。",
    brushErase: "笔刷擦除",
    brushEraseOn: "笔刷擦除中",
    brushEraseHint: "涂抹多余部分，再点「擦除涂抹」—— 不新建图层。",
    brushErasePlate: "笔刷清底图",
    brushErasePlateOn: "笔刷清底图中",
    brushErasePlateHint: "涂抹底图残留再套用 — 只清底图，不改图层。",
    brushEraseLayer: "笔刷擦图层",
    brushEraseLayerOn: "笔刷擦图层中",
    brushEraseLayerHint: "在选中图层上涂抹 — 只在这块打透明洞。",
    erasePainted: "擦除涂抹",
    eraseLayerPainted: "擦图层涂抹",
    erasePaintedDone: "已从底图擦除涂抹区域。",
    expandTitle: "AI 外扩补边",
    expandHow:
      "不是免费拉大画布。AI 会画出新背景像素，让底图变成 1:1 / 9:16 等比例。图层保留，只扩大底图。",
    expandCostHint: (n: number) =>
      `约 ${n} 点（tokens）— fal AI 补边。比例已经合适就不用点；空白加边会免费，但这里不做那种。`,
    expandSquare: (n: number) => `1:1 · ${n} 点`,
    expandStory: (n: number) => `9:16 · ${n} 点`,
    expandLandscape: (n: number) => `16:9 · ${n} 点`,
    expandWider: (n: number) => `4:5 · ${n} 点`,
    expanding: "AI 正在补边…",
    expandDone: "底图已 AI 外扩 — 可拖动图层适配新构图。",
    expandFailed: "外扩失败",
    expandNeedHttpBg: "底图需要服务器地址 — 请先拆层，再外扩。",
    expandAlready: "已接近该比例 — 未扣点。",
    magicChatTitle: "Magic 指令",
    magicChatHint:
      "用白话改整张图 — 不用先拆层。或：改成新文案（要先选文字层）",
    magicChatHintWithCosts: (c: { edit: number }) =>
      `描述整张图怎么改（约 ${c.edit} 点）。拆层是独立按钮，这里不用。免费：提起、粘贴、可编辑文字。`,
    magicChatPlaceholder: "例如：背景改夜晚 · 标题改成夏季大促…",
    magicChatSend: "执行",
    magicChatHelp:
      "描述整张图的修改。可选：改成 …（选中文字层）· 改这层：…（只改选中块）",
    magicChatNeedLayer: "这个指令要先选中图层（或直接描述整张图怎么改）。",
    magicChatNeedText: "请选中文字层并输入新文案（或写「改成 …」）。",
    magicChatOk: "完成。",
    magicFullEditing: "AI 正在改整张图…",
    magicFullEditDone: "整张图已更新。",
    magicFullEditDoneClearedLayers:
      "整张图已更新 — 已清掉旧图层，避免和新底图打架。",
    magicFullEditFailed: "整图编辑失败",
    magicFullEditNeedPrompt: "请先描述整张图要改什么。",
    magicFullEditNeedImage: "请先上传图片。",
    qwenSplitting: "正在拆层…",
    qwenRegionSplitting: "正在拆选区…",
    qwenRegionReady: "选区已拆 — 新图层已加入，底图已修补。",
    layersReadyHint:
      "图层已就绪 — 未拆出的仍在底图。可用擦除，或框选后拆选区。",
    readyToEdit: "图片已就绪 — 先拆层，再擦除残留或拆选区。",
    readyLiftHint: "已开启框选 — 框住一整块组件，松手即提起。",
    readyManualHint: "图像已就绪 — 拆层（文字＋物件），或框选提起一件。版面保留。",
    emptyLiftHint: "暂无图层 — 试拆层，或框选/笔刷。",
    boxLift: "框选提起",
    boxLiftOn: "框选提起中",
    boxLiftHint: "框选一块提起为图层",
    detectAll: "拆层",
    detectAllQwen: (n: number) => `Florence 拆层 ${n}`,
    detectAllFlorence: (n: number) => `Florence 拆层 ${n}`,
    qwenFullSplit: (n: number) => `Qwen 拆层 ${n}`,
    suggestText: (n: number) => `识别文字 ${n}`,
    qwenBox: (n: number) => `拆选区 ${n}`,
    qwenBoxOn: "拆选区中",
    qwenBoxHint: "在底图上框住残留组件 — 只对该区域再拆层。",
    qwenNeedHttpBg: "底图地址未就绪 — 请重新拆层后再试。",
    erase: "清底图",
    eraseOn: "清底图中",
    eraseHint: "框选底图上不想要的残留并清除（不新建图层）。",
    erasePlate: "清底图",
    erasePlateOn: "清底图中",
    erasePlateHint: "框选底图残留并修补 — 只清底图，图层保留。",
    erasePlateDone: "已从底图擦除。",
    eraseLayer: "擦图层",
    eraseLayerOn: "擦图层中",
    eraseLayerHint: "先选中图层，再框要打穿的部分（在这块打透明洞）。",
    eraseLayerNeedSelect: "请先选中一个图层，再擦图层。",
    eraseLayerDone: "已从这个图层擦除。",
    erasingHole: "正在擦除…",
    eraseDone: "已从底图擦除。",
    missTools: "残留处理",
    missToolsHint: "漏拆可用：AI 改选区、清底图、擦图层、框选提起，或拆选区。",
    lifting: "正在切割并清底…",
    makeEditableText: "改为可编辑文字",
    makeEditableTextHint:
      "免费：把图片字换成真正可改文字 — 25+ 字体、描边／柔阴影／硬阴影／发光／霓虹，字色·描边色·阴影色可分开设。",
    chargedErase: (n: number) => `已 AI 清底 · ${n} 点`,
    updatingLayers: "正在拆层…",
    layers: "图层",
    itemsCount: (n: number) => `${n} 个`,
    lastTokens: (n: number) => `上次 ${n} 点`,
    ocrObj: (text: number, obj: number) => `文字 ${text} · 物件 ${obj}`,
    brushMappedWrong: "笔刷切割与涂抹不对应（坐标异常）。请清笔触、在主体上再涂一次，再点「生成图层」。",
    brushOffCanvas: "笔刷没有画在图上。请在相片范围内涂抹（不要画空白边）。",
    brushTooLarge: "笔刷范围太大（几乎整张图）。请只涂要提起的主体。",
    brushLayerReady: "笔刷图层已创建 — 拖一下确认切割是否正确。",
    boxTooLarge: "框选太大 — 请只框住要提起的主体。",
    boxLayerReady: "框选图层已创建 — 拖一下确认切割是否正确。",
    makeLayerHint: "在主体上涂抹后点「生成图层」。「清除笔触」只清紫色涂层，不会擦掉相片。",
    add: "添加",
    addHow: "加普通文字、形状、Logo — 或用 AI 生成新贴纸到画布。",
    aiAddComponent: "添加 AI 组件",
    aiAddHow: "描述角标、图标、产品或贴纸。独立透明图层，可拖曳。",
    aiAddPlaceholder: "例如：金色限时角标 · 红色减价爆炸贴 · 可爱吉祥物挥手",
    aiAddRun: (n: number) => `生成组件 ${n}`,
    aiAddGenerating: "正在生成组件…",
    aiAddReady: "AI 组件已加入 — 拖去定位。",
    aiAddFailed: "AI 组件失败",
    aiAddNeedPrompt: "请先描述要生成的组件。",
    text: "文字",
    logo: "Logo",
    logoBusy: "Logo…",
    rect: "矩形",
    ...
    makeLayer: "生成图层",
    cutting: "切割中…",
    healTok: (n: number) => `清底约 ${n}+ 点（AI 填充）`,
    noLayersYet: "暂无图层",
    show: "显示",
    hide: "隐藏",
    lock: "锁定",
    ...
    copyLayer: "复制",
    pasteLayer: "粘贴",
    layerCopied: "已复制图层 — 点「粘贴」或 ⌘V 放置。",
    layerPasted: "已粘贴图层。",
    layerClipboardEmpty: "没有可粘贴内容 — 请先复制一个图层。",
    forward: "↑",
    backward: "↓",
    toFront: "置顶",
    toBack: "置底",
    ...
    matting: "…",
    delete: "删除",
    editTextPlaceholder: "输入新文案…",
    editTextHintEnable: "先输入新文案，再点「AI 改字」保留风格，或「改为可编辑文字」",
    enablingText: "正在从底图清除原文字…",
    textEditableNow: "文字已可编辑 — 可改内容、大小、字体或横竖排。",
    liveText: "改为可编辑文字",
    liveTextOn: "可编辑文字已开",
    aiRewrite: (n: number) => `AI 改字 ${n}`,
    aiRewriteHint: "OCR 乱码可忽略 — 直接输入正确新文案。AI 按裁切图保留风格。",
    qwenTextEditHint:
      "图层是视觉裁切。改字：输入新文案 → AI 改字。可编辑文字是普通字体兜底。",
    cropEditIdle: "在画布点选图层，或用「AI 改选区」框出要改的地方。",
    aiEditRegion: "AI 改选区",
    aiEditRegionOn: "AI 改选区中",
    aiEditRegionHint: "框选要改的地方 → 松开后写下要怎么改 → AI 只改这块裁切。",
    aiEditRegionReady: "选区已提起 — 在下方说明改什么，再点 AI 编辑。",
    cropEditTitle: "编辑选中",
    cropEditHow: "这块有两种改法 — 选下面分页。",
    cropEditModeText: "改文字",
    cropEditModeAi: "AI 改样",
    cropEditModeTextHint: "保留字体风格，只改文案（约图像点数）。",
    cropEditModeAiHint: "改颜色／国旗／人脸／产品（约图像点数）。不是打精确新字。",
    editInstructionPlaceholder: "例如：改成「夏季大促」· 英国旗改中国旗 · 把脸换成微笑女生",
    aiEditCrop: (n: number) => `AI 改样 ${n}`,
    aiEditCropHint: "只改选中裁切。要打精确新文案，用「改文字」。",
    aiEditingCrop: "AI 正在改选区…",
    aiEditCropDone: "选区已更新。",
    aiEditCropFailed: "AI 选区编辑失败",
    aiEditNeedInstruction: "请先说明这块区域要改成什么。",
    chargedAiEditCrop: (n: number) => `AI 选区编辑 · ${n} 代币`,
    aiRewriting: "AI 正在改字…",
    aiRewriteDone: "改字完成 — 已按原风格重绘。",
    aiRewriteFailed: "AI 改字失败",
    aiRewriteNeedText: "请先输入新文案。",
    aiRewriteNeedHttpCrop: "此裁切暂不支持 AI 改字 — 已改用可编辑文字。",
    chargedAiRewrite: (n: number) => `AI 改字 · ${n} 点`,
    bold: "粗体",
    color: "颜色",
    strokeColor: "描边色",
    effectColor: "阴影色",
    effectColorHint: "阴影或发光颜色（可与字色不同）",
    fontStyle: "字体",
    fontGroupSystem: "系统",
    fontGroupCjk: "中文",
    fontGroupSans: "无衬线",
    fontGroupSerif: "衬线",
    fontGroupDisplay: "海报／标题",
    fontGroupScript: "手写",
    fontSystem: "系统",
    fontPingFang: "苹方／黑体",
    fontSongtiSystem: "宋体（系统）",
    fontYuantiSystem: "圆体（系统）",
    fontNotoSansSc: "Noto 黑体简",
    fontNotoSansTc: "Noto 黑体繁",
    fontNotoSerifSc: "Noto 宋体简",
    fontZcoolXiaowei: "站酷小薇",
    fontZcoolQingke: "站酷庆科",
    fontMaShanZheng: "马善政毛笔",
    fontInter: "Inter",
    ...
    textEffect: "效果",
    textEffectNone: "无",
    textEffectOutline: "描边",
    textEffectHeavyOutline: "粗描边",
    textEffectSoftShadow: "柔阴影",
    textEffectHardShadow: "硬阴影",
    textEffectGlow: "发光",
    textEffectNeon: "霓虹",
    textEffectOutlineShadow: "描边+阴影",
    textEffectShadow: "阴影",
    newText: "新文字",
    seedreamCopyrightBlocked:
      "Seedream 拒绝了这张图（版权／品牌／肖像过滤）。点数已退回。用户上传和我们的 AI 海报都可能踩到（有 Logo／角色时）。请用框选提起／清底图，或换一张图。",
    seedreamNoLayersRefunded: (n: number) =>
      `没有可提起图层 · 已退回 ${n} 点`,
    brushCutoutLabel: "笔刷抠图",
    brandLogoLabel: "品牌 Logo",
    layerText: (s: string) => `文字：${s}`,
    layerLogo: (s: string) => `Logo：${s}`,
    layerShape: (s: string) => `形状：${s}`,
    layerObject: (s: string) => `物件：${s}`,
    chargedDetect: (n: number, bal?: number) =>
      bal != null ? `检测已扣 ${n} 点 · 余额 ${bal}` : `检测已扣 ${n} 点`,
    chargedHeal: (n: number) => `本地清底兜底已扣 ${n} 点`,
    chargedMatte: (n: number) => `抠图已扣 ${n} 点`,
    blurPunchFallback: "已使用免费本地填充（服务器修复不可用）。",
    downloaded: "已下载合成 PNG（背景 + 图层）。",
    downloadLayer: "下载这块",
    downloadLayerHint: "只下载选中图层 PNG — 不是整板。",
    downloadedLayer: "已下载这个图层 PNG。",
    downloadLayerNeedImage: "这层暂时没有图片文件（可编辑文字／形状）。请用顶部「下载」整板，或先转成图片裁切。",
    downloadLayerFailed: "无法下载这个图层。",
    savedLibrary: "已保存到作品库",
    noLayersDetected: "未检测到图层。可用笔刷抠图手动抬起区域。",
    detectMissHint: "漏检请用下方「补提漏检」的笔刷或框选。",
    ...
    couldNotAddLogo: "无法添加品牌 Logo",
    brushFailed: "笔刷抠图失败",
    matteFailed: "抠图失败",
    noCropForMatte: "没有可用于抠图的裁切。",
    nothingToExport: "还没有可导出的内容。",
    exportFailedLoading: "导出失败 — 图片可能仍在加载，请重试。",
    exportFailedGeneric: "无法导出 — 请等图层加载完成后再试。",
    saveFailed: "无法保存到作品库",
    titleShow: "显示",
    titleHide: "隐藏",
    titleLock: "锁定",
    ...
    titleNeedBrandLogo: "请先在品牌套件上传 Logo",
  },
  imageCanvas: {
    badge: "独立工具 · 不必重新生成",
    title: "图片画布工作室",
  ...
  contentResearch: {
    ...
    directPostHint:
      "已有目标帖就不用搜关键词 — 支持 xhslink、小红书 explore、Instagram /p/ 或 /reel/、以及 Facebook（主页帖、/share/p/ 短链；不支持 photo/?fbid= 看图链接）。实体产品请先填上方产品名称。xhslink 失效时，请在 App 内「分享 → 复制链接」粘贴完整链接。",
    ...
    busy: "搜索网页并分析中…",
    failed: "内容研究失败，请重试。",
    signInRequired: "需要登录才能使用平台内容研究（Standard 或以上）。",
    searchCooldown: "小红书 API 需要冷却 — 请等 {seconds} 秒再搜索。",
    topicRequired: "请先输入搜索关键词。",
    topPicksTitle: "为你改写的 3 个方向（参考爆款）",
    sendToUltraCanvas: "发送到 Ultra 画布 →",
    sendToUltraMasterHint: "Ultra 画布需要 Master 方案。",
    sendToUltraUpgrade: "升级至 Master →",
    inspiredBy: "参考爆款",
    ...
    resultSubtitle: "根据 小红书、Instagram 热门帖整理。",
  ...
  studioAssistant: {
    ...
    welcomeLanding:
      "你好！问我 Alchemy — Tokens、向导 vs Ultra 画布 vs 字幕 vs 修图、免费 300 token 够不够。或者说你想推广什么，我帮你打开正确路径。",
    welcomeStart:
    ...
    welcomePro:
      "Ultra 画布 — 节点工作流：上传→图片→视频、修饰节点、剧本流水线、保存画布。跑之前可以问我顺序、模板或 token 成本。",
    welcomeBrandKit:
    ...
    quotaExceeded: "已达今日 AI 规划次数上限 — 请明天再试，或 [查看方案](/pricing) 升级。有账号可 [登录](/sign-in) 享更高每日额度。",
    ...
    chipStartCreating: "开始制作",
    unknownAction: "那个按钮没反应 — 请用下面这个。",
    renewConversation: "重新对话",
    returningNudge: "欢迎回来 — [字幕工具](/captions-2) 帮最近影片加字幕，或问我 tokens。",
    followUpsLabel: "建议下一步",
    signInLink: "登录",
  },
  microWizard: {
    ...
    resumeCta: {
      freeBadge: "不扣 Token",
      paidBadge: "会扣 Token",
      hint: "紫色：查看你已生成的成品（不扣）。白色：用上方新设置再生成新成品（会扣 Token）。",
    },
    ...
    intakeFuse: {
      ...
      tipTitle: "参考风格，不抄內容。",
      tipIntro:
        "AI 会分析排版、语气、色调和构图 — 不会抄帖子内容或品牌。静图广告研究请用 小红书／Instagram。",
      tip1: {
        title: "效果更好",
        body: "关键词写得具体一点，研究结果会更接近你想要的风格。",
      },
      tip2: {
        title: "先从小红书／Instagram 开始",
        body: "这两个 feed 通常给出最干净的静图广告排版。",
      },
      tip3: {
        title: "风格大於內容",
    ...
    productNameStep: {
      stepEyebrow: "第 3 步",
      title: "你的产品是什么样的？",
      hint: "会用于研究关键词、标题、prompt，以及需要时的分镜规划。",
      label: "产品",
      labelHint: "写短一点的产品名 — 例如「金砂石手链」，不要只写「饰品」，也不要写成整段卖点。",
    ...
    preGenerateSetup: {
      ...
      browseContinueScenes: "查看已有场景图 →",
      browseContinueImage: "查看已有图片 →",
      browseContinueHint:
        "紫色：直接查看你已生成的成品（不扣 Token）。白色：用上方新设置再生成新成品（会扣 Token）。",
      regenerateScenes: "重新生成新场景",
      regenerateImage: "重新生成新图片",
      directHint:
      ...
      stylePickerPartsDesc:
        "产品爆炸图 — 拆开零件并标注说明，一张海报连标题和内容。",
			...
			stylePickerJellyDesc:
				"极简透亮果冻／玻璃 3D — 少量品牌字。",
						stylePickerTypeForceLabel: "字体受力",
			stylePickerTypeForceDesc:
				"大字存在场景中，受声波/折射/张力/冲击影响 — 人物与产品保持完整。",
			stylePickerSpatialLayoutLabel: "空间排版",
			stylePickerSpatialLayoutDesc:
				"字即建筑：平面 / 镂空 / 挤出 / 转角。产品与概念都可用。单张静帧。",
			stylePickerPhotoDoodleLabel: "实景插画",
			stylePickerPhotoDoodleDesc:
				"真实照片＋2D 卡通叠加（通勤 / 城市流行 / 人物 / 自然）。产品与概念都可用。单张静帧。",
			stylePickerLightTrailLabel: "动感光轨",
			stylePickerLightTrailDesc:
				"暗调电影感猩红 / 青蓝霓虹光轨（群像 / 眼神 / 面具 / 侧脸）。产品与概念都可用。单张静帧。",
			stylePickerScreenBreakLabel: "破屏出界",
			stylePickerScreenBreakDesc:
				"从档案撕开或手机门户冲出。产品＝SKU 英雄；概念＝人物／品牌英雄。单张静帧。",
			stylePickerMaterialLettersLabel: "材质大字",
			stylePickerMaterialLettersDesc:
				"大字由羽绒/牛仔/帐篷尼龙/皮革构成，接触处有真实形变。",
			stylePickerTypeInteractionLabel: "字体互动",
			stylePickerTypeInteractionDesc:
				"折叠/揭膜/运动切片/镜面 TRACE — 字体参与产品表达。",
			stylePickerProductLifestyleLabel: "生活方式产品",
			stylePickerProductLifestyleDesc:
				"产品极前景 + 人物 + 彩虹折射光 + 大标题与数字卖点。",
			posterDialectAuto: "自动 · 最合适",
			posterDialectTypeForceTitle: "受力类型",
			posterDialectTypeForceHint:
				"力从哪产生、往哪传播、影响到哪结束 — 只扭曲笔画。产品受力或空间装置。",
			posterDialectTypeForceProductGroup: "产品受力",
			posterDialectTypeForceSpatialGroup: "空间装置",
			posterDialectTypeForce: {
				"sound-wave": { title: "声波", description: "耳机/音箱附近笔画被推开" },
				refraction: { title: "折射", description: "玻璃局部错位与色散" },
				tension: { title: "张力", description: "绳索拉扯字母接触点" },
				"shock-wave": { title: "冲击波", description: "撞击点压缩/荡开笔画" },
				"standing-wave": { title: "驻波", description: "展厅装置 — 丝带字呈驻波" },
				bend: { title: "弯曲", description: "缆绳＋吊重让大字挠曲" },
				buckle: { title: "压屈", description: "重梁压弯柱状字母" },
				shear: { title: "剪切", description: "错位叠层让字面碎开" },
			},
			posterDialectSpatialLayoutTitle: "空间方言",
			posterDialectSpatialLayoutHint:
				"字如何活在建筑里 — 平面、镂空、挤出或转角。不是受力变形。",
			posterDialectSpatialLayout: {
				planes: { title: "平面", description: "倾斜板面之间的透视大字 + 橙色体块" },
				void: { title: "镂空", description: "混凝土镂空字母，橙色内壁" },
				extrude: { title: "挤出", description: "可站立的立体厚字，橙色侧面" },
				corner: { title: "转角", description: "大字沿墙角两面透视包裹" },
			},
			posterDialectPhotoDoodleTitle: "插画方言",
			posterDialectPhotoDoodleHint:
				"照片保持写实 — 选插画气氛：通勤街景、城市流行、人物环绕或自然框。",
			posterDialectPhotoDoodle: {
				commute: { title: "通勤", description: "繁忙街道 — 咖啡 / 时钟 / 公文包公仔" },
				"city-pop": { title: "城市流行", description: "霓虹夜景 — 卡带 / 麦克风 / 音符" },
				"people-orbit": { title: "人物环绕", description: "街拍模特 — 音箱 / 球鞋 / 滑板环绕" },
				"nature-frame": { title: "自然框", description: "天际线 — 山羊 / 花 / 太阳插画框" },
			},
			posterDialectLightTrailTitle: "光轨方言",
			posterDialectLightTrailHint:
				"暗调电影感 — 选光轨切法：群像横轨、眼神横切、面具光束或侧脸剪切。",
			posterDialectLightTrail: {
				"cast-streak": { title: "群像光轨", description: "团队站位 — 双色水平光轨" },
				"eye-slash": { title: "眼神横切", description: "人像 — 猩红光束横切眼线" },
				"mask-beam": { title: "面具光束", description: "暗调英雄 — 垂直 / 交叉光束" },
				"profile-shear": { title: "侧脸剪切", description: "侧颜 — 斜向速度光轨" },
			},
			posterDialectScreenBreakTitle: "破屏方言",
			posterDialectScreenBreakHintProduct:
				"产品模式：你的 SKU 是破屏英雄 — 踏出或弹出门户。选撕开或手机方言。",
			posterDialectScreenBreakHintConcept:
				"概念模式：人物／品牌是破屏英雄 — 不需要 SKU。档案撕开或手机门户卖触达和气氛。",
			posterDialectScreenBreak: {
				"tear-reach": { title: "撕开伸手", description: "手从档案页撕洞伸向镜头" },
				"tear-peek": { title: "撕开探头", description: "脸从锯齿撕口探出／抓住纸边" },
				"phone-studio": { title: "手机棚拍", description: "巨型手机＋干净棚 — 球鞋／手冲出" },
				"phone-ground": { title: "手机地面", description: "手机插在石地 — 从屏幕爬出" },
			},
			posterDialectMaterialLettersTitle: "材质类型",
			posterDialectMaterialLettersHint:
				"字母由真实材质构成 — 接触行为比贴图更重要。",
			posterDialectMaterialLetters: {
				down: { title: "羽绒", description: "坐压处凹陷起皱" },
				denim: { title: "牛仔", description: "破口毛边与拉力痕迹" },
				"tent-nylon": { title: "帐篷尼龙", description: "风绳拉紧与金属气眼" },
				leather: { title: "皮革", description: "掀角折痕与厚度高光" },
			},
			posterDialectTypeInteractionTitle: "互动类型",
			posterDialectTypeInteractionHint:
				"字体参与产品表达 — MOVE 时人物保持完整。",
			posterDialectTypeInteraction: {
				fold: { title: "折叠", description: "沿铰链多平面弯折" },
				reveal: { title: "揭膜", description: "薄膜掀起带动文字" },
				move: { title: "运动切片", description: "只切文字，人物完整" },
				trace: { title: "镜面", description: "字母反射人物与瓶身" },
			},
stylePickerModelLabel: "模特佩戴／使用",
      ...
      copyCollapsedHint: "文案已随创作方式设定。展开可再编辑。",
        ...
        parts: {
          ...
          supportingPlaceholder:
            "例如：\n电池 — 全日续航\n外壳 — 磨砂防滑\n芯片 — 快充 IC",
				...
				"type-force": {
					title: "字体受力：填写受力大字",
					body: "标题=受力大字。选择受力类型（或自动）。辅助=小字品牌/活动信息。",
					hookLabel: "受力大字 / 标题",
					hookPlaceholder: "例如 LOUD · SERVE · HOLD · VEIL",
					supportingLabel: "辅助 / 活动信息",
					supportingPlaceholder: "短品牌或活动行（可选）",
				},
				"spatial-layout": {
					title: "空间排版：先填建筑大字",
					body: "必填：标题=建筑上的巨型字。可选：产品图（产品落在结构上/内）、辅助标签、方言平面/镂空/挤出/转角（或自动）。画面：混凝土+天空+橙色点缀+空间大字。单张静帧。产品与概念都可用。",
					hookLabel: "建筑大字 / 标题",
					hookPlaceholder: "例如 TYPE · VOID · BETWEEN PLANES · OPEN CORNER",
					supportingLabel: "辅助 / 研究短句",
					supportingPlaceholder: "例如 STEP THROUGH · WORDS HAVE WEIGHT（可选）",
				},
				"photo-doodle": {
					title: "实景插画：气氛为主（标题可选）",
					body: "可选：标题=驱动插画角色的主题。可选：产品/人物图（保持写实）。方言通勤/城市流行/人物环绕/自然框（或自动）。画面：真实照片＋粗线插画。单张静帧。产品与概念都可用。",
					hookLabel: "主题 / 气氛（可选）",
					hookPlaceholder: "例如 赶时间 · 城市流行 · 街拍 · 周末徒步",
					supportingLabel: "辅助 / 品牌短句",
					supportingPlaceholder: "短品牌或活动行（可选）",
				},
				"light-trail": {
					title: "动感光轨：气氛为主（标题可选）",
					body: "可选：标题=驱动光轨能量的主题。可选：产品/人物图（霓虹光轨下保持写实）。方言群像/眼神/面具/侧脸（或自动）。画面：暗青底＋猩红青蓝光轨。单张静帧。产品与概念都可用。",
					hookLabel: "主题 / 气氛（可选）",
					hookPlaceholder: "例如 夜行团队 · 扫描 · 英雄 · 速度",
					supportingLabel: "辅助 / 品牌短句",
					supportingPlaceholder: "短品牌或活动行（可选）",
				},
				"screen-break": {
					title: "破屏出界：按模式选英雄",
					body: "产品：建议上传 SKU — 它是破屏英雄。概念：人物/Logo/品牌图可选 — 他们是破屏英雄，不需要 SKU。标题可选。方言撕开伸手/探头/手机棚拍/手机地面（或自动）。画面：门户破口＋强制透视＋浮动 3D UI。单张静帧。",
					hookLabel: "Campaign / 主题（可选）",
					hookPlaceholder: "例如 BREAK THE SCREEN · OWN THE MOMENT · STEP OUT",
					supportingLabel: "简介 / 辅助 / 优惠",
					supportingPlaceholder: "短 bio、服务句或 CTA（可选）",
				},
"material-letters": {
					title: "材质大字：填写材质词",
					body: "标题=材质大字。选择羽绒/牛仔/尼龙/皮革（或自动）。辅助=口号或规格。",
					hookLabel: "材质大字 / 标题",
					hookPlaceholder: "例如 WARM · BREAK · OPEN · FOLD",
					supportingLabel: "口号 / 规格",
					supportingPlaceholder: "例如 BUILT FOR THE COLD · 14 OZ",
				},
				"type-interaction": {
					title: "字体互动：填写互动词",
					body: "标题=折叠/揭膜/切片/镜面词。选择类型（或自动）。辅助=品牌/标语。",
					hookLabel: "互动大字 / 标题",
					hookPlaceholder: "例如 FOLD · REVEAL · MOVE · TRACE",
					supportingLabel: "标语 / 规格",
					supportingPlaceholder: "短辅助行（可选）",
				},
				"product-lifestyle": {
					title: "生活方式产品：填写标题与数字卖点",
					body: "必须上传产品。标题=超大标题。辅助=功能句 + 大数字卖点。",
					hookLabel: "大标题",
					hookPlaceholder: "例如 AIRPODS · 品牌名",
					supportingLabel: "卖点（数字 + 短标签）",
    ...
    preVideoSetup: {
      ...
      browseContinueExport: "查看已有视频 →",
      browseContinueHint:
        "紫色：直接查看你已生成的视频（不扣 Token）。白色：用上方新设置再生成一条新视频（会扣 Token）。",
      regenerateVideo: "重新生成新视频",
      assistantHint:
    ...
    conceptNameStep: {
      ...
      hint: "会用于研究关键词、标题、prompt，以及需要时的分镜规划。",
      label: "概念",
      labelHint: "写清楚即可 — 别太宽（如「生意」），也别写成整份活动方案。",
      placeholder: "例如：瑜伽会员招募",
      examplesLabel: "试试例子",
      examples: ["瑜伽会员招募", "护肤品牌焕新", "周末早午餐推广"],
    },
    conceptTitle: "概念助手",
    ...
    blockReasons: {
      ...
      need_product_name: "请输入你的产品。",
      need_concept: "请输入你的概念。",
  ...
  ultraCanvas: {
    ...
    backStudio: "引导向导",
    title: "Ultra 画布",
    subtitle: "节点工作流：添加节点、用 @ 引用素材、逐步或一次运行。",
    costHint:
      "Ultra 画布按次扣 Token。每次出图或出片会从你的 Alchemy Token 余额扣除。",
    mobileDesktopOnly:
    ...
    busyBanner: "运行中 — 保存/加载已锁定",
    spawnBlockedExistingScenes: "场景节点已存在 — 请先删除已生成的 image/video 节点再重新生成。",
    researchHandoffImported: "已将 Studio 研究导入 Research 节点。",
    staleOutputBadge: "上游已变更 — 请重新运行以刷新输出。",
    creativeBHint: {
      title: "导演检查清单",
      staleTag: "需重跑",
      steps: [
        ...
        "角色 — 人脸 + 可选多角度。",
        "场景 — 场景圣经 + 构建空间。",
        "剧本 — 规划（静帧 + 动态 + 每场 VO 台词）。",
        "静帧 — 分镜同步 → 关键帧（或生成 Image）。",
        "配音 — 由已接剧本拉取 → 生成 TTS（视频前或同时）。",
        "视频 — 每场生成（动态含台词表演）。",
        "拼接 — 合并场景 + 按时间轴混入配音。",
      ],
      dismiss: "关闭",
    ...
    mobileNodes: "+ 添加节点",
    stopRun: "停止",
    busyNavBlocked: "请等运行完成后再切换画布。",
    runCancelled: "已取消",
    aliasPlaceholder: "@别名（如 Ava）",
    imagePromptPlaceholder: "描述广告图片… 用 @ 引用多图素材",
    runImage: "生成图片",
    refineImage: "微调静帧（可选）",
    imageFromStoryboard: "分镜静帧已就绪 — 下一步生成视频（不必再生成图片）。",
    tokenBadge: "{n} tok",
    ...
    directorChipsHint:
      "可选：点一下会把提示文字贴进上方输入框。做动作片请先别点这些 — 自己写运动提示，或只点「动作冲击」。",
    scriptNode: {
      sceneCountLabel: "场景数量",
      beatsTitle: "导演节拍（幕 · 时间 · 情绪 · 镜头 · 台词）",
      beatActPlaceholder: "Act 1 · Pain",
      beatTimePlaceholder: "0-8秒",
      beatEmotionPlaceholder: "情绪 / 氛围",
      beatFramingPlaceholder: "景别（如中近景）",
      beatCameraPlaceholder: "运镜（如慢推）",
      beatBlockingPlaceholder: "走位 / 动作",
      beatLinePlaceholder: "台词或屏幕文字",
      beatSpeakerPlaceholder: "说话人别名（PersonA）",
      spawnCastHint:
        "生成流水线时会按剧情分派角色并串起连续镜头（上一场图→下一场）。如需调整，直接改各场景图里的 @PersonA / @PersonB / @brand。",
    },
    characterNode: {
      hint: "可 AI 生成人脸参考图，或上传 / 从作品库选择 — 再「生成多角度」做三视图，连到场景或 @提及。",
      uploadPlaceholder: "上传人脸 / 三视图",
      biographyPlaceholder: "人物小传 — 年龄、穿搭、性格…",
      generatePromptPlaceholder: "可选：AI 生成外貌提示（留空则用人物小传）…",
      generate: "AI 生成角色",
      generateNeedPrompt: "请先填写人物小传或外貌提示再生成。",
      aiGeneratedFileName: "AI 角色参考图",
      orUpload: "— 或上传 / 作品库 —",
      aliasPlaceholder: "别名（如 PersonA）",
      generateAngles: "生成多角度",
      generatingAngles: "生成角度中…",
      anglesNeedFace: "请先上传或生成人脸。",
      anglesReady: "角度表就绪 — 可用作 @锁定。",
      openAngleSheet: "打开角度表",
    },
    brainstormNode: {
      hint: "想法 + 目标时长 → 多个创意方向。选一个填入剧本。",
      ideaPlaceholder: "你的想法 / 产品钩子…",
      durationLabel: "目标时长（秒）",
      brainstorm: "脑暴选项",
      brainstorming: "脑暴中…",
      needIdea: "请先输入想法。",
      applied: "已应用到剧本 — 请检查节拍并按需规划。",
      pick: "用这个 → 剧本",
      optionFallback: "选项",
    },
    researchNode: {
      hint: "调研摘要会流入剧本与场景提示。可从 Studio 调研导入。",
      summaryPlaceholder: "粘贴调研摘要、钩子、创意方向…",
      importHandoff: "导入 Studio 调研",
      handoffImported: "调研内容已导入。",
      handoffMissing: "未找到 Studio 调研交接 — 请先在 Studio 完成调研。",
      openStudioResearch: "在 Studio 做调研 →",
    },
    proControls: {
      title: "专业控制",
      aspectRatio: "画幅比例",
    ...
    toolbar: {
      ...
      newBoard: "清空画布",
      load: "加载",
      emptyBoards: "还没有保存的画布。",
      nodeCount: "{n} 个节点",
      undo: "撤销",
      redo: "重做",
      templates: "模板",
      shortcuts: "⌘Z 撤销 · ⌘⇧Z 重做 · ⌘D 复制 · Del 删除 · ⌘S 保存",
      deleteBoard: "删除画布",
      deleteBoardConfirm: "删除此已保存的画布？此操作无法撤销。",
      deleteBoardConfirmTitle: "删除画布？",
      clearBoardConfirmTitle: "清空画布？",
      clearBoardConfirm: "清除所有节点并回到空白起步板（上传→图片→视频）？未保存的更改会丢失。",
    },
    videoPromptLabel: "视频动态／剧情",
    videoPromptHint:
      "此框控制片中发生什么（动作、对白感觉、节奏）— 不是静帧长相。场景图片＝画面；此节点＝动态。",
    videoVsTextVideoHint:
      "需要已连接或 @提及 的静帧。还没有图？从左侧面板加「文字生视频」（或用起始板上的文字生视频节点）。",
    videoPromptPlaceholder: "例如：男人倾前说：还在弄？半夜了。产品广告在哪？",
    videoPromptEmptyWarn:
      "动态框为空 — 目前只靠镜头运动。请填入剧情／动作，再点生成视频。",
    textVideoPromptHint:
      "从想法直出片段：在此描述整场戏，不需要静帧。已有确认参考图时，请用「图生视频」。",
    textVideoPromptPlaceholder: "电影感文字生视频提示…",
    paletteTextVideoHint: "没有静帧？用「文字生视频」— 描述场景后直接生成。",
    paletteScrollUp: "向上",
    paletteScrollDown: "向下",
    runVideo: "生成视频",
    runTextVideo: "文字生视频",
    runScript: "规划剧本",
    scriptBriefPlaceholder: "输入创意简报，AI 将规划分镜…",
    scriptSceneLabel: "场景 {n}",
    spawnScenes: "生成 {n} 个文字生视频节点",
    spawnPipeline: "生成 {n} 条图片→视频流水线",
    openCaptions: "在字幕工作室打开",
    missingLocalAsset: "本地文件未保存 — 请重新上传或从作品库选择。",
    uploadPlaceholder: "上传图片 / 关键帧",
    uploadRefHint: "设置 @别名（如 Outfit、Gundam、Model）。连到图片节点或在提示词里 @提及 作为参考图。",
    pickFromLibrary: "从作品库选择",
    audioNode: {
      uploadPlaceholder: "上传 MP3 / WAV / M4A",
      uploadCloud: "上传到云端",
      uploading: "上传中…",
    },
    worldNode: {
      hint: "场景圣经 + 可选场景图 →「构建空间」展开成完整环境表。",
      descriptionPlaceholder: "同一间办公室、暖色顶灯、凌乱桌面、左侧窗光…",
      uploadPlaceholder: "可选场景参考图",
      buildSpace: "构建空间",
      buildingSpace: "构建空间中…",
      buildNeedDescription: "请先填写场景描述或上传参考图。",
      spaceReady: "空间表就绪 — 可连到场景。",
      openSpaceSheet: "打开空间表",
    },
    storyboardNode: {
      hint: "分镜格 —「生成整幕」一次填三格；可单格重生成。再推送静帧 / 生成流水线。",
      syncFromScript: "从剧本同步",
      spawnClips: "生成镜头流水线",
      empty: "先规划剧本，再点「从剧本同步」。",
      shotLabel: "第 {n} 镜",
      actLabel: "第 {n} 幕",
      panelLabel: "面板 {n}",
      panelsWord: "面板",
      stillPlaceholder: "本镜静帧提示词",
      statusPending: "待生成",
      statusOutline: "大纲就绪",
      statusStill: "有图",
      statusVideo: "有片",
      voWindow: "配音 {start}–{end}s",
      needScript: "请先连接上游剧本节点。",
      needPlan: "请先运行「规划剧本」生成场次。",
      needPanelPrompt: "请先在该面板填写静帧提示词。",
      generateKeyframe: "关键帧",
      regenerateKeyframe: "重生成静帧",
      generateVideo: "生成视频",
      regenerateVideo: "重生成视频",
      generateAct: "生成整幕静帧",
      generatingAct: "生成静帧中…",
      generateActVideos: "生成整幕视频",
      generatingActVideos: "生成视频中…",
      generatingKeyframe: "关键帧中…",
      needStillForVideo: "请先关键帧静帧，再生成视频。",
      editPrompt: "改提示",
      hidePrompt: "收起",
      applyStillsToScenes: "推送静帧 → 场景图片",
      stillsApplied: "已将 {n} 张分镜静帧推入场景图片节点。",
      stillsNoneToApply: "没有可推送的静帧 — 请先关键帧，再生成流水线。",
    },
    voiceNode: {
      hint: "配音来自你接入的剧本或分镜。改上游台词 → 拉取 → 可选生成预览 → 拼接按场放置。",
      stepsHint: "1) 接剧本（或分镜）→ 配音  2) 改上游台词  3) 拉取对时  4) 可选生成预览  5) 执行拼接。",
      scriptPlaceholder: "口播文案…（或由已连接的剧本／分镜拉取）",
      pullDialogue: "由已连接剧本／分镜拉取",
      generate: "生成配音",
      generating: "生成中…",
      needDialogue: "已连接的剧本／分镜还没有台词 — 请加 beat line 或分镜 dialogue，再拉取。",
      needWireScript: "请先将剧本或分镜接到配音节点 — 拉取只读你接的线，不会偷其他节点的文案。",
      needPullBeforeSplice:
        "已接配音但没有对时台词 — 请先由剧本／分镜拉取，再拼接（否则口播不会按场放置）。",
      timedLinesTitle: "对时台词（来自已连接剧本／分镜）",
      timedLinesHint: "时段跟场景顺序 + 视频时长。改完上游要再拉取。拼接用这些线做配音。",
      timedLinesEmpty: "还没有对时台词 — 请先由已连接剧本／分镜拉取。",
      sourceHint:
        "拉取只会用接到这个配音节点的剧本／分镜。只清空此框没用 — 要改上游台词再拉取。",
    },
    runSplice: "拼接视频",
    spliceHint: "连接视频节点（可选音频做 BGM）。在下方列表调整剪辑顺序。",
    spliceOrder: {
      title: "剪辑顺序",
      empty: "把视频节点连到此拼接 — 然后在这里排序。",
      hint: "↑↓ 决定播放顺序。画布位置不再决定剪辑顺序。",
      moveUp: "提前",
      moveDown: "延后",
      ready: "已就绪",
      waiting: "请先生成视频",
      needClips: "请先连接已生成的视频片段再拼接。",
    },
    videoProControls: {
      title: "视频专业控制",
      engine: "视频模式",
      ...
      engineHint:
        "默认单镜：人脸／产品锁定、单镜冲击力更强。需要参考片／多静帧风格时再切参考片模式。",
      aspectRatio: "画幅比例",
      camera: "镜头运动",
      cameraAuto: "自动（跟提示词）",
      cameraAutoHint: "不加模板镜头 — 动态跟你的提示词。",
      cameraFromPromptHint: "已检测到提示词里的镜头描述 — 跳过模板镜头。",
      cameraMultiRefHint: "多参考视频跟提示词运动 — 跳过模板镜头。",
      duration: "时长",
      resolution: "分辨率",
      motionStrength: "运动强度",
      motionHint: "越高动作越大",
    ...
    libraryPicker: {
      ...
      close: "关闭",
      loading: "加载中…",
      empty: "作品库暂无素材 — 在 Studio 或 Ultra 画布生成后导出到作品库。",
      unnamed: "未命名",
    },
    export: {
      saveToLibrary: "保存到作品库",
      saving: "保存中…",
      saved: "已保存到作品库",
    },
    modifierNodes: {
      lightingHint: "连接到图片或视频节点 — 将灯光效果合并到下游提示词。",
      backgroundHint: "连接到图片或视频节点 — 设置场景背景。",
      gradeHint: "连接到图片或视频节点 — 应用画面风格（视频安全）。",
    },
    cameraNode: {
      preset: "预设",
      spin: "旋转",
    ...
    textNode: {
      placeholder: "备注、简介或提示片段…",
    },
    brandNode: {
      hint: "将品牌 Logo 作为 @brand 供图片引用 — 可直接上传、从作品库选，或用品牌套件。",
      empty: "还没有 Logo — 可在下方上传或打开品牌套件。",
      uploadLogo: "上传 Logo",
      editKit: "编辑品牌套件 →",
      aliasPlaceholder: "别名（默认：brand）",
    },
    templates: {
      productHero: {
        name: "产品主图",
      ...
      storyDifferenceAd: {
        name: "故事差异广告",
        desc: "Creative B V2 — 三幕（痛点→方案→收尾）· 9:16 · 约 23 秒拼接",
      },
      comicToPhotoreal: {
        name: "漫画→真人漫游",
        desc: "上传漫画角色 → 写成真人并在场景中走动展示 · 静帧→视频",
      },
      comicRedCarpet: {
        name: "漫画红毯",
        desc: "原创华丽角色的漫画风红毯秀 · 禁止真人明星脸",
      },
    },
  },
  ...
  ultraCanvas2: {
    badge: "Ultra",
    title: "Ultra 画布",
    subtitle: "先选起点，再在同一块 Ultra 画布自由改。可用左侧加任何节点。",
    backClassic: "Ultra →",
    tryBeta: "Ultra 画布",
    costHint: "按次扣 Token。每次图像或视频生成会从 Alchemy 余额扣除。",
    howTitle: "你想怎样创作？",
    howSubtitle: "先选起点，之后仍可自由加节点、改连线。",
    noImageHint: "",
    laneA: "A · 完整视频广告",
    laneAHint: "适合多场景投放",
    laneB: "B · 快速视频片段",
    ...
    badgeRequired: "必需",
    badgeOptional: "可选",
    restoredSession: "已恢复你上次的编辑会话。",
    dismissRestore: "关闭",
    saveStatusSaving: "保存中…",
    saveStatusSaved: "已全部保存",
    ...
    cards: {
      ...
      imagesToVideo: {
        title: "图片 → 视频",
        desc: "把图片（上传或生成）变成短动态片段。",
        flow: "上传 → 图片 → 图生视频",
      },
      storyboard: {
        title: "分镜广告",
        desc: "规划场景、静图、配音并拼成多段广告。",
        flow: "剧本 → 分镜 → 配音 → 拼接",
      },
      scratch: {
        title: "从零搭建",
    ...
    useWorkflow: "使用此流程 →",
    recommended: "推荐",
    loadSavedTitle: "加载已存画布",
    loadSavedHint: "继续你已保存到 Ultra 的画布。",
    loadSavedEmpty: "还没有已存画布 — 请先选上方起点。",
    continueBoard: "继续当前画布",
    changeStart: "起始选择",
    changeStartConfirmTitle: "打开起始选择？",
    changeStartConfirm:
      "当前画布会保留，直到你选新起点（会替换现有节点）。若要先清空，请用「清除画布」。",
    textVideo: {
      useWhen: "已知画面且不需要参考图时使用。",
      purpose: "根据文字场景描述生成一条视频片段。",
      tip: "描述画面上发生的事，不必写模型指令。",
      example:
    ...
    spliceReview: {
      ...
      complete: "已完成",
      notAdded: "未添加",
      addBgmHint: "导出前建议加背景音乐。可连接 Audio 节点，或选择无音乐导出。",
      completeAd: "先补齐广告",
      exportWithoutMusic: "无音乐导出",
    },
    askAlchemy: {
      title: "问 Alchemy",
      askAnything: "随便问…",
      howToUse:
        "这里还不能打字提问 — 请点下面的问题芯片。Alchemy 会根据你画布上现有的节点回答。",
      checkWorkflow: "检查我的工作流",
      skipUpload: "可以跳过上传吗？",
      estimateCost: "估算总费用",
      improvePrompt: "优化我的 Prompt",
      tip: "点上面的芯片即可得到回答。",
      answers: {
        missingScript: "请添加或打开「剧本规划」（完整广告必需）。",
        missingStoryboard: "剧本之后请加「分镜」（必需）。",
        missingSplice: "最后请加「视频拼接」来合并片段。",
        uploadOptional: "上传是可选的 — 没有产品图也可以从剧本开始。",
        laneBAlternate: "文字生成视频是快捷路径（B 道），不是剧本后面的一步。",
        singleClipPath: "你在「单一片段」：在文字生成视频里写场景，再点生成。不需要图片。",
        needUploadStill: "请先用「上传」节点加入已确认的图片。",
        animateFlow: "流程：上传 → 图片 → 图生视频。",
        scratchBoard: "空白画布 — 左侧点「添加节点」，连线后再运行。",
        pickWorkflow: "请先选一种起始工作流（那四张卡片）。",
        coreOk: "核心节点看起来齐全 — 接下来跑剧本 / 生成片段。",
        skipYes: "可以。跳过上传，用文字生成视频：写清主体、动作、场景和运镜。",
        skipNeedUpload: "「图片转动画」必须先上传（或从素材库选图）。",
        skipCompleteAd: "完整视频广告里，上传可选。没有照片也可以先写剧本。",
        costEstimate: "现在点「全部运行」大约消耗 {n} Token。剧本规划走计划额度（不扣 Token）。",
        promptEmpty: "打开文字生成视频，按「主体 + 动作 + 场景 + 运镜」写。例如：黑玻璃上的精华瓶、金色透光、镜头缓慢推进。",
        promptStrengthen: "把 Prompt 写清楚：主体是谁/什么、做一个动作、在哪里、镜头怎么动。描述画面，不要写模型指令。",
      },
    },
    library: {
      search: "按名称搜索…",
