...
export const zhCn = {
  ...
  landing: {
    ...
    howSteps: [
      ...
      { title: "AI 分析风格", body: "识别排版、色调和语气，再套到你的产品或概念。" },
      { title: "改文案和规划", body: "确认标题、格式；需要时先看分镜静帧，再消耗点数。" },
      { title: "生成和编辑", body: "出图或出片后，再在画布改字、加 Logo、导出尺寸。" },
    ],
    demoModal: {
      close: "关闭示范",
      tryCta: "免费试用 — 做第一张广告",
    ...
    refTitle: "参考风格，出品牌+内容",
    refBody:
      "选择你喜欢的帖或 Reel。Alchemy 会识别排版、色板、光线和语气，建议再套到你的产品或概念 — 学风格不抄内容，成品仍然是品牌+内容。",
    refCardLabel: "参考风格",
    refFeatureItems: [
      {
        title: "识别风格 DNA",
