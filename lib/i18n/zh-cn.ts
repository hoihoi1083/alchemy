  ...
  wizard: {
    ...
    visualStyles: {
      ...
      "designed-poster": {
        title: "设计海报",
        description:
          "商业 feed 海报 — 你填的标题＋标语上图（任何品类，不限食品）",
      },
      "parts-poster": {
        title: "零件拆解",
...
socialDripFitTitle: "这个格式可以／不可以做什么",
  ...
  microWizard: {
    ...
    intakeFuse: {
      ...
      templateTipIntro: "选预设排版，或「直接創作」（无模板）。再用助手填写文案栏位。",
      templateIntro: "依你已选的输出類型筛选模板，或选直接創作自由填写。",
      templateDirectTitle: "直接創作（无模板）",
      templateDirectBody: "空白排版 — 用助手填写主标题與辅助文案。",
      templatePickHint: "请先在上方选模板或直接創作，再填写文案。",
      templateSelectedNote: "已选：{name}",
      switchPathConfirm:
        "切换会清空另一路径 — 研究选择或模板选择，以及本步文案。确定继续？",
      researchSelectedBanner:
        "已选：{title} · {platform} · 点「继续」后会套用风格",
      copyHookLabel: "主标题（hook）",
      copyHookPlaceholder: "吸睛的主标语",
      copySublineLabel: "辅助文案",
      ...
      productAssistHint: "依产品名称自动填写主标题、辅助文案與 CTA。",
    ...
    preGenerateSetup: {
      ...
      conceptCopyFocus: {
        ...
        designed: {
          ...
          body: "主标题 = 海报大标题（你填什么就画什么，不会换成产品名或乱发明标语）。辅助文案 = 短标语。额外要求只写色调／场景。",
      ...
      mainPhotoHint: "清晰正面产品照 — 输出会以这张作为产品身份。",
