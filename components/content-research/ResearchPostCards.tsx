...
function proxiedCoverUrl(url: string | undefined, platform: ContentResearchPost["platform"]): string | undefined {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        {posts.map((post) => {
          const cover = proxiedCoverUrl(post.coverImageUrl, post.platform);
