...
export function LandingBrandKit() {
  ...
  return (
    <section id="brand-kit" className="relative w-full overflow-hidden bg-slate-50">
      <div
      ...
      <div className="landing-brand-kit-grid relative mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-8 px-5 py-12 md:gap-10 md:px-8 md:py-16">
        <Reveal distance={48} className="w-full min-w-0 max-w-xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-slate-500">{L.brandKitLogoTip}</p>
        ...
        <Reveal delayMs={140} distance={44} scaleFrom={0.94} className="mx-auto w-full min-w-0 max-w-lg md:mx-0 md:justify-self-end">
