...
export function LandingEditableCanvas() {
  ...
  return (
    <section className="w-full bg-white px-5 py-10 md:px-8 md:py-12">
      <div className="mx-auto w-full max-w-[1440px] overflow-hidden rounded-[1.75rem] bg-[#0B1020] text-white shadow-2xl">
        <div className="landing-canvas-grid grid gap-8 px-6 py-10 md:items-center md:gap-10 md:px-10 md:py-12">
            ...
            <div className="flex min-h-[260px]">
              ...
              <div className="relative min-w-0 flex-1 bg-[#F5F0E8] p-3">
                <div className="relative mx-auto max-w-[240px]">
                  {/* Selection frame like editor */}
                  <div
                    className="relative overflow-hidden rounded-lg ring-2 ring-indigo-500"
                    style={{ boxShadow: "0 0 0 1px rgba(99,102,241,0.35)" }}
                  >
                    ...
                    {/* Corner selection handles — keep fully inside the frame */}
          ...
          {/* Right: copy + feature icons */}
          <div>
            <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">{L.canvasTitle}</h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-300">{L.canvasBody}</p>
            ...
            <ul className="mt-6 grid grid-cols-3 gap-3 sm:grid-cols-5 sm:gap-4">
              {L.canvasFeatureItems.map((item, i) => (
                <li key={item.title} className="text-center">
                  ...
                  <p className="mt-0.5 text-[10px] leading-snug text-slate-400">{item.body}</p>
                </li>
              ))}
            </ul>
            ...
            <Link
              href="/edit-image"
              className="mt-7 inline-flex rounded-full bg-violet-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-violet-400"
            >
              {L.canvasCta}
            </Link>
          </div>
